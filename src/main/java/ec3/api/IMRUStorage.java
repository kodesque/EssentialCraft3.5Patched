 ...
 * 
 * @author Modbder
 * @Description This interface is used to check for the items like soul shards in the player's inventory, before using
 *              MRU in the actual item. Do not use this when you are creating item, that wastes MRU, use this only to
 *              create MRU storage items.
 */
...
// *======================================EXAMPLES=========================================*//
/**
 * here is an example of how I use this to first try to decrease amount of MRU in the MRUStorages, and only then in the
 * actual item. I use this every time I need to decrease the MRU. This is actually contained in ECUtils.class
 */
