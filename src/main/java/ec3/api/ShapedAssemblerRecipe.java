...
public class ShapedAssemblerRecipe implements IRecipe {
    ...
    public ShapedAssemblerRecipe(Block result, int mruReq, Object... recipe) {
        this(new ItemStack(result), mruReq, recipe);
    }

    public ShapedAssemblerRecipe(Item result, int mruReq, Object... recipe) {
        this(new ItemStack(result), mruReq, recipe);
    }
