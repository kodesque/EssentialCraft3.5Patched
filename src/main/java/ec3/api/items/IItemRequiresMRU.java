...
public interface IItemRequiresMRU {
    ...
    // *======================================EXAMPLES=========================================*//
    /**
     * I used two basic classes to work with my items, but at some development point I decided, that I do not need one
     * of them anymore. Anyway, this way is also suggested here. It is under the @Deprecated mark
     */

    // This is the way to store MRU using damage values. I decided to not use this, because it is not the best way to do
    // so, and it will not allow you to store more than 32000 mru in it. Although this way was used in EC I, and it was
    // perfectly working there.
    /*
     * @Deprecated
    ...
    // This is the way to store MRU in item's NBTTagCompound. Notice, that I'm not showing how to create/edit tags, it
    // all is within the ECUtils class. I use lots of methods from there. Just ignore it, you can use your ways to do
    // this
    /*
     ...
     * @Override
     * public boolean setMRU(ItemStack stack, int amount) {
     * if(ECUtils.getStackTag(stack).getInteger("mru")+amount >= 0 &&
     * ECUtils.getStackTag(stack).getInteger("mru")+amount<=ECUtils.getStackTag(stack).getInteger("maxMRU"))
     * {
     ...
     * }
     * @Override
     * public void onUpdate(ItemStack itemStack, World world, Entity entity, int indexInInventory, boolean
     * isCurrentItem)
     * {
     ...
     * public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
     * {
     * par3List.add(ECUtils.getStackTag(par1ItemStack).getInteger("mru") + "/" +
     * ECUtils.getStackTag(par1ItemStack).getInteger("maxMRU") + " MRU");
     * }
     * @Override
     * public void getSubItems(int par1, CreativeTabs par2CreativeTabs, List par3List)
     * {
