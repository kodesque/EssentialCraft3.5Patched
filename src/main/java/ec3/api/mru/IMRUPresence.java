 ...
 *
 * @author Modbder
 * @Description use this interface to interact with MRU concentration centers. Remember, that MRUPressence is an Entity,
 *              so you can get it via List and the world.getEntitiesWithinAABB(IMruPressence.class,AxisAlignedBB)
 *
 */
public interface IMRUPresence {
    ...
    /**
     * The MRU balance. The basics of the corruption mechanics. Should return 1.0F if the MRUPressence is not corrupted,
     ...
     *
     * @param f : float - the more difference it has to 1.0F the faster the MRU amount will increase. The more the
     *          amount is, the faster the MRUPressence will spin.
     */
    public void setBalance(float f);

    /**
     * The mru amount currently stored in the MRUPressence. The higher the number is, the more corruption will be
     * affected.
     *
    ...
    /**
     * Set your mru amount here. If the MRUPressence is corrupted, and MRU is higher than 50000 it will automatically
     * release all corruption in the world and become pure.
     *
