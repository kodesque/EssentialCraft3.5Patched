 ...
 *
 * @author Modbder
 * @Description implement this in your tileEntities so they can be counted as pieces of structure AND you can reference
 *              to the main part of the structure
 */
public interface IStructurePiece {
    ...
    /**
     * This will be used by the structure central block if the structure is correct to give you the data needed. Do any
     * variable setups here.
     *
