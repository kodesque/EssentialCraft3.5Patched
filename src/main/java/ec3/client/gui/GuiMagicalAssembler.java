...
public class GuiMagicalAssembler extends GuiCommon {
    ...
    public void initGui() {
        ...
        if (assembler.currentRecipe == -1) this.buttonList.add(new GuiButton(0, k + 152, l + 21, 20, 20, "Set"));
        else {
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        if (assembler.currentRecipe == -1) this.modList.drawScreen(p_73863_1_, p_73863_2_, p_73863_3_);
        else {
            if (assembler.currentCraft != null) {
                ...
                this.fontRendererObj
                    .drawStringWithShadow(assembler.currentCraft.getDisplayName(), k + 48, l + 3, 0x00ff00);
                GL11.glEnable(GL11.GL_LIGHTING);
                List<UnformedItemStack> hasItems = new ArrayList<UnformedItemStack>(
                    assembler.requiredItemsToCraft.size());
                List<UnformedItemStack> hasItemsCopy = new ArrayList<UnformedItemStack>(
                    assembler.requiredItemsToCraft.size());
                ...
                for (int i = 2; i < 17; ++i) {
                    ...
                    if (is != null) {
                        forCycle: for (int j = 0; j < hasItemsCopy.size(); ++j) {
                            if (hasItemsCopy.get(j) != null && hasItemsCopy.get(j)
                                .itemStackMatches(is)) {
                ...
                for (int i = 0; i < assembler.requiredItemsToCraft.size(); ++i) {
                    ...
                    if (is != null) {
                        ItemStack ss = is.getISToDraw(
                            this.genericTile.getWorldObj()
                                .getTotalWorldTime());
                        if (ss != null) {
                            ...
                            if (drawed != null) {
                                Random rnd = new Random(
                                    this.genericTile.getWorldObj()
                                        .getTotalWorldTime() / 20 % 20);
                                if (drawed.getItemDamage() == -1
                                    || drawed.getItemDamage() == OreDictionary.WILDCARD_VALUE) {
    ...
    public class GuiCraftsList extends GuiScrollingList {
        ...
        public GuiCraftsList(GuiMagicalAssembler parent, int listWidth, int listHeight, int posY, int maxPosY, int posX,
            int maxPosX) {
            ...
            if (var3 > l + 5 && var3 < l + 38 + 5 && listIndex < assembler.allRecipes.size()) {
                ...
                if (rendered != null) {
                    ...
                    if (rendered.getItem() != null) {
                        if (!this.parent.indexSelected(listIndex)) this.parent.fontRendererObj
                            .drawStringWithShadow(rendered.getDisplayName(), k + 50, var3, 0xffffff);
                        else this.parent.fontRendererObj
                            .drawStringWithShadow(rendered.getDisplayName(), k + 50, var3, 0x00ff00);
                    }
                    this.parent.drawGradientRect(
                        k + 12 + defaultX,
                        l + 16 + defaultY,
                        k + 12 + 18 + defaultX,
                        l + 16 + 18 + defaultY,
                ...
                if (parent.mouseX > k + 28 && parent.mouseX < var2) {
                    if (parent.mouseY > var3 && parent.mouseY < var3 + 28) {
                        ...
                        int sizeY = 64;
                        this.parent
                            .drawGradientRect(mouseX, mouseY, sizeX + mouseX, sizeY + mouseY, 0xff000000, 0xff333333);
                        this.parent
                            .drawGradientRect(mouseX, mouseY, sizeX + mouseX, 1 + mouseY, 0xff000000, 0xff000000);
                        this.parent.drawGradientRect(
                            mouseX,
                            mouseY + sizeY - 1,
                            sizeX + mouseX,
                        ...
                        Random rnd = new Random(
                            this.parent.genericTile.getWorldObj()
                                .getTotalWorldTime() / 20 % 20);
                        String recipeString = "";
                        ...
                        for (int i = 0; i < recipe.getRecipeSize(); ++i) {
                            ...
                            if (recipe instanceof MagicianTableRecipe) {
                                ...
                                ItemStack needToDraw = is.getISToDraw(
                                    this.parent.genericTile.getWorldObj()
                                        .getTotalWorldTime());
                                if (needToDraw != null) {
                                    if (isLst.containsKey(needToDraw.toString())) {
                        ...
                        if (recipe instanceof MagicianTableRecipe) {
                            ...
                            this.parent.fontRendererObj.drawStringWithShadow(
                                "Required MRU: " + ((MagicianTableRecipe) recipe).mruRequired,
                                mouseX + 2,
                                mouseY + 54,
                                0xffffff);
                        }
                        if (recipe instanceof ShapedAssemblerRecipe) {
                            ...
                            this.parent.fontRendererObj.drawStringWithShadow(
                                "Required MRU: " + ((ShapedAssemblerRecipe) recipe).mruRequired,
                                mouseX + 2,
                                mouseY + 54,
                                0xffffff);
                        }
                        if (recipe instanceof RadiatingChamberRecipe) {
                            ...
                            this.parent.fontRendererObj.drawStringWithShadow(
                                "Required MRU: " + (int) (((RadiatingChamberRecipe) recipe).mruRequired
                                    * ((RadiatingChamberRecipe) recipe).costModifier),
                                mouseX + 2,
                                mouseY + 54,
                                0xffffff);
                        }
                        ...
                        for (int i = 0; i < items.size(); ++i) {
                            ...
                            if (drawed != null) {
                                int amount = 1;
                                if (isLst.containsKey(drawed.toString())) amount = isLst.get(drawed.toString());
                                ...
                                itemRender.renderItemAndEffectIntoGUI(
                                    ...
                                    x,
                                    y);
                                this.parent.fontRendererObj
                                    .drawStringWithShadow("x" + amount + "", x + 10, y + 10, 0x0000ff);
                            }
                            drawed = null;
                        }

                        this.parent.fontRendererObj
                            .drawStringWithShadow(recipeString, mouseX + 12, mouseY + 2, 0x0000ff);
                    }
                }
