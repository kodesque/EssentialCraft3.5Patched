...
import ec3.dummycore.utils.IMainMenu;
...
public class GuiMainMenuEC3 extends GuiMainMenu implements IMainMenu {
    ...
    private void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_) {
        ...
        tessellator
            .addVertexWithUV((double) k, (double) l, (double) this.zLevel, (double) (0.5F - f2), (double) (0.5F - f3));
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        this.mc.getTextureManager()
            .bindTexture(minecraftTitleTextures);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    public void drawButton(GuiButton button, Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_) {
        if (button.enabled) {
            ...
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            boolean field_146123_n = p_146112_2_ >= button.xPosition && p_146112_3_ >= button.yPosition
