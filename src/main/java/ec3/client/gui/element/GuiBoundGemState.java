            ...
            if (inventory.getStackInSlot(slotNum)
                ...
                if (this.tile.getWorldObj()
                    ...
                    Minecraft.getMinecraft().fontRenderer
                        .drawString("No Tile At Pos!", posX + 5, posY + 5, 0xff0000, true);
                } else {
                    if (!(this.tile.getWorldObj()
                        .getTileEntity(o[0], o[1], o[2]) instanceof ITEHasMRU)) {
                        Minecraft.getMinecraft().fontRenderer
                            .drawString("Not Magical!", posX + 12, posY + 5, 0xff0000, true);
                    } else {
                        if (!(MathUtils.getDifference(tile.xCoord, o[0]) <= 16
                            ...
                            Minecraft.getMinecraft().fontRenderer
                                .drawString("Not In Range!", posX + 8, posY + 5, 0xff0000, true);
                        } else {
                            if (((ITEHasMRU) (tile.getWorldObj()
                                .getTileEntity(o[0], o[1], o[2]))).getMRU() <= 0) {
                                Minecraft.getMinecraft().fontRenderer
                                    .drawString("No MRU In Tile!", posX + 6, posY + 5, 0xff0000, true);
                            } else {
                                Minecraft.getMinecraft().fontRenderer
                                    .drawString("Working", posX + 22, posY + 5, 0x00ff00, true);
                            }
                        }
                    }
                }
