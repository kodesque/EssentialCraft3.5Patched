...
public class GuiHeightState extends GuiTextField {
    ...
    public void draw(int posX, int posY) {
        ...
        for (int i = 0; i < 10; ++i) {
            MiscUtils.drawScaledTexturedRect(
                posX + 1 + rnd.nextInt(15),
                posY + 3 + rnd.nextInt(11),
                Blocks.gravel.getIcon(0, 0),
                2,
                2,
                2);
        }
        ...
        for (int i = 0; i < 6; ++i) {
            MiscUtils.drawScaledTexturedRect(
                posX + 1 + rnd.nextInt(15),
                posY + 3 + rnd.nextInt(11),
                Blocks.stained_hardened_clay.getIcon(0, 8),
                1,
                1,
                2);
        }
        for (int i = 0; i < 4; ++i) {
            MiscUtils.drawScaledTexturedRect(
                posX + 1 + rnd.nextInt(15),
                posY + 6 + rnd.nextInt(8),
                Blocks.gold_block.getIcon(0, 8),
                1,
                1,
                2);
        }
        for (int i = 0; i < 8; ++i) {
            MiscUtils.drawScaledTexturedRect(
                posX + 1 + rnd.nextInt(15),
                posY + 12 + rnd.nextInt(2),
                Blocks.lava.getIcon(0, 0),
                1,
                1,
                2);
        }
        for (int i = 0; i < 8; ++i) {
            MiscUtils
                .drawScaledTexturedRect(posX + 1 + rnd.nextInt(15), posY + 14, Blocks.bedrock.getIcon(0, 0), 1, 1, 2);
        }
        rnd = null;
