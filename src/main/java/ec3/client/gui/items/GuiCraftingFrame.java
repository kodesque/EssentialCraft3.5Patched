...
public class GuiCraftingFrame extends GuiContainer {
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        MiscUtils
            .handleButtonPress(par1GuiButton.id, this.getClass(), par1GuiButton.getClass(), this.mc.thePlayer, 0, 0, 0);
    }
    ...
    public void drawScreen(int mX, int mY, float partialTicks) {
        ...
        for (int ik = 0; ik < this.buttonList.size(); ++ik) {
            ...
            boolean hover = mX >= btn.xPosition && mY >= btn.yPosition
            ...
            if (id == 0) {
                ...
                if (MiscUtils.getStackTag(this.crafter.filterStack)
