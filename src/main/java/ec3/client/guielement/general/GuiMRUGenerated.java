    ...
    public void drawText(int posX, int posY) {
        if (tileValue.equals("matrixAbsorber")) {
            Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(
                TileMatrixAbsorber.mruUsage + "UBMRU > " + TileMatrixAbsorber.mruGenerated + "MRU",
                posX + 2,
                posY + 5,
                0xffffff);
        }
        if (tileValue.equals("heatGenerator")) {
            if (tile instanceof TileHeatGenerator) {
                ...
                if (furnace.currentBurnTime > 0) {
                    int scaledSize = MathUtils
                        .pixelatedTextureSize(furnace.currentBurnTime, furnace.currentMaxBurnTime, 14) + 1;
                    this.drawTexturedModalRect(
                        posX + 101,
                        posY + 2 + 15 - scaledSize,
                        176,
                        15 - scaledSize,
                        15,
                        scaledSize);
                ...
                Block[] b = new Block[4];
                b[0] = furnace.getWorldObj()
                    .getBlock(furnace.xCoord + 2, furnace.yCoord, furnace.zCoord);
                b[1] = furnace.getWorldObj()
                    .getBlock(furnace.xCoord - 2, furnace.yCoord, furnace.zCoord);
                b[2] = furnace.getWorldObj()
                    .getBlock(furnace.xCoord, furnace.yCoord, furnace.zCoord + 2);
                b[3] = furnace.getWorldObj()
                    .getBlock(furnace.xCoord, furnace.yCoord, furnace.zCoord - 2);
                ...
                Minecraft.getMinecraft().fontRenderer
                    .drawStringWithShadow((int) mruGenerated + " MRU/t", posX + 2, posY + 5, 0xffffff);
            }
        }
        if (tileValue.equals("ultraHeatGenerator")) {
            if (tile instanceof TileUltraHeatGenerator) {
                ...
                b[3] = furnace.getWorldObj()
                    .getBlock(furnace.xCoord, furnace.yCoord, furnace.zCoord - 2);
                for (int i = 0; i < 4; ++i) {
                    if (b[i] == Blocks.air) {} else
                        if (b[i] == Blocks.netherrack) {} else if (b[i] == Blocks.lava) {} else
                            if (b[i] == Blocks.fire) {} else if (b[i] instanceof IHotBlock) {} else {}

                }
                float heat = furnace.heat;
                if (heat < 1000) mruGenerated = heat / 100;
                else if (heat > 10000) mruGenerated = 80 + heat / 1000;
                else mruGenerated = heat / 124;
                Minecraft.getMinecraft().fontRenderer
                    .drawStringWithShadow((int) mruGenerated + " MRU/t", posX + 2, posY + 5, 0xffffff);
                Minecraft.getMinecraft().fontRenderer
                    .drawStringWithShadow("Heat: " + (int) furnace.heat + "C", posX + 82, posY - 10, 0xffffff);
            }
        }
        if (tileValue.equals("naturalFurnace")) {
            if (tile instanceof TileFlowerBurner) {
                ...
                Minecraft.getMinecraft().fontRenderer
                    .drawStringWithShadow((int) TileFlowerBurner.mruGenerated + " MRU/t", posX + 2, posY + 5, 0xffffff);
                ...
                if (furnace.burnedFlower != null) {
                    Block b = furnace.getWorldObj()
                        .getBlock(
                            (int) furnace.burnedFlower.x,
                            (int) furnace.burnedFlower.y,
                            (int) furnace.burnedFlower.z);
                    if (b != null) {
                        MiscUtils.drawTexture(
                            posX + 83,
                            posY + 1,
                            b.getIcon(
                                2,
        ...
        if (tileValue.equals("ultraNaturalFurnace")) {
            if (tile instanceof TileUltraFlowerBurner) {
                ...
                Minecraft.getMinecraft().fontRenderer
                    .drawStringWithShadow((int) furnace.mruProduced + " MRU/t", posX + 2, posY + 5, 0xffffff);
                MiscUtils.bindTexture("essentialcraft", "textures/gui/slot_common.png");
                this.drawTexturedModalRect(posX + 82, posY, 0, 0, 18, 18);
                if (furnace.burnedFlower != null) {
                    Block b = furnace.getWorldObj()
        ...
        if (tileValue.equals("cold")) {
            if (tile instanceof TileColdDistillator) {
                ...
                Minecraft.getMinecraft().fontRenderer
                    .drawStringWithShadow((int) cold.CgetMru() + " MRU/t", posX + 2, posY + 5, 0xffffff);
            }
        }
        if (tileValue.equals("enderGenerator")) {
            Minecraft.getMinecraft().fontRenderer
                .drawStringWithShadow((int) TileEnderGenerator.mruGenerated + " MRU/hit", posX + 2, posY + 5, 0xffffff);
        }
        if (tileValue.equals("sunray")) {
            Minecraft.getMinecraft().fontRenderer
                .drawStringWithShadow((int) TileSunRayAbsorber.mruGenerated + " MRU/t", posX + 2, posY + 5, 0xffffff);
        }
        if (tileValue.equals("moonwell")) {
            float mruGenerated = TileMoonWell.mruGenerated;
            int moonPhase = tile.getWorldObj().provider.getMoonPhase(
                tile.getWorldObj()
                    .getWorldTime());
            ...
            if (tile.yCoord > 80) heightFactor = 0F;
            else {
