...
public class EntityColoredFlameFX extends EntityFX {
    ...
    public EntityColoredFlameFX(World w, double x, double y, double z, double mX, double mY, double mZ, double r,
    ...
    public void renderParticle(Tessellator var3, float p_70539_2_, float p_70539_3_, float p_70539_4_, float p_70539_5_,
