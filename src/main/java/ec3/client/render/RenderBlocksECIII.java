    ...
    public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
        ...
        if (block instanceof BlockRayTower) {
            if (metadata == 0) {
                ...
                renderInventoryBlockWithSize(
                    renderer,
                    Blocks.glass,
                    BlocksCore.fortifiedGlass.getBlockTextureFromSide(0),
                    0.81F,
                    1.1F,
                    0.81F,
                    0,
        ...
        if (block instanceof BlockMoonWell) {
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                BlocksCore.moonWell.getIcon(0, 0),
                1F,
                0.1F,
                1F,
                0,
        ...
        if (block instanceof BlockMagicalDisplay) {
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                BlocksCore.magicalDisplay.getIcon(0, 0),
                1F,
                1F,
                0.1F,
                0,
        ...
        if (block instanceof BlockMagicalQuarry) {
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                BlocksCore.fortifiedGlass.getIcon(0, 0),
                1F,
                1F,
                1F,
                0,
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                BlocksCore.fortifiedStone.getIcon(0, 0),
                0.99F,
                0.2F,
                0.99F,
                0,
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                BlocksCore.magicalQuarry.getIcon(0, 0),
                0.2F,
                0.5F,
                0.2F,
                0,
        ...
        if (block instanceof BlockMRUCoil_Coil) {
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                BlocksCore.magicPlating.getIcon(1, 0),
                0.1F,
                0.7F,
                0.1F,
                0,
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                BlocksCore.ecEjector.getIcon(1, 0),
                0.3F,
                0.3F,
                0.3F,
                0,
