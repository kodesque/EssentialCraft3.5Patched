                ...
                if (currentScreen != null && currentScreen instanceof GuiContainer && GuiScreen.isCtrlKeyDown()) {
                    ...
                    try {
                        ...
                        if (inv != null && inv instanceof ISidedInventory) {
                            ...
                            if (RenderHandlerEC3.slotsTable.isEmpty()
                                || !RenderHandlerEC3.slotsTable.containsKey(inv)) {
                            ...
                            if ((slt.inventory instanceof TileEntity) || (slt.inventory instanceof InventoryBasic)) {
                                ...
                                if (slt.inventory instanceof ISidedInventory) {
                                    if (RenderHandlerEC3.slotsTable.containsKey(inv)) {
                                        Hashtable<Integer, List<ForgeDirection>> accessibleSlots = RenderHandlerEC3.slotsTable
                                            .get(inv);
    ...
    public void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        if (event.player.worldObj.isRemote && event.phase == Phase.START)
            if (event.player instanceof EntityClientPlayerMP) {
                ...
                if (PotionRegistry.paradox != null
                    && mc.thePlayer.getActivePotionEffect(PotionRegistry.paradox) != null) {
                    int duration = mc.thePlayer.getActivePotionEffect(PotionRegistry.paradox)
                        .getDuration();
                    if (duration > 100) {
                ...
                if (ClientProxy.kbArmorBoost.getIsKeyPressed() && !isSprintKeyDown) {
                    ...
                    if (ItemComputerArmor.class.cast(ItemsCore.computer_helmet)
                ...
                if (!player.capabilities.isFlying && player.isInWater()
                    && ItemComputerArmor.class.cast(ItemsCore.computer_helmet)
                        .hasFullset(player)
    ...
    public void pre(RenderGameOverlayEvent.Pre event) {
        try {
            ...
            if (event.type == ElementType.CROSSHAIRS) {
                ...
                if (Minecraft.getMinecraft().thePlayer.inventory.armorInventory[3] != null
                    ...
                    MiscUtils.drawTexture_Items(
                        (int) k - 8,
                        (int) h - 8,
                        ItemsCore.computer_helmet.getIconFromDamage(0),
                        16,
                        16,
                        100);
            ...
            if (event.type == ElementType.HEALTH) {
                if (Minecraft.getMinecraft().thePlayer.getActivePotionEffect(PotionRegistry.mruCorruptionPotion)
                    != null) {
