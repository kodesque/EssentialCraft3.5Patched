...
public class RenderMINInjector extends TileEntitySpecialRenderer {
    ...
    public static final IModelCustom model = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/MIN_Injector.obj"));
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
        ...
        if (ejector.getRotation() == ForgeDirection.DOWN) {
            ...
            if (!advanced) render.bindTexture(glass);
            else render.bindTexture(glass);
