...
public class RenderMRUCoilHardener extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation textures = new ResourceLocation(
        "essentialcraft:textures/special/models/mruCoilHardener.png");
    public static final IModelCustom model = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/mruCoilHardener.obj"));
     ...
     */
    public void doRender(TileMRUCoil_Hardener tile, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        if (tile.localLightning != null) tile.localLightning.render(p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_);
        GL11.glPopMatrix();
