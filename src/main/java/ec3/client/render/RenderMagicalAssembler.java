...
public class RenderMagicalAssembler extends TileEntitySpecialRenderer {
    ...
    public static void renderBeam(float partialTicks, double x, double y, double z, double posX, double posY,
        double posZ, double offsetX, double offsetY, double offsetZ, float colorR, float colorG, float colorB,
        float colorRB, float colorGB, float colorBB, float size) {
        GL11.glPushMatrix();
        ...
        float f10 = MathHelper.sqrt_float(f4 * f4 + f5 * f5 + f6 * f6) / 32.0F
            - (PlayerTickHandler.tickAmount + partialTicks) * 0.1F;
