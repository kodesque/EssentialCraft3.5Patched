...
public class RenderMatrixAbsorber extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation textures = new ResourceLocation(
        "essentialcraft:textures/special/models/matrixAbsorber.png");
    public static final IModelCustom model = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/MatrixAbsorber.obj"));
