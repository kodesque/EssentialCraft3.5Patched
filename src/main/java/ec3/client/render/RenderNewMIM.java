...
public class RenderNewMIM extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation vtextures = new ResourceLocation(
        "essentialcraft:textures/blocks/voidStone.png");
    public static final IModelCustom model = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/MIM.obj"));
