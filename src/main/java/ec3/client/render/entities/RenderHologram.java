...
public class RenderHologram extends RenderBiped {
    ...
    public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
        ...
        if (h.attackID == -1) meta = 76;

        if (h.attackID == 0) meta = 70;

        if (h.attackID == 1) meta = 73;

        if (h.attackID == 2) meta = 72;

        if (h.attackID == 3) meta = 71;

        GL11.glScalef(2, 2, 2);

        MiscUtils.renderItemStack_Full(
            new ItemStack(ECItems.genericItem, 1, meta),
            0,
            0,
            0,
            p_76986_2_ / 2,
