    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        if (item.getItem() instanceof ItemBlockElementalCrystal) {
            if (type == ItemRenderType.INVENTORY || type == ItemRenderType.ENTITY) {
                ...
                if (tag.hasKey("size")) size = tag.getFloat("size");

                if (tag.hasKey("fire")) fireF = tag.getFloat("fire");
                if (tag.hasKey("water")) waterF = tag.getFloat("water");
                if (tag.hasKey("earth")) earthF = tag.getFloat("earth");
                if (tag.hasKey("air")) airF = tag.getFloat("air");
