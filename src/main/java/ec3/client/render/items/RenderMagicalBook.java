...
public class RenderMagicalBook implements IItemRenderer {
    ...
    public static final ResourceLocation bookTextures = new ResourceLocation(
        "essentialcraft",
        "textures/special/models/bookUV.png");
    public static final ResourceLocation pageTextures = new ResourceLocation(
        "essentialcraft",
        "textures/special/models/pageUV.png");
    public static final IModelCustom book = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft", "textures/special/models/book.obj"));
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (GuiResearchBook.currentDiscovery == null && GuiResearchBook.currentCategory == null) {
            ...
            Minecraft.getMinecraft().fontRenderer
                .drawString("\u00a7l" + StatCollector.translateToLocal("ec3.txt.book.startup"), 0, 0, 0x7e760a);
            Minecraft.getMinecraft().fontRenderer
                .drawString(StatCollector.translateToLocal("ec3.txt.book.containedKnowledge"), 16, 15, 0x7e760a);
            int tier = MiscUtils.getStackTag(item)
                .getInteger("tier");
            for (int i = 0; i <= tier; ++i) {
                Minecraft.getMinecraft().fontRenderer.drawString(
                    "-\u00a7o" + StatCollector.translateToLocal("ec3.txt.book.tier_" + i),
                    16,
                    25 + (i * 10),
                    0x222222);
            }
            Minecraft.getMinecraft().fontRenderer
                .drawString(StatCollector.translateToLocal("ec3.txt.book.edition"), 16, 80, 0x7e760a);
            Minecraft.getMinecraft().fontRenderer.drawString(
