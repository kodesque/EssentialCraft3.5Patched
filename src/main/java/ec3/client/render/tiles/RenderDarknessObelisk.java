...
public class RenderDarknessObelisk extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation obelisk = new ResourceLocation(
        "essentialcraft:textures/special/models/darknessObelisk.png");
    public static final ResourceLocation rune = new ResourceLocation(
        "essentialcraft:textures/special/models/darknessRune.png");
    public static final IModelCustom model = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/DarknessObelisk.obj"));
     ...
     */
    public void doRender(TileEntity tile, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
        float p_76986_9_) {
        ...
        GL11.glPushMatrix();
        float lightLevel = tile.getWorldObj()
            .getBlockLightValue(tile.xCoord, tile.yCoord, tile.zCoord);
        GL11.glEnable(GL11.GL_BLEND);
        GL11.glColor4f(1, 1, 1, 1 - lightLevel / 15F);
        Minecraft.getMinecraft().renderEngine.bindTexture(rune);
        GL11.glTranslated(p_76986_2_ + 0.5F, p_76986_4_, p_76986_6_ + 0.5F);

        float upperRotationIndex = tile.getWorldObj()
            .getWorldTime() % 100;
