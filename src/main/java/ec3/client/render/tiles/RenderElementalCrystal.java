...
public class RenderElementalCrystal extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation textures = new ResourceLocation(
        "essentialcraft:textures/special/models/MCrystalTex.png");
    ...
    public static final ResourceLocation fire = new ResourceLocation(
        "essentialcraft:textures/special/models/FCrystalTex.png");
    public static final ResourceLocation water = new ResourceLocation(
        "essentialcraft:textures/special/models/WCrystalTex.png");
    public static final ResourceLocation earth = new ResourceLocation(
        "essentialcraft:textures/special/models/ECrystalTex.png");
    public static final ResourceLocation air = new ResourceLocation(
        "essentialcraft:textures/special/models/ACrystalTex.png");
    ...
    public void doRender(TileEntity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        if (metadata == 1) {
            GL11.glTranslatef(
                (float) p_76986_2_ + 0.5F,
                (float) p_76986_4_ + 1.4F - (1.0F - scale) * 1.4F,
                (float) p_76986_6_ + 0.5F);
        ...
        if (metadata == 0) {
            GL11.glTranslatef(
                (float) p_76986_2_ + 0.5F,
                (float) p_76986_4_ - 0.4F + (1.0F - scale) * 1.4F,
                (float) p_76986_6_ + 0.5F);
            GL11.glScalef(scale, scale, scale);
        ...
        if (metadata == 2) {
            GL11.glTranslatef(
                (float) p_76986_2_ + 0.5F,
                (float) p_76986_4_ + 0.5F,
                (float) p_76986_6_ - 0.5F + (1.0F - scale) * 1.5F);
            GL11.glScalef(scale, scale, scale);
        ...
        if (metadata == 4) {
            GL11.glTranslatef(
                (float) p_76986_2_ - 0.5F + (1.0F - scale) * 1.5F,
                (float) p_76986_4_ + 0.5F,
                (float) p_76986_6_ + 0.5F);
            GL11.glScalef(scale, scale, scale);
            GL11.glRotatef(90, 1, 0, 0);
        ...
        if (metadata == 3) {
            GL11.glTranslatef(
                (float) p_76986_2_ + 0.5F,
                (float) p_76986_4_ + 0.5F,
                (float) p_76986_6_ + 1.5F - (1.0F - scale) * 1.5F);
            GL11.glScalef(scale, scale, scale);
            GL11.glRotatef(-90, 1, 0, 0);
        ...
        if (metadata == 5) {
            GL11.glTranslatef(
                (float) p_76986_2_ + 1.5F - (1.0F - scale) * 1.5F,
                (float) p_76986_4_ + 0.5F,
                (float) p_76986_6_ + 0.5F);
            GL11.glScalef(scale, scale, scale);
            GL11.glRotatef(90, 1, 0, 0);
