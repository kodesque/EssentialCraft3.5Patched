...
public class RenderMINEjector extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation glass = new ResourceLocation(
        "essentialcraft:textures/special/models/minEjector_glass.png");
    public static final ResourceLocation overlay = new ResourceLocation(
        "essentialcraft:textures/special/models/minEjector_overlay.png");
    public static final ResourceLocation rings = new ResourceLocation(
        "essentialcraft:textures/special/models/minEjector_rings.png");
    public static final ResourceLocation overlayA = new ResourceLocation(
        "essentialcraft:textures/special/models/minEjector_overlayA.png");
    public static final ResourceLocation ringsA = new ResourceLocation(
        "essentialcraft:textures/special/models/minEjector_ringsA.png");
    public static final IModelCustom model = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/MIN_Ejector.obj"));
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
        boolean advanced = tile.getWorldObj()
            .getBlockMetadata(tile.xCoord, tile.yCoord, tile.zCoord) >= 6;
        ...
        if (ejector.getRotation() == ForgeDirection.DOWN) {
            ...
            if (!advanced) render.bindTexture(overlay);
            else render.bindTexture(overlayA);
            model.renderPart("pCube2");
            if (!advanced) render.bindTexture(rings);
            else render.bindTexture(ringsA);
