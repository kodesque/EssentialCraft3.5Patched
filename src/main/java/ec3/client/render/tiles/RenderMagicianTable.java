...
public class RenderMagicianTable extends TileEntitySpecialRenderer {
    ...
    public static final IModelCustom model = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/MagicianTable.obj"));
    public static final IModelCustom cube = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/Cube.obj"));
