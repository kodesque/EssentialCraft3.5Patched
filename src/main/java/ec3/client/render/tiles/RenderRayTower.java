...
import ec3.client.models.ModelFloatingCube;
...
public class RenderRayTower extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation enderCrystalTextures = new ResourceLocation(
        "essentialcraft:textures/entities/rayCrystal.png");
     ...
     */
    public void doRender(TileRayTower p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
