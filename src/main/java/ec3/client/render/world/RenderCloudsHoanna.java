package ec3.client.render.world;
...
public class RenderCloudsHoanna extends IRenderHandler {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        if (world.rand.nextInt(10) == 0) ++cloudTickCounter;
        for (int layer = 0; layer < 3; ++layer) {
            ...
            double d1 = (mc.renderViewEntity.prevPosX
                ...
                + d0 * layer * layer * 0.029999999329447746D) / (double) f2;
            ...
            Vec3 vec3 = Vec3
                .createVectorHelper((1F * (layer + 1) / 3F), (1F * (layer + 1) / 3F), (1F * (layer + 1) / 3F));
            if (world.isRaining()) vec3 = Vec3.createVectorHelper(0.3D, 0.3D, 0.3D);
            if (world.isRaining() && world.isThundering()) vec3 = Vec3.createVectorHelper(0.1D, 0.1D, 0.1D);
                    ...
                    for (int i1 = -b1 + 1; i1 <= b1; ++i1) {
                        ...
                        if (f4 > -f3 - 1.0F) {
                            ...
                            tessellator.addVertexWithUV(
                                ...
                                (double) (f4 + 0.0F),
                                (double) (f17 + (float) b0),
                                (double) ((f14 + 0.0F) * f10 + f8),
                                (double) ((f15 + (float) b0) * f10 + f9));
                            tessellator.addVertexWithUV(
                                (double) (f16 + (float) b0),
                                (double) (f4 + 0.0F),
                                (double) (f17 + (float) b0),
                                (double) ((f14 + (float) b0) * f10 + f8),
                                (double) ((f15 + (float) b0) * f10 + f9));
                            tessellator.addVertexWithUV(
                                (double) (f16 + (float) b0),
                                (double) (f4 + 0.0F),
                        ...
                        if (l > -1) {
                            ...
                            for (j1 = 0; j1 < b0; ++j1) {
                                tessellator.addVertexWithUV(
                                    (double) (f16 + (float) j1 + 0.0F),
                                    (double) (f4 + 0.0F),
                                    (double) (f17 + (float) b0),
                                    (double) ((f14 + (float) j1 + 0.5F) * f10 + f8),
                                    (double) ((f15 + (float) b0) * f10 + f9));
                                tessellator.addVertexWithUV(
                                    (double) (f16 + (float) j1 + 0.0F),
                                    (double) (f4 + f3),
