...
public class RenderSkyHoanna extends IRenderHandler {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        if (ECUtils.isEventActive("ec3.event.darkness")) colorDay = 0x000000;
        ...
        int mod = 1;
        if (b) mod = 3;
        if (!ECUtils.isEventActive("ec3.event.darkness")) for (int i = 0; i < 10 * mod; ++i) {
            GL11.glPushMatrix();
        ...
        if (!ECUtils.isEventActive("ec3.event.darkness")) for (int i = 0; i < 6; ++i) {
            GL11.glPushMatrix();
            GL11.glRotatef(-90.0F + i * 30F, 0.0F + i * i, i - 1.0F / i / i, 1.0F * i * i);
            GL11.glRotatef(world.getCelestialAngle(partialTicks) * 360.0F * i, 1.0F, 0.0F, 0.0F);
            ...
            for (int x = 0; x < 2 * i; ++x) {
                ...
                tessellator1.startDrawingQuads();
                tessellator1.setColorRGBA(
                    moonRnd.nextInt(),
                    moonRnd.nextInt(),
                    moonRnd.nextInt(),
                    (int) (moonRnd.nextFloat() * 255F));
