    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_,
        ...
        for (int i = 0; i < 10; ++i) {
            EssentialCraftCore.proxy.spawnParticle(
                "mruFX",
                p_149734_2_ + 0.5F + MathUtils.randomFloat(p_149734_5_) / 5,
                p_149734_3_ + 0.5F,
                p_149734_4_ + 0.5F + MathUtils.randomFloat(p_149734_5_) / 5,
                0,
                -5 - MathUtils.randomFloat(p_149734_5_) * 5,
                0);
            Vec3 rotateVec = Vec3.createVectorHelper(1, 0, 1);
            rotateVec.rotateAroundY(i * 36);
            for (int i1 = 0; i1 < 3; ++i1) EssentialCraftCore.proxy.spawnParticle(
                "mruFX",
                p_149734_2_ + 0.5F + MathUtils.randomFloat(p_149734_5_) / 5,
                p_149734_3_ + 0.25F,
                p_149734_4_ + 0.5F + MathUtils.randomFloat(p_149734_5_) / 5,
