...
public class BlockFancy extends Block implements IColdBlock {
    ...
    public static final String[] overlays = new String[] { "ancientTile", "bigTile", "brick", "fancyTile",
        "pressuredTile", "smallTiles", "temple", "tiles", "futuristicTile", "machine", "runic", "netherStar", "plate",
        "packedPlate", "doublePlate", "gem" };
    ...
    public void getSubBlocks(Item p_149666_1_, CreativeTabs p_149666_2_, List p_149666_3_) {
        for (int i = 0; i < overlays.length; ++i) p_149666_3_.add(new ItemStack(p_149666_1_, 1, i));
    }

    @SideOnly(Side.CLIENT)
    public IIcon getIcon(int side, int meta) {
        if (this.nativeCreated) return this.blockIcon;
        else return base.getIcon(side, this.baseMeta);
    }

    @Override
    public float getColdModifier(World w, int x, int y, int z, int meta) {
        // TODO Auto-generated method stub
        return this == ECBlocks.fancyBlocks.get(3) ? 0.5F : 0;
    }
