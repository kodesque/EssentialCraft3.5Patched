...
public class BlockFurnaceMagic extends BlockContainer {
    ...
    public void onBlockPlacedBy(World w, int p_149689_2_, int p_149689_3_, int p_149689_4_,
    ...
    public void registerBlockIcons(IIconRegister r) {
        ...
        for (int i = 0; i < 4; ++i) frontIcons[i] = r.registerIcon("essentialcraft:furnace_" + names[i]);
    }
