...
public class BlockHologramSpawner extends Block {
    ...
    public boolean onBlockActivated(World w, int x, int y, int z, EntityPlayer p, int p_149727_6_, float p_149727_7_,
        float p_149727_8_, float p_149727_9_) {
        if (!w.isRemote && w.provider != null
            && (w.provider.dimensionId == Config.dimensionID || Config.allowHologramInOtherDimensions)) {
