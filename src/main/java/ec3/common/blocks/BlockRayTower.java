...
public class BlockRayTower extends BlockContainer {
    ...
    public void onBlockAdded(World w, int i, int j, int k) {
        ...
        if (w.getBlock(i, j + 1, k) == Blocks.air) {
            if (w.getBlockMetadata(i, j, k) == 0) {
                w.setBlock(i, j + 1, k, ECBlocks.rayTower, 1, 3);
    ...
    public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_, int p_149742_3_, int p_149742_4_) {
        return p_149742_1_.getBlock(p_149742_2_, p_149742_3_, p_149742_4_)
            ...
            && p_149742_1_.getBlock(p_149742_2_, p_149742_3_ + 1, p_149742_4_) == Blocks.air;
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
        ...
        if (par1World.getBlock(par2, par3 - 1, par4) == ECBlocks.rayTower) {
