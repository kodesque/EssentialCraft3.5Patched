...
public class BlockRightClicker extends BlockContainer {
    ...
    public IIcon getIcon(int par1, int par2) {
        if (par2 == OreDictionary.WILDCARD_VALUE) par2 = 0;
    ...
    public IIcon getIcon(IBlockAccess w, int x, int y, int z, int side) {
        ...
        return tile.getStackInSlot(10) != null && tile.getStackInSlot(10)
            .getItem() instanceof ItemBlock
                ? ItemBlock.class.cast(
                    tile.getStackInSlot(10)
                        .getItem()).field_150939_a.getIcon(
                            side,
                            tile.getStackInSlot(10)
                                .getItemDamage())
                : side == tile.rotation ? metaRelatedIcons[meta] : blockIcons[0];
    }
