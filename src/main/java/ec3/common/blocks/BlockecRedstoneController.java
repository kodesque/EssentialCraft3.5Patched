...
public class BlockecRedstoneController extends BlockContainer {
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
        ...
        if (p_149727_5_.isSneaking()) {
            TileChamberRedstoneController rc = (TileChamberRedstoneController) p_149727_1_
                .getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_);
            rc.setting += 1;
            if (rc.setting >= 11) rc.setting = 0;
            if (p_149727_5_.worldObj.isRemote) p_149727_5_.addChatMessage(
                new ChatComponentText(StatCollector.translateToLocal("ec3.txt.redstone_" + rc.setting)));
        } else {
            TileChamberRedstoneController rc = (TileChamberRedstoneController) p_149727_1_
                .getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_);
            if (p_149727_5_.worldObj.isRemote) p_149727_5_.addChatMessage(
    ...
    public int isProvidingWeakPower(IBlockAccess w, int x, int y, int z, int meta) {
        TileChamberRedstoneController rc = (TileChamberRedstoneController) w.getTileEntity(x, y, z);
