...
import ec3.dummycore.utils.DataStorage;
    ...
    protected void dropFewItems(boolean playerkill, int fortune) {
        ...
        if (!this.worldObj.isRemote) {
            for (int i = 0; i < this.players.size(); ++i) {
                ...
                if (p != null) p.triggerAchievement(AchievementRegistry.achievementList.get("hologram"));
                ...
                if (addBig) p.triggerAchievement(AchievementRegistry.achievementList.get("hologramBig"));
            }
        }
        ...
        if (this.worldObj.rand.nextDouble() < 0.1D) this.entityDropItem(new ItemStack(ItemsCore.dividingGun, 1, 0), 0);
