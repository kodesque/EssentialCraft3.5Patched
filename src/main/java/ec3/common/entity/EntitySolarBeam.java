...
public class EntitySolarBeam extends EntityWeatherEffect {
    ...
    public EntitySolarBeam(World p_i1703_1_, double p_i1703_2_, double p_i1703_4_, double p_i1703_6_) {
        ...
        if (!p_i1703_1_.isRemote && p_i1703_1_.getGameRules()
            ...
            if (p_i1703_1_.getBlock(i, j, k)
                .getMaterial() == Material.air && Blocks.fire.canPlaceBlockAt(p_i1703_1_, i, j, k)) {
            ...
            for (i = 0; i < 32; ++i) {
                ...
                if (p_i1703_1_.getBlock(j, k, l)
                    .getMaterial() == Material.air && Blocks.fire.canPlaceBlockAt(p_i1703_1_, j, k, l)) {
    ...
    public void onUpdate() {
        super.onUpdate();
        if (--beamLiveTime <= 0) this.setDead();
        if ((beamLiveTime % 5) == 0)
