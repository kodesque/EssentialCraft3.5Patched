...
public class ContainerNewMIM extends Container {
    ...
    public static class SlotBGTEClassDepenant extends Slot {
        ...
        public boolean isItemValid(ItemStack stk) {
            ...
            if (!(stk.getItem() instanceof ItemBoundGem)) return false;
            ...
            if (stk.getTagCompound()
                .getInteger("dim") != tile.getWorldObj().provider.dimensionId) return false;

            int[] coords = ItemBoundGem.getCoords(stk);

            TileEntity t = tile.getWorldObj()
                .getTileEntity(coords[0], coords[1], coords[2]);

            if (t == null) return false;

            if (!(dependant.isAssignableFrom(t.getClass()))) return false;
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (p_82846_2_ > 27 + inv.getSizeInventory() && p_82846_2_ < 36 + inv.getSizeInventory()
