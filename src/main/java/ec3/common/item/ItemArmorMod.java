...
import ec3.dummycore.utils.DCASMCheck;
import ec3.dummycore.utils.ExistanceCheck;
...
public class ItemArmorMod extends ItemArmor
    ...
    public Multimap getAttributeModifiers(ItemStack stack) {
        ...
        if (this == ItemsCore.magicArmorItems[5]) mods.put(
        ...
        if (this == ItemsCore.magicArmorItems[7]) mods.put(
        ...
        if (this == ItemsCore.magicArmorItems[9]) mods.put(
            SharedMonsterAttributes.maxHealth.getAttributeUnlocalizedName(),
            new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "hp", 30D, 0));

        if (this == ItemsCore.magicArmorItems[11]) mods.put(
            SharedMonsterAttributes.movementSpeed.getAttributeUnlocalizedName(),
