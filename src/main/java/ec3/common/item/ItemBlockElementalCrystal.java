...
public class ItemBlockElementalCrystal extends ItemBlock {
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4,
        ...
        if (MiscUtils.getStackTag(par1ItemStack) != null) {
            size = MiscUtils.getStackTag(par1ItemStack)
                .getFloat("size");
            fire = MiscUtils.getStackTag(par1ItemStack)
                .getFloat("fire");
            water = MiscUtils.getStackTag(par1ItemStack)
                .getFloat("water");
            earth = MiscUtils.getStackTag(par1ItemStack)
                .getFloat("earth");
            air = MiscUtils.getStackTag(par1ItemStack)
                .getFloat("air");
        }
