...
public class ItemGenericArmor extends ItemArmor {
    ...
    public String getArmorTexture(ItemStack itemstack, Entity entity, int slot, String type) {
        switch (slot) {
            case 2:
                return "essentialcraft:textures/special/armor/wind_layer_2.png"; // 2 should be the slot for legs
            default:
    ...
    public boolean hasColor(ItemStack stk) {
        return (!stk.hasTagCompound() ? false
            : (!stk.getTagCompound()
    ...
    public Multimap getAttributeModifiers(ItemStack stack) {
        ...
        if (this == ItemsCore.wind_chestplate) mods.put(
            SharedMonsterAttributes.movementSpeed.getAttributeUnlocalizedName(),
            new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "mSpeed", 0.075D, 0));
