    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        if (!hasCheckedParent) {
            ...
            try {
                ...
                Method addInfo = c
                    .getMethod("addInformation", ItemStack.class, EntityPlayer.class, List.class, boolean.class);
            ...
            if (parentHasAddInfo) {
                try {
                    this.field_150939_a.getClass()
                        .getMethod("addInformation", ItemStack.class, EntityPlayer.class, List.class, boolean.class)
                        .invoke(field_150939_a, par1ItemStack, par2EntityPlayer, par3List, par4);
                } catch (Exception e) {
