...
public class ItemCharm extends ItemStoresMRUInNBT implements IBauble {
    ...
    public String[] name = new String[] { "Fire", "Water", "Earth", "Air", "Steam", "Magma", "Lightning", "Life",
        "Rain", "Dust" };
    ...
    public void updateFire(EntityPlayer e, ItemStack s) {
        if (e.isBurning() && !e.isPotionActive(Potion.fireResistance.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -50) || this.setMRU(s, -50))) {
            e.extinguish();
    ...
    public void updateEarth(EntityPlayer e, ItemStack s) {
        if (e.hurtTime > 0 && !e.isPotionActive(Potion.resistance.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -200) || this.setMRU(s, -200))) {
            e.addPotionEffect(new PotionEffect(Potion.resistance.id, 100, 0));
        }
    }

    public void updateAir(EntityPlayer e, ItemStack s) {
        if (e.isSprinting() && !e.isPotionActive(Potion.moveSpeed.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -10) || this.setMRU(s, -10))) {
    ...
    public void updateSteam(EntityPlayer e, ItemStack s) {
        if (e.getHealth() < 5 && !e.isPotionActive(Potion.moveSpeed.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -200) || this.setMRU(s, -200))) {
    ...
    public void updateMagma(EntityPlayer e, ItemStack s) {
        Material m = e.worldObj.getBlock((int) e.posX - 1, (int) e.posY - 1, (int) e.posZ)
            .getMaterial();
        Material m1 = e.worldObj.getBlock((int) e.posX - 1, (int) e.posY, (int) e.posZ)
            .getMaterial();
        if ((m == Material.lava || m1 == Material.lava) && !e.isPotionActive(Potion.fireResistance.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -100) || this.setMRU(s, -100))) {
    ...
    public void updateLightning(EntityPlayer e, ItemStack s) {
        if (e.worldObj.isThundering() && !e.isPotionActive(Potion.damageBoost.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -100) || this.setMRU(s, -100))) {
            e.addPotionEffect(new PotionEffect(Potion.fireResistance.id, 100, 0));
    ...
    public void updateLife(EntityPlayer e, ItemStack s) {
        if (e.getHealth() < 5 && !e.isPotionActive(Potion.regeneration.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -200) || this.setMRU(s, -200))) {
            e.addPotionEffect(new PotionEffect(Potion.regeneration.id, 50, 1));
            e.worldObj.playSoundAtEntity(e, "random.orb", 1, 10F);
        }
        if (e.getHealth() < 20 && !e.isPotionActive(Potion.regeneration.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -50) || this.setMRU(s, -50))) {
    ...
    public void updateRain(EntityPlayer e, ItemStack s) {
        if (e.worldObj.isRaining() && !e.isPotionActive(Potion.digSpeed.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -50) || this.setMRU(s, -50))) {
    ...
    public void updateDust(EntityPlayer e, ItemStack s) {
        Material m = e.worldObj.getBlock((int) e.posX - 1, (int) e.posY - 1, (int) e.posZ)
            .getMaterial();
        if (m == Material.sand && !e.isPotionActive(Potion.resistance.id)
            && (ECUtils.tryToDecreaseMRUInStorage(e, -100) || this.setMRU(s, -100))) {
            e.addPotionEffect(new PotionEffect(Potion.resistance.id, 100, 0));
