        ...
        if (stack.getTagCompound() == null) {
            ...
            if (tile != null) {
                if (tile instanceof TileMagicalMirror) {
                    ...
                    player.addChatMessage(
                        new ChatComponentText("Mirror linked to the wand!")
            ...
            if (tile != null) {
                if (tile instanceof TileMagicalAssembler) {
                    int[] o = MiscUtils.getStackTag(stack)
                        .getIntArray("pos");
                    float distance = new DummyDistance(new Coord3D(x, y, z), new Coord3D(o[0], o[1], o[2]))
                        .getDistance();
                    if (distance <= TileMagicalMirror.cfgMaxDistance) {
                        ...
                        if (tile1 != null && tile1 instanceof TileMagicalMirror) {
                            ...
                            player.addChatMessage(
                                new ChatComponentText("Mirror linked to the assembler!")
                                    .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.GREEN)));
                    ...
                    if (tile instanceof IInventory) {
                        ...
                        if (distance <= TileMagicalMirror.cfgMaxDistance) {
                            ...
                            if (tile1 != null && tile1 instanceof TileMagicalMirror) {
                                ((TileMagicalMirror) tile1).inventoryPos = new Coord3D(x + 0.5F, y + 0.5F, z + 0.5F);
                                player.addChatMessage(
                                    new ChatComponentText("Mirror linked to the inventory!")
                                        .setChatStyle(new ChatStyle().setColor(EnumChatFormatting.GREEN)));
                                stack.setTagCompound(null);
                                return true;
                            }
