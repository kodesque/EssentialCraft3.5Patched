...
public class ItemCraftingFrame extends Item {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        ...
        if (inv != null) {
            ...
            for (int i = 0; i < 9; ++i) {
                ...
                if (stk == null) par3List.add(i + ": Empty");
                else par3List.add(i + ": " + stk.getDisplayName());
            }

            ItemStack stk = inv.getStackInSlot(9);
            if (stk == null) par3List.add("Result: None");
            else par3List.add("Result: " + stk.getDisplayName());
        }
    }
    ...
    public void onUpdate(ItemStack itemStack, World world, Entity entity, int indexInInventory, boolean isCurrentItem) {
        ...
        if (((EntityPlayer) entity).openContainer == null
            || !(((EntityPlayer) entity).openContainer instanceof ContainerCraftingFrame)) {
            return;
        }
