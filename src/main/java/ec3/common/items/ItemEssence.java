...
public class ItemEssence extends Item {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        ...
        if (t == 0) par3List.add("Rarity: \247f" + "Common");
        if (t == 1) par3List.add("Rarity: \247e" + "Uncommon");
        if (t == 2) par3List.add("Rarity: \247b" + "Rare");
        if (t == 3) par3List.add("Rarity: \247d" + "Exceptional");
    }

    public static int convertDamageToIntBefore4(int d) {
        if (d == 0 || d == 4 || d == 8 || d == 12) return 0;
        if (d == 1 || d == 5 || d == 9 || d == 13) return 1;
        if (d == 2 || d == 6 || d == 10 || d == 14) return 2;
        if (d == 3 || d == 7 || d == 11 || d == 15) return 3;
        return 0;
    }

    public EnumRarity getRarity(ItemStack par1ItemStack) {
        int t = (int) ((float) par1ItemStack.getItemDamage() / 4);
        if (t == 1) return EnumRarity.uncommon;
        if (t == 2) return EnumRarity.rare;
        if (t == 3) return EnumRarity.epic;
