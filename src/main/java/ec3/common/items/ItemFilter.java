...
public class ItemFilter extends Item {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        ...
        if (par1ItemStack.getItemDamage() > 1) par3List.add(StatCollector.translateToLocal("ec3.txt.desc.blacklist"));
        else par3List.add(StatCollector.translateToLocal("ec3.txt.desc.whitelist"));
    }
    ...
    public void onUpdate(ItemStack itemStack, World world, Entity entity, int indexInInventory, boolean isCurrentItem) {
        ...
        if (((EntityPlayer) entity).openContainer == null
            || !(((EntityPlayer) entity).openContainer instanceof ContainerFilter)) {
            return;
        }
