...
public class ItemMRUMatrixProjection extends Item {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        if (par1ItemStack.getTagCompound() != null) {
            String username = par1ItemStack.getTagCompound()
                .getString("playerName");
            par3List.add(
                EnumChatFormatting.DARK_GRAY + "Thus is a projection of "
    ...
    public void onUsingTick(ItemStack stack, EntityPlayer player, int count) {
        ...
        if (count == 100) player.addPotionEffect(new PotionEffect(Potion.confusion.id, 200, 0, true));
        if (count <= 50) {
    ...
    public ItemStack onEaten(ItemStack p_77654_1_, World p_77654_2_, EntityPlayer p_77654_3_) {
        ...
        if (!p_77654_3_.worldObj.isRemote) {
            p_77654_3_.addChatMessage(
                new ChatComponentText(EnumChatFormatting.AQUA + "Your MRU Matrix twists with new colors!"));
            ApiCore.getPlayerData(p_77654_3_)
                .modifyMatrixType(p_77654_1_.getItemDamage());
        }
