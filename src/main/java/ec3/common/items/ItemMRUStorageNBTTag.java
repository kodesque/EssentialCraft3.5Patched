...
public class ItemMRUStorageNBTTag extends Item implements IMRUStorage, IItemRequiresMRU, IBauble {
    ...
    int[] colors = new int[] { 0x555555, 0x665555, 0x775555, 0x885555, 0x995555, 0xaa5555, 0xbb5555, 0xcc5555, 0xdd5555,
        0xee6666, 0xff6666 };
    public static String[] dropNames = new String[] { "SoulShard", "SoulSphere", "DarkSoulMatter", "RedSoulMatter",
        "MatterOfEthernity" };
    ...
    public boolean setMRU(ItemStack stack, int amount) {
        if (ECUtils.getStackTag(stack)
            .getInteger("mru") + amount >= 0
            && ECUtils.getStackTag(stack)
                .getInteger("mru") + amount <= ECUtils.getStackTag(stack)
                    .getInteger("maxMRU")) {
            ECUtils.getStackTag(stack)
                .setInteger(
                    "mru",
    ...
    public int getMRU(ItemStack stack) {
        ...
        return ECUtils.getStackTag(stack)
            .getInteger("mru");
    }
