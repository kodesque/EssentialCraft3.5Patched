...
public class ItemWindPickaxe extends ItemPickaxeMod {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
        ...
        return ECItems.wind_elemental_hoe.onItemUse(
            p_77648_1_,
            p_77648_2_,
            p_77648_3_,
            p_77648_4_,
    ...
    public boolean hitEntity(ItemStack weapon, EntityLivingBase attacked, EntityLivingBase attacker) {
        ...
        if (attacker instanceof EntityPlayer) {
            ...
            // #link ec3.events.ECEventHandler
            EntityPlayer p = EntityPlayer.class.cast(attacker);

            ItemStack currentTool = p.getCurrentEquippedItem();

            if (!p.worldObj.isRemote && currentTool != null
                && currentTool.getItem() instanceof ItemTool
                && ItemTool.class.cast(currentTool.getItem())
                    .func_150913_i() == ECItems.windElemental) {
