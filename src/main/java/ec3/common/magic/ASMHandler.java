...
public class ASMHandler implements IClassTransformer {
    ...
    public String nbttagcompoundClassName = NBTTagCompound.class.getName()
        .replace('.', '/');
    public String itemStackClassName = ItemStack.class.getName()
        .replace('.', '/');
    public String worldClassName = World.class.getName()
        .replace('.', '/');
    public String entityClassName = Entity.class.getName()
        .replace('.', '/');
    public String miscUtils = MiscUtils.class.getName()
        .replace('.', '/');
    public String ecutils = ECUtils.class.getName()
        .replace('.', '/');
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        if (name.equals(toolClass)) {
            Notifier.notifyCustomMod(
                "EssentialCraft",
                "Hello, TConstruct. I was just about toSUDDENTLYUNEXPECTEDASMPACHING!!!");
    ...
    public byte[] handleTransform(byte[] transformingClass, String classpath, boolean isObfuscated) {
         ...
         * FieldNode nodeMRU = new FieldNode(Opcodes.ASM5, Opcodes.ACC_PUBLIC, "currentMRU",
         * Type.INT_TYPE.getDescriptor(), null, 0);
         * FieldNode nodeMaxMRU = new FieldNode(Opcodes.ASM5, Opcodes.ACC_PUBLIC, "maxMRU",
         * Type.INT_TYPE.getDescriptor(), null, 5000);
         * System.out.println(" *Patch status: fields patching");
         * System.out.println(" *Patch status: adding a FieldNode "+nodeMRU+" with fieldname "+nodeMRU.
         * name+" and fieldvalue "+nodeMRU.value);
         * classNode.fields.add(nodeMRU);
         * System.out.println(" *Patch status: adding a FieldNode "+nodeMaxMRU+" with fieldname "+nodeMaxMRU.
         * name+" and fieldvalue "+nodeMaxMRU.value);
         ...
         * MethodNode method_getMRU = new
         * MethodNode(Opcodes.ASM5,Opcodes.ACC_PUBLIC,"getMRU","(L"+itemStackClassName+";)"+Type.INT_TYPE.getDescriptor(
         * ),null,null);
         * System.out.println(" 	**Patch status: generated a MethodNode "+method_getMRU+" with methodname "
         * +method_getMRU.name);
         * System.out.println(" 	**Patch status: creating an Instruction List for "+method_getMRU+" with methodname "
         * +method_getMRU.name);
         * System.out.println("		***Patch status: creating method body");
         * MethodVisitor mv = writer.visitMethod(method_getMRU.access, method_getMRU.name, method_getMRU.desc, null,
         * null);
         * Label l0 = new Label();
         * mv.visitCode();
         * mv.visitLabel(l0);
         * mv.visitVarInsn(Opcodes.ALOAD, 1);
         * mv.visitMethodInsn(Opcodes.INVOKESTATIC, miscUtils, "getStackTag",
         * "(L"+itemStackClassName+";)"+"L"+nbttagcompoundClassName+";",false);
         * mv.visitLdcInsn("mru");
         * mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, nbttagcompoundClassName, method_getInt, "(Ljava/lang/String;)I",
         * false);
         ...
         * System.out.println();
         * System.out.println(" *Patch status: generating MethodNode");
         * MethodNode method_getMaxMRU = new
         * MethodNode(Opcodes.ASM5,Opcodes.ACC_PUBLIC,"getMaxMRU","(L"+itemStackClassName+";)"+Type.INT_TYPE.
         * getDescriptor(),null,null);
         * System.out.println(" 	**Patch status: generated a MethodNode "+method_getMaxMRU+" with methodname "
         * +method_getMaxMRU.name);
         * System.out.println(" 	**Patch status: creating an Instruction List for "
         * +method_getMaxMRU+" with methodname "+method_getMaxMRU.name);
         * System.out.println("		***Patch status: creating method body");
         ...
         * System.out.println();
         * System.out.println(" *Patch status: generating MethodNode");
         * MethodNode method_setMRU = new
         * MethodNode(Opcodes.ASM5,Opcodes.ACC_PUBLIC,"setMRU","(L"+itemStackClassName+";I)"+Type.BOOLEAN_TYPE.
         * getDescriptor(),null,null);
         * System.out.println(" 	**Patch status: generated a MethodNode "+method_setMRU+" with methodname "
         * +method_setMRU.name);
         * System.out.println(" 	**Patch status: creating an Instruction List for "+method_setMRU+" with methodname "
         * +method_setMRU.name);
         * System.out.println("		***Patch status: creating method body");
         ...
         * mv.visitVarInsn(Opcodes.ILOAD, 2);
         * mv.visitInsn(Opcodes.IADD);
         * mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, nbttagcompoundClassName, method_setInt, "(Ljava/lang/String;I)V",
         * false);
         * Label l3 = new Label();
         * mv.visitLabel(l3);
         ...
         * if(method.name.equals(method_onUpdate) &&
         * method.desc.equals("(L"+itemStackClassName+";L"+worldClassName+";L"+entityClassName+";IZ)V"))
         * {
         ...
         * toInject.add(new FieldInsnNode(Opcodes.GETFIELD, toolClass.replace('.', '/'), "maxMRU",
         * Type.INT_TYPE.getDescriptor()));
         * toInject.add(new MethodInsnNode(Opcodes.INVOKESTATIC, ecutils, "initMRUTag",
         * "(L"+itemStackClassName+";I)V",false));
         * instructions.insert(method.instructions.get(1), toInject);
         * System.out.println(" *Patch status: success patching instructions in target method: "+method_onUpdate+
         * "(onUpdate)?");
         * break fcn;
         * }
         * }
