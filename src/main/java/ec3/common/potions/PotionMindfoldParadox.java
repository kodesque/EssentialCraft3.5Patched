...
public class PotionMindfoldParadox extends Potion {
    ...
    public void performEffect(EntityLivingBase p_76394_1_, int p_76394_2_) {
        int duration = p_76394_1_.getActivePotionEffect(ECPotions.paradox)
            .getDuration();
        if (duration == 2000) {
            if (p_76394_1_.worldObj.isRemote) p_76394_1_.worldObj.playSound(
                p_76394_1_.posX,
                p_76394_1_.posY,
                p_76394_1_.posZ,
                "essentialcraft:sound.tinnitus",
                100,
                1,
                true);
    ...
    public void renderInventoryEffect(int x, int y, PotionEffect effect, Minecraft mc) {
        ...
        mc.fontRenderer
            .drawStringWithShadow(StatCollector.translateToLocal("potion.paradox.txt"), x + 10 + 18, y + 16, 16777215);
    }
