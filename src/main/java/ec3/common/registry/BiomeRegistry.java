...
public class BiomeRegistry {
    ...
    public void registerFirstWorldBiomes() {
        ...
        firstWorldBiomeArray[4] = new BiomeGenFirstWorld_Dreadlands(Config.biomeID[5]).setGrassColor(0x889688)
        ...
        firstWorldBiomeArray[8] = new BiomeGenFirstWorld_Desert(Config.biomeID[4]).setBiomeName("desert")
            .setColor(16421912)
            .setDisableRain()
            .setTemperatureRainfall(2.0F, 0.0F)
