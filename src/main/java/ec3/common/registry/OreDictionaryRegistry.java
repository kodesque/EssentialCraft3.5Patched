...
public class OreDictionaryRegistry {
    ...
    public static void register() {
        ...
        OreDictionary
            .registerOre("iceCompressed", new ItemStack(BlocksCore.coldStone, 1, OreDictionary.WILDCARD_VALUE));
        OreDictionary.registerOre("blockVoid", new ItemStack(BlocksCore.voidStone, 1, OreDictionary.WILDCARD_VALUE));
        OreDictionary
            .registerOre("blockVoidStone", new ItemStack(BlocksCore.voidStone, 1, OreDictionary.WILDCARD_VALUE));
        ...
        OreDictionary
            .registerOre("blockGlassVoid", new ItemStack(BlocksCore.voidGlass, 1, OreDictionary.WILDCARD_VALUE));
        OreDictionary.registerOre("voidGlass", new ItemStack(BlocksCore.voidGlass, 1, OreDictionary.WILDCARD_VALUE));
        OreDictionary
            .registerOre("blockVoidGlass", new ItemStack(BlocksCore.voidGlass, 1, OreDictionary.WILDCARD_VALUE));
        ...
        OreDictionary
            .registerOre("blockPalePlating", new ItemStack(BlocksCore.platingPale, 1, OreDictionary.WILDCARD_VALUE));
        OreDictionary.registerOre(
            "blockMitrilinePlating",
            new ItemStack(BlocksCore.invertedBlock, 1, OreDictionary.WILDCARD_VALUE));
