...
public class RecipeRegistry {
    ...
    public void registerRecipes() {
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.drops, 4, 4),
                new Object[] { "shardFire", "shardWater", "shardEarth", "shardAir" }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.mruMover1, 1, 0),
                new Object[] { "shardElemental", "stickWood" }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.magicalChisel, 1, 0),
        ...
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                ...
                new Object[] { "ingotThaumium", "ingotThaumium", "ingotThaumium", "ingotThaumium", "ingotThaumium",
                    "ingotThaumium", "ingotThaumium", "ingotThaumium", new ItemStack(ItemsCore.genericItem, 1, 23) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.playerList, 1, 0),
                new Object[] { Items.paper, new ItemStack(ItemsCore.bound_gem, 1, 0) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.holopad),
                new Object[] { "TVT", "TET", "THT", 'T', ItemsCore.twinkling_titanite, 'V', gen(36), 'H', gen(59), 'E',
                    new ItemStack(ItemsCore.storage, 1, 4) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.blockPale, 1, 0),
                new Object[] { "ISI", "SES", "ISI", 'I', getItemByNameEC3("genericItem", 39), 'S', Blocks.lapis_block,
                    'E', getItemByNameEC3("genericItem", 38) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.furnaceMagic, 1, 0),
                new Object[] { "III", "IEI", "III", 'I', new ItemStack(ItemsCore.genericItem, 1, 7), 'E', "rodHeat" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.furnaceMagic, 1, 4),
                new Object[] { "III", "IEI", "III", 'I', new ItemStack(ItemsCore.genericItem, 1, 34), 'E',
                    new ItemStack(BlocksCore.furnaceMagic, 1, 0) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.furnaceMagic, 1, 8),
                new Object[] { "III", "IEI", "III", 'I', new ItemStack(ItemsCore.genericItem, 1, 41), 'E',
                    new ItemStack(BlocksCore.furnaceMagic, 1, 4) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.furnaceMagic, 1, 12),
                new Object[] { "III", "IEI", "III", 'I', new ItemStack(ItemsCore.genericItem, 1, 35), 'E',
                    new ItemStack(BlocksCore.furnaceMagic, 1, 8) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 1),
                new Object[] { "ISI", "SES", "ISI", 'I', "ingotIron", 'S', "stone", 'E', "shardElemental" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.mruMover_t2, 1, 0),
                new Object[] { " SI", " ES", "E  ", 'I', "gemDiamond", 'S', "plateGlass", 'E', "ingotMagic" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 21),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 3, 24),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 4, 26),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 8, 28),
                new Object[] { "SPS", "EGE", "GGG", 'G', "ec3:ingotGold", 'E', "gemEmerald", 'P', "ec3:gemEnderPearl",
                    'S', "shardElemental" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 8, 29),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.matrixAbsorber, 1, 0),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.controlRod, 1, 0),
                new Object[] { "DII", " CI", "I D", 'I', "ingotIron", 'C', "elementalCore", 'D', "waterMagic" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.magicalMirror, 3, 0),
                new Object[] { " P ", "PGP", " P ", 'P', "plateMagic", 'G', "plateGlass" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.filter, 1, 0),
                new Object[] { " P ", "PGP", " P ", 'P', "plateFortified", 'G', Blocks.crafting_table }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.filter, 1, 1),
                new Object[] { " P ", "PGP", " P ", 'P', "plateVoid", 'G', ItemsCore.filter }));
        addRecipe(
            new ItemStack(ItemsCore.magicalBuilder, 1, 0),
            new Object[] { new ItemStack(BlocksCore.rightClicker, 1, OreDictionary.WILDCARD_VALUE), "plateVoid",
                "voidCore", new ItemStack(ItemsCore.filter, 1, 0), new ItemStack(ItemsCore.magicalDigger, 1, 0),
                "plateVoid", "plateMagic", new ItemStack(ItemsCore.filter, 1, 0),
                new ItemStack(BlocksCore.rightClicker, 1, OreDictionary.WILDCARD_VALUE) });
        GameRegistry.addShapelessRecipe(
            new ItemStack(ItemsCore.magicalBuilder, 1, 1),
            new ItemStack(ItemsCore.magicalBuilder, 1, 0));
        GameRegistry.addShapelessRecipe(
            new ItemStack(ItemsCore.magicalBuilder, 1, 2),
            new ItemStack(ItemsCore.magicalBuilder, 1, 1));
        GameRegistry.addShapelessRecipe(
            new ItemStack(ItemsCore.magicalBuilder, 1, 3),
            new ItemStack(ItemsCore.magicalBuilder, 1, 2));
        GameRegistry.addShapelessRecipe(
            new ItemStack(ItemsCore.magicalBuilder, 1, 4),
            new ItemStack(ItemsCore.magicalBuilder, 1, 3));
        GameRegistry.addShapelessRecipe(
            new ItemStack(ItemsCore.magicalBuilder, 1, 0),
            new ItemStack(ItemsCore.magicalBuilder, 1, 4));
        ...
        addRecipe(
            new ItemStack(BlocksCore.mithrilineCrystal, 1, 0),
        ...
        addRecipe(
            new ItemStack(BlocksCore.mithrilineCrystal, 1, 3),
            new Object[] { "dustFading", "gemFading", "dustFading", "dustFading",
                new ItemStack(BlocksCore.mithrilineCrystal, 1, 0), "dustFading", "dustFading", "gemFading",
                "dustFading", });
        addRecipe(
            new ItemStack(BlocksCore.mithrilineCrystal, 1, 6),
            new Object[] { "plateVoid", "voidCore", "plateVoid", "plateVoid",
                new ItemStack(BlocksCore.mithrilineCrystal, 1, 3), "plateVoid", "plateVoid", "voidMRU", "plateVoid", });
        addRecipe(
            new ItemStack(BlocksCore.mithrilineCrystal, 1, 9),
            new Object[] { "ingotDemonic", "demonicCore", "ingotDemonic", "ingotDemonic",
                new ItemStack(BlocksCore.mithrilineCrystal, 1, 6), "ingotDemonic", "ingotDemonic", "demonicCore",
                "ingotDemonic", });
        addRecipe(
            new ItemStack(BlocksCore.ecBalancer, 1, 0),
        ...
        addRecipe(
            new ItemStack(BlocksCore.ecRedstoneController, 1, 0),
        ...
        addRecipe(
            new ItemStack(ItemsCore.genericItem, 1, 53),
        ...
        addRecipe(
            new ItemStack(BlocksCore.ecHoldingChamber, 1, 0),
        ...
        addRecipe(
            new ItemStack(BlocksCore.rayTower, 4, 0),
            new Object[] { "magicWater", "conversionMatrix", "magicWater", "plateFortified", "mruCatcher",
                "plateFortified", new ItemStack(BlocksCore.fortifiedStone, 1, 0), "screenMagic",
                new ItemStack(BlocksCore.fortifiedStone, 1, 0), });

        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.magicPlating, 16, 0),
        ...
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.platingPale, 16, 0),
        ...
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.invertedBlock, 16, 0),
        ...
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.demonicPlating, 16, 0),
        ...
        addRecipe(
            new ItemStack(BlocksCore.potionSpreader, 1, 0),
            1000,
        ...
        addRecipe(
            new ItemStack(BlocksCore.magicalEnchanter, 1, 0),
            5000,
            new Object[] { "screenMagic", new ItemStack(Items.enchanted_book, 1, 0), "mruCatcher", "worldInteractor",
                ...
                "plateMagic", });
        addRecipe(
            new ItemStack(BlocksCore.monsterHarvester, 1, 0),
            10000,
            new Object[] { "plateMagic", "screenMagic", "mruCatcher", new ItemStack(ItemsCore.staffOfLife, 1, 0),
                "elementalCore", "conversionMatrix", "worldInteractor", "frameMagic", "worldInteractor", });
        addRecipe(
            new ItemStack(BlocksCore.magicalRepairer, 1, 0),
            2000,
         ...
         */
        addRecipe(
            new ItemStack(BlocksCore.ecAcceptor, 1, 0),
        ...
        addRecipe(
            ...
            1000,
            new Object[] { "screenMagic", "mruCatcher", "conversionMatrix", new ItemStack(BlocksCore.coldStone),
                "elementalCore", new ItemStack(BlocksCore.coldStone), "plateMagic",
                new ItemStack(ItemsCore.matrixProj, 1, 2), "worldInteractor", });
        addRecipe(
            new ItemStack(BlocksCore.magmaticSmeltery, 1, 0),
            8000,
        ...
        addRecipe(
            new ItemStack(BlocksCore.magicalJukebox, 1, 0),
            404,
            new Object[] { "plateMagic", "mruCatcher", "worldInteractor", "elementalCore",
                ...
                "plateRedstone", });
        addRecipe(
            new ItemStack(BlocksCore.crystalFormer, 1, 0),
            1200,
        ...
        addRecipe(
            ...
            new Object[] { "plateFortified", "frameMagic", "plateFortified", "screenMagic",
                new ItemStack(ItemsCore.magicalDigger, 1, 0), "mruCatcher", "worldInteractor", "elementalCore",
                "worldInteractor", });
        addRecipe(
            new ItemStack(BlocksCore.monsterClinger, 1, 0),
            8000,
        ...
        addRecipe(
            new ItemStack(BlocksCore.crystalExtractor, 1, 0),
            1000,
        ...
        addRecipe(
            ...
            new Object[] { "elementalCore", "mruCatcher", "frameMagic", "screenMagic",
                new ItemStack(ItemsCore.storage, 1, 3), "conversionMatrix", "plateMagic", "mruLink", "plateMagic", });
        addRecipe(
            new ItemStack(BlocksCore.voidGlass, 32, 0),
            new Object[] { "titanite", "frameMagic", "titanite", "frameMagic", "ttitanite", "frameMagic", "titanite",
                "frameMagic", "titanite", });
        // TODO Computer Guy's recipes
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 69),
                new Object[] { "#R#", "LQL", "#R#", '#', "plateDemonic", 'R', "dustRedstone", 'L', "gemLapis", 'Q',
                    "gemQuartz" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 68),
                new Object[] { "#@#", "@C@", "#@#", '#', "plateDemonic", '@', gen(47), 'C', gen(55) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 74),
                new Object[] { "#@#", "@C@", "#@#", '#', "plateDemonic", '@', gen(48), 'C', gen(55) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 67),
                new Object[] { "#@#", "@C@", "#@#", '#', "plateDemonic", '@', gen(44), 'C', gen(68) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 66),
                new Object[] { "#@#", "@C@", "#@#", '#', "plateDemonic", '@', gen(47), 'C', gen(74) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 2, 59),
                new Object[] { "#C#", "@#@", "#C#", '#', "plateDemonic", '@', gen(0), 'C', gen(55) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 65),
                new Object[] { "#@#", "@C@", "#@#", '#', gen(41), '@', "demonicCore", 'C', gen(37) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 63),
                new Object[] { "#@#", "ACA", "#@#", '#', gen(59), '@', gen(74), 'C', gen(9), 'A', gen(32) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 64),
                new Object[] { "#@#", "@C@", "#@#", '#', gen(74), '@', gen(59), 'C', gen(75) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 60),
                new Object[] { "#@#", "@@@", "#@#", '#', gen(74), '@', gen(59) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 62),
                new Object[] { "#@#", "$#$", "P#P", '#', gen(68), '@', gen(67), '$', gen(60), 'P', gen(59) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 56),
                new Object[] { "#+#", "/C*", "#-#", '#', gen(59), 'C', gen(69), '+', gen(70), '-', gen(73), '*',
                    gen(72), '/', gen(71) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 61),
                new Object[] { "#@#", "@C@", "#@#", '#', gen(67), '@', gen(68), 'C', gen(59) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 58),
                new Object[] { "#@#", "@C@", "#@#", '#', gen(66), '@', gen(67), 'C', gen(65) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 57),
                new Object[] { "#@#", "@C@", "#@#", '#', gen(68), '@', gen(65), 'C',
                    new ItemStack(ItemsCore.storage, 1, 4) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.genericItem, 1, 75),
        ...
        // TODO 4.5 recipes
        addRecipe(
            new ItemStack(BlocksCore.mithrilineFurnace, 1, 0),
        ...
        addRecipe(
            new ItemStack(BlocksCore.playerPentacle, 1, 0),
            new Object[] { "dustMithriline", ItemsCore.matrixProj, "dustMithriline", ItemsCore.matrixProj,
                ItemsCore.soulStone, ItemsCore.matrixProj, "dustMithriline", ItemsCore.matrixProj, "dustMithriline", });
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.redstoneTransmitter, 2, 0),
                new Object[] { "   ", "RTR", "SSS", 'S', BlocksCore.fortifiedStone, 'R', "dustRedstone", 'T',
                    Blocks.redstone_torch }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.magicalHopper, 1, 0),
                new Object[] { "SHS", "SCS", "SDS", 'S', BlocksCore.fortifiedStone, 'H', Blocks.hopper, 'C',
                    Blocks.chest, 'D', Blocks.dropper }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.rightClicker, 1, 0),
                new Object[] { "SSS", "DID", "SPS", 'S', BlocksCore.fortifiedStone, 'P', Blocks.piston, 'I',
                    Blocks.dispenser, 'D', Blocks.dropper }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.windRune, 1, 0),
                new Object[] { "MPM", "PEP", "MPM", 'M', BlocksCore.invertedBlock, 'E', "elementalCore", 'P',
                    "plateMithriline" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.metadataManager, 1, 0),
                new Object[] { "SSS", "SBR", "SSS", 'S', BlocksCore.fortifiedStone, 'R', "dustRedstone", 'B',
                    ItemsCore.bound_gem }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.blockBreaker, 1, 0),
                new Object[] { "SSS", "SRP", "SSS", 'S', BlocksCore.fortifiedStone, 'R', "dustRedstone", 'P',
                    ItemsCore.weak_elemental_pick }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.rightClicker, 1, 1),
                new Object[] { new ItemStack(BlocksCore.rightClicker, 1, 0), new ItemStack(Items.slime_ball, 1, 0) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.rightClicker, 1, 2),
                new Object[] { new ItemStack(BlocksCore.rightClicker, 1, 0), new ItemStack(Blocks.chest, 1, 0) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.rightClicker, 1, 3),
                new Object[] { new ItemStack(BlocksCore.rightClicker, 1, 2), new ItemStack(Items.slime_ball, 1, 0) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.rightClicker, 1, 4),
                new Object[] { new ItemStack(BlocksCore.rightClicker, 1, 2), new ItemStack(Items.redstone, 1, 0) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.rightClicker, 1, 5),
                new Object[] { new ItemStack(BlocksCore.rightClicker, 1, 4), new ItemStack(Items.slime_ball, 1, 0) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(BlocksCore.compressed, 1, 0),
                new Object[] { new ItemStack(ItemsCore.drops, 1, 0), new ItemStack(ItemsCore.drops, 1, 0),
                    new ItemStack(ItemsCore.drops, 1, 0), new ItemStack(ItemsCore.drops, 1, 0),
                    new ItemStack(ItemsCore.drops, 1, 0), new ItemStack(ItemsCore.drops, 1, 0),
                    new ItemStack(ItemsCore.drops, 1, 0), new ItemStack(ItemsCore.drops, 1, 0),
        ...
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                ...
                new Object[] { new ItemStack(ItemsCore.drops, 1, 1), new ItemStack(ItemsCore.drops, 1, 1),
                    new ItemStack(ItemsCore.drops, 1, 1), new ItemStack(ItemsCore.drops, 1, 1),
                    new ItemStack(ItemsCore.drops, 1, 1), new ItemStack(ItemsCore.drops, 1, 1),
                    new ItemStack(ItemsCore.drops, 1, 1), new ItemStack(ItemsCore.drops, 1, 1),
        ...
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                ...
                new Object[] { new ItemStack(ItemsCore.drops, 1, 2), new ItemStack(ItemsCore.drops, 1, 2),
                    new ItemStack(ItemsCore.drops, 1, 2), new ItemStack(ItemsCore.drops, 1, 2),
                    new ItemStack(ItemsCore.drops, 1, 2), new ItemStack(ItemsCore.drops, 1, 2),
                    new ItemStack(ItemsCore.drops, 1, 2), new ItemStack(ItemsCore.drops, 1, 2),
        ...
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                ...
                new Object[] { new ItemStack(ItemsCore.drops, 1, 3), new ItemStack(ItemsCore.drops, 1, 3),
                    new ItemStack(ItemsCore.drops, 1, 3), new ItemStack(ItemsCore.drops, 1, 3),
                    new ItemStack(ItemsCore.drops, 1, 3), new ItemStack(ItemsCore.drops, 1, 3),
                    new ItemStack(ItemsCore.drops, 1, 3), new ItemStack(ItemsCore.drops, 1, 3),
        ...
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                ...
                new Object[] { new ItemStack(ItemsCore.drops, 1, 4), new ItemStack(ItemsCore.drops, 1, 4),
                    new ItemStack(ItemsCore.drops, 1, 4), new ItemStack(ItemsCore.drops, 1, 4),
                    new ItemStack(ItemsCore.drops, 1, 4), new ItemStack(ItemsCore.drops, 1, 4),
                    new ItemStack(ItemsCore.drops, 1, 4), new ItemStack(ItemsCore.drops, 1, 4),
                    new ItemStack(ItemsCore.drops, 1, 4), }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.drops, 9, 0),
                new Object[] { new ItemStack(BlocksCore.compressed, 1, 0) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.drops, 9, 1),
                new Object[] { new ItemStack(BlocksCore.compressed, 1, 1) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.drops, 9, 2),
                new Object[] { new ItemStack(BlocksCore.compressed, 1, 2) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.drops, 9, 3),
                new Object[] { new ItemStack(BlocksCore.compressed, 1, 3) }));
        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.drops, 9, 4),
                new Object[] { new ItemStack(BlocksCore.compressed, 1, 4) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.demonicPentacle, 1, 0),
                new Object[] { "FVF", "VCV", "FVF", 'F', "focusFire", 'V', "plateVoid", 'C', "voidCore" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.weaponMaker, 1, 0),
                new Object[] { "SIS", "SCS", "SSS", 'S', BlocksCore.fortifiedStone, 'I',
                    Blocks.heavy_weighted_pressure_plate, 'C', Blocks.crafting_table }));
        GameRegistry.addShapelessRecipe(
            new ItemStack(BlocksCore.weaponMaker, 1, 1),
            new ItemStack(BlocksCore.weaponMaker, 1, 0));
        GameRegistry.addShapelessRecipe(
            new ItemStack(BlocksCore.weaponMaker, 1, 2),
            new ItemStack(BlocksCore.weaponMaker, 1, 1));
        GameRegistry.addShapelessRecipe(
            new ItemStack(BlocksCore.weaponMaker, 1, 3),
            new ItemStack(BlocksCore.weaponMaker, 1, 2));
        GameRegistry.addShapelessRecipe(
            new ItemStack(BlocksCore.weaponMaker, 1, 0),
            new ItemStack(BlocksCore.weaponMaker, 1, 3));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_elemental_hoe, 1, 0),
                new Object[] { "DD ", " S ", " S ", 'D', "gemWind", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_elemental_axe, 1, 0),
                new Object[] { "DD ", "DS ", " S ", 'D', "gemWind", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_elemental_pick, 1, 0),
                new Object[] { "DDD", " S ", " S ", 'D', "gemWind", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_elemental_shovel, 1, 0),
                new Object[] { " D ", " S ", " S ", 'D', "gemWind", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_elemental_sword, 1, 0),
                new Object[] { " D ", " D ", " S ", 'D', "gemWind", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.soulScriber, 1, 0),
                new Object[] { "N", "Q", "S", 'N', Items.netherbrick, 'S', "stickWood", 'Q', Items.quartz }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.weak_elemental_hoe, 1, 0),
                new Object[] { "DD ", " S ", " S ", 'D', "blockElemental", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.weak_elemental_axe, 1, 0),
                new Object[] { "DD ", "DS ", " S ", 'D', "blockElemental", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.weak_elemental_pick, 1, 0),
                new Object[] { "DDD", " S ", " S ", 'D', "blockElemental", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.weak_elemental_shovel, 1, 0),
                new Object[] { " D ", " S ", " S ", 'D', "blockElemental", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.weak_elemental_sword, 1, 0),
                new Object[] { " D ", " D ", " S ", 'D', "blockElemental", 'S', "stickWood" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_helmet, 1, 0),
                new Object[] { "DDD", "D D", 'D', "gemWind" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_chestplate, 1, 0),
                new Object[] { "D D", "DDD", "DDD", 'D', "gemWind" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_leggings, 1, 0),
                new Object[] { "DDD", "DDD", "D D", 'D', "gemWind" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wind_boots, 1, 0),
                new Object[] { "D D", "D D", 'D', "gemWind" }));

        // TODO 4.6 Recipes
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.chest, 1, 0),
                new Object[] { "###", "# #", "###", '#',
                    new ItemStack(BlocksCore.magicPlating, 1, OreDictionary.WILDCARD_VALUE) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.chest, 1, 1),
                new Object[] { "###", "# #", "###", '#',
                    new ItemStack(BlocksCore.voidStone, 1, OreDictionary.WILDCARD_VALUE) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.device, 1, 0),
                new Object[] { "#@#", "#R#", "###", '#',
                    new ItemStack(BlocksCore.fortifiedStone, 1, OreDictionary.WILDCARD_VALUE), 'R', "dustRedstone", '@',
                    ItemsCore.weak_elemental_hoe }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.device, 1, 1),
                new Object[] { "#@#", "#R#", "###", '#',
                    new ItemStack(BlocksCore.fortifiedStone, 1, OreDictionary.WILDCARD_VALUE), 'R', "dustRedstone", '@',
                    Items.water_bucket }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.device, 1, 2),
                new Object[] { "#@#", "#R#", "#@#", '#',
                    new ItemStack(BlocksCore.fortifiedStone, 1, OreDictionary.WILDCARD_VALUE), 'R', "dustRedstone", '@',
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.device, 1, 3),
                new Object[] { "#@#", "#R#", "###", '#',
                    new ItemStack(BlocksCore.fortifiedStone, 1, OreDictionary.WILDCARD_VALUE), 'R', "dustRedstone", '@',
                    Blocks.hay_block }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.device, 1, 5),
                new Object[] { "#@#", "#R#", "###", '#',
                    new ItemStack(BlocksCore.fortifiedStone, 1, OreDictionary.WILDCARD_VALUE), 'R', "dustRedstone", '@',
                    Items.shears }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.device, 1, 6),
                new Object[] { "#@#", "#R#", "###", '#',
                    new ItemStack(BlocksCore.fortifiedStone, 1, OreDictionary.WILDCARD_VALUE), 'R', "dustRedstone", '@',
                    Items.golden_apple }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.device, 1, 7),
                new Object[] { "#@#", "#R#", "###", '#',
                    new ItemStack(BlocksCore.fortifiedStone, 1, OreDictionary.WILDCARD_VALUE), 'R', "dustRedstone", '@',
                    Items.apple }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.advBreaker, 1, 0),
                new Object[] { " R ", "RBR", " C ", 'B', BlocksCore.blockBreaker, 'R', "dustRedstone", 'C',
                    Blocks.chest }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.craftingFrame, 1, 0),
                new Object[] { "#@#", "@#@", "#@#", '#', Blocks.crafting_table, '@', "plateFortified" }));

        GameRegistry.addRecipe(
            new ShapelessOreRecipe(
                new ItemStack(ItemsCore.inventoryGem, 1, 0),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.filter, 1, 3),
                new Object[] { " @ ", "@#@", " @ ", '#', new ItemStack(ItemsCore.filter, 1, 2), '@', "plateVoid" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.mimEjector),
                new Object[] { " @ ", "#C#", "#E#", '#', gen(34), '@', "ec3:gemEnderPearl", 'C', "elementalCore", 'E',
                    "plateEnder" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.mimInjector),
                new Object[] { " @ ", "#C#", "#E#", '#', gen(34), '@', gen(23), 'C', "elementalCore", 'E',
                    "plateEnder" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.mimEjectorP),
                new Object[] { " @ ", "#C#", "#E#", '#', "plateMithriline", '@', "ec3:gemEnderPearl", 'C',
                    "elementalCore", 'E', "plateEnder" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.mimInjectorP),
                new Object[] { " @ ", "#C#", "#E#", '#', "plateMithriline", '@', gen(23), 'C', "elementalCore", 'E',
                    "plateEnder" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.newMim),
                new Object[] { "VPV", "CRC", "PMP", 'P', "plateVoid", 'V', new ItemStack(BlocksCore.chest, 1, 1), 'C',
                    "voidCore", 'R', "voidMRU", 'M', "redSoulMatter" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.mimScreen),
                new Object[] { "DDD", "PCP", "PMP", 'P', "plateMagic", 'D', "screenMagic", 'C', "elementalCore", 'M',
                    "mruCatcher" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.mimInvStorage),
                new Object[] { "PPP", "SCS", "PPP", 'P', "plateMagic", 'C', "elementalCore", 'S', BlocksCore.chest }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.mimCrafter),
                new Object[] { "PPP", "SCS", "PPP", 'P', "plateMagic", 'C', "elementalCore", 'S',
                    Blocks.crafting_table }));

        addRecipe(
            new ItemStack(BlocksCore.voidStone, 16, 0),
        ...
        addRecipe(
            ...
            10000,
            new Object[] { "screenMagic", new ItemStack(ItemsCore.genericItem, 1, 32), "mruCatcher", "worldInteractor",
                "elementalCore", "conversionMatrix", "plateMagic", new ItemStack(ItemsCore.matrixProj, 1, 1),
                "plateMagic", });
        addRecipe(
            new ItemStack(BlocksCore.moonWell, 1, 0),
            10000,
            new Object[] { "screenMagic", new ItemStack(BlocksCore.elementalCrystal, 1, 0), "mruCatcher",
                "worldInteractor", "elementalCore", "conversionMatrix", "plateMagic",
                new ItemStack(ItemsCore.matrixProj, 1, 3), "plateMagic", });
        ...
        addRecipe(
            new ItemStack(ItemsCore.biomeWand, 1, 0),
            1200,
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.magicMonocle, 1, 0),
                new Object[] { " DS", " D ", " D ", 'D', new ItemStack(ItemsCore.genericItem, 1, 10), 'S',
                    "plateGlass" }));

        addRecipe(
            new ItemStack(ItemsCore.genericItem, 1, 17),
        ...
        addRecipe(
            new ItemStack(ItemsCore.genericItem, 3, 18),
        ...
        addRecipe(
            new ItemStack(ItemsCore.genericItem, 1, 80),
        ...
        addRecipe(
            new ItemStack(ItemsCore.genericItem, 1, 81),
        ...
        addRecipe(
            new ItemStack(ItemsCore.spawnerCollector, 1, 0),
            10000,
            new Object[] { "dustCrystal", "focusWater", "focusWater", "ingotMagic", "redSoulMatter", "focusWater",
                "plateMagic", "ingotMagic", "dustCrystal", });

        addRecipe(
            new ItemStack(ItemsCore.magicalDigger, 1, 0),
            10000,
            new Object[] { Blocks.tnt, "focusEarth", "redSoulMatter", "focusFire", ItemsCore.elemental_pick,
                "focusEarth", "plateMagic", "focusFire", Blocks.tnt, });

        addRecipe(
            new ItemStack(ItemsCore.staffOfLife, 1, 0),
            1000,
            new Object[] { ItemsCore.elemental_hoe, "focusEarth", new ItemStack(ItemsCore.genericItem, 1, 4),
                "focusEarth", "redSoulMatter", "focusEarth", "plateMagic", "focusEarth", ItemsCore.elemental_hoe, });

        addRecipe(
            new ItemStack(ItemsCore.emeraldHeart, 1, 0),
            5000,
        ...
        addRecipe(
            ...
            10000,
            new Object[] { ItemsCore.elemental_sword, "gemNetherStar", ItemsCore.elemental_sword, "alloysMagical",
                ItemsCore.magicalShield, "alloysMagical", "alloysMagical", "matterOfEternity", "alloysMagical", });
        addRecipe(
            new ItemStack(ItemsCore.magicWaterBottle, 1, 0),
            5000,
            new Object[] { "focusAir", "magicWater", "focusEarth", "plateDiamond", "redSoulMatter", "plateDiamond",
                "focusWater", "magicWater", "focusWater", });
        addRecipe(
            new ItemStack(ItemsCore.magicalPorkchop, 1, 0),
            5000,
            new Object[] { "focusEarth", Items.porkchop, "focusEarth", "dustCrystal", "redSoulMatter", "dustCrystal",
                "focusWater", "dustCrystal", "focusWater", });
        addRecipe(
            new ItemStack(ItemsCore.magicalWings, 1, 0),
            5000,
            new Object[] { "plateMagic", "focusAir", "focusAir", "plateMagic", Items.feather, Items.feather,
                "redSoulMatter", Items.feather, Items.feather, });
        addRecipe(
            new ItemStack(ItemsCore.holyMace, 1, 0),
            1000,
            new Object[] { "redSoulMatter", "focusAir", new ItemStack(ItemsCore.genericItem, 1, 4), "ingotMagic",
                ItemsCore.elemental_sword, "focusAir", "focusEarth", "ingotMagic", "redSoulMatter", });
        addRecipe(
            new ItemStack(ItemsCore.chaosFork, 1, 0),
            10000,
            new Object[] { "ingotMagic", "focusFire", "matterOfEternity", "ingotMagic", ItemsCore.elemental_sword,
                "focusFire", new ItemStack(ItemsCore.matrixProj, 1, 1), "ingotMagic", "ingotMagic", });
        addRecipe(
            new ItemStack(ItemsCore.frozenMace, 1, 0),
            10000,
            new Object[] { "ingotMagic", "focusWater", "matterOfEternity", "ingotMagic", ItemsCore.elemental_sword,
                "focusWater", new ItemStack(ItemsCore.matrixProj, 1, 2), "ingotMagic", "ingotMagic", });

        addRecipe(
            new ItemStack(ItemsCore.windTablet, 1, 0),
            10000,
            new Object[] { "focusAir", "plateFortified", "focusAir", "plateFortified", ItemsCore.windKeeper,
                "plateFortified", "focusAir", "plateFortified", "focusAir", });

        addRecipe(
            new ItemStack(BlocksCore.magicalTeleporter, 1, 0),
            10000,
         ...
         */
        addRecipe(
            new ItemStack(BlocksCore.ultraHeatGen, 1, 0),
            5000,
            new Object[] { "plateVoid", "voidMRU", "plateVoid", "voidCore", new ItemStack(BlocksCore.heatGenerator),
                "voidCore", "plateVoid", "voidMRU", "plateVoid", });
        addRecipe(
            new ItemStack(BlocksCore.ultraFlowerBurner, 1, 0),
            5000,
            new Object[] { "plateVoid", "voidMRU", "plateVoid", "voidCore", new ItemStack(BlocksCore.naturalFurnace),
                "voidCore", "plateVoid", "voidMRU", "plateVoid", });

        addRecipe(
            new ItemStack(BlocksCore.magicalFurnace, 1, 0),
            10000,
            new Object[] { "screenMagic", "voidMRU", "worldInteractor", "plateFortified", "voidCore", "plateFortified",
                "plateVoid", "matterOfEternity", "plateVoid", });

        addRecipe(
            new ItemStack(BlocksCore.emberForge, 1, 0),
            10000,
        ...
        addRecipe(
            ...
            new Object[] { "gemNetherStar", "voidMRU", "gemNetherStar", "voidCore",
                new ItemStack(ItemsCore.magicArmorItems[0], 1, 0), "voidCore", "plateVoid", "matterOfEternity",
                "plateVoid", });
        ...
        addRecipe(
            ...
            new Object[] { "voidMRU", "gemNetherStar", "voidMRU", "voidCore",
                new ItemStack(ItemsCore.magicArmorItems[1], 1, 0), "voidCore", "plateVoid", "matterOfEternity",
                "plateVoid", });
        ...
        addRecipe(
            ...
            10000,
            new Object[] { "gemNetherStar", "voidMRU", "gemNetherStar", "voidCore",
                new ItemStack(ItemsCore.magicArmorItems[2], 1, 0), "voidCore", "plateVoid", "matterOfEternity",
                "plateVoid", });
        ...
        addRecipe(
            ...
            10000,
            new Object[] { "gemNetherStar", "voidMRU", "gemNetherStar", "voidCore",
                new ItemStack(ItemsCore.magicArmorItems[3], 1, 0), "voidCore", "plateVoid", "matterOfEternity",
                "plateVoid", });

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.fence[0], 16, 0),
                new Object[] { "   ", "DDD", "DDD", 'D', BlocksCore.voidStone }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.fence[1], 16, 0),
                new Object[] { "   ", "DDD", "DDD", 'D', BlocksCore.magicPlating }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BlocksCore.fence[2], 16, 0),
                new Object[] { "   ", "DDD", "DDD", 'D', BlocksCore.fortifiedStone }));

        addRecipe(
            new ItemStack(ItemsCore.magmaticStaff, 1, 0),
            1000,
            new Object[] { "focusFire", "focusFire", BlocksCore.magmaticSmeltery, "dustCrystal", "matterOfEternity",
                "focusFire", "plateMagic", "dustCrystal", "focusFire", });

        addRecipe(
            new ItemStack(ItemsCore.magicalLantern, 1, 0),
            1000,
            new Object[] { "focusAir", "focusFire", "redSoulMatter", ItemsCore.magicalSlag, "plateMagic", "focusFire",
                "plateMagic", ItemsCore.magicalSlag, "focusAir", });

        addRecipe(
            new ItemStack(ItemsCore.magnetizingStaff, 1, 0),
            1000,
            new Object[] { "focusAir", "orbGold", "darkSoulMatter", ItemsCore.magicalSlag, "plateMagic", "orbGold",
                "plateMagic", ItemsCore.magicalSlag, "focusAir", });

        addRecipe(
            new ItemStack(BlocksCore.mruCoilHardener, 3, 0),
            1000,
        ...
        addRecipe(
            new ItemStack(BlocksCore.corruptionCleaner, 1, 0),
            1000,
        ...
        addRecipe(
            new ItemStack(BlocksCore.reactorSupport, 2, 0),
            10000,
        ...
        addRecipe(
            ...
            10000,
            new Object[] { new ItemStack(ItemsCore.matrixProj, 1, 3), "gemNetherStar",
                new ItemStack(ItemsCore.matrixProj, 1, 3), "resonatingCrystal", "magnet", "resonatingCrystal",
    ...
    public void registerRadiatingChamber() {
        ...
        RadiatingChamberRecipes.addRecipeIS(
            ...
            4);
        RadiatingChamberRecipes.addRecipeIS(
            new ItemStack[] { new ItemStack(BlocksCore.blockPale, 1, 0), new ItemStack(Items.diamond) },
            ...
            4);
        RadiatingChamberRecipes.addRecipeIS(
            new ItemStack[] { new ItemStack(BlocksCore.blockPale, 1, 0), new ItemStack(Items.emerald) },
            getItemByNameEC3("genericItem", 40),
            300,
            new float[] { Float.MAX_VALUE, Float.MIN_VALUE },
            100,
            4);
        RadiatingChamberRecipes.addRecipeIS(
            new ItemStack[] { new ItemStack(Blocks.stone), new ItemStack(ItemsCore.drops, 1, 4) },
            ...
            1);
        RadiatingChamberRecipes.addRecipeIS(
            new ItemStack[] { new ItemStack(Items.iron_ingot), new ItemStack(ItemsCore.genericItem, 1, 3) },
    ...
    public void registerMagicianTable() {
        ...
        MagicianTableRecipes.addRecipeIS(
            new UnformedItemStack[] { new UnformedItemStack(getItemByNameEC3("genericItem", 7)),
                ...
                new UnformedItemStack("ingotDemonic"), new UnformedItemStack("ingotDemonic") },
            new ItemStack(ItemsCore.genericItem, 4, 54),
            2000);
        MagicianTableRecipes.addRecipeIS(
        ...
        MagicianTableRecipes.addRecipeIS(
            new ItemStack[] { new ItemStack(BlocksCore.voidStone), null, null, null, null },
    ...
    public void registerMithrilineFurnace() {
        ...
        MithrilineFurnaceRecipes
            .addRecipe(getItemByNameEC3("genericItem", 47), new ItemStack(ItemsCore.genericItem, 8, 46), 480, 1);
    ...
    public void registerEFuelCrafts() {
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 1, 0),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 0), 'C', Items.coal }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 4, 0),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 4), 'C', Items.coal }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 8, 0),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 8), 'C', Items.coal }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 16, 0),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 12), 'C', Items.coal }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 1, 1),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 1), 'C',
                    Items.snowball }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 4, 1),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 5), 'C',
                    Items.snowball }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 8, 1),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 9), 'C',
                    Items.snowball }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 16, 1),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 13), 'C',
                    Items.snowball }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 1, 2),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 2), 'C',
                    Items.wheat_seeds }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 4, 2),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 6), 'C',
                    Items.wheat_seeds }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 8, 2),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 10), 'C',
                    Items.wheat_seeds }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 16, 2),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 14), 'C',
                    Items.wheat_seeds }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 1, 3),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 3) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 4, 3),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 7) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 8, 3),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 11) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.elementalFuel, 16, 3),
                new Object[] { " E ", "ECE", " E ", 'E', new ItemStack(ItemsCore.essence, 1, 15) }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.fFocus, 1, 0),
                new Object[] { "GIG", "IEI", "GIG", 'E', new ItemStack(ItemsCore.elementalFuel, 1, 0), 'G',
                    Items.gold_ingot, 'I', Items.iron_ingot }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.wFocus, 1, 0),
                new Object[] { "GIG", "IEI", "GIG", 'E', new ItemStack(ItemsCore.elementalFuel, 1, 1), 'G',
                    Items.gold_ingot, 'I', Items.iron_ingot }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.eFocus, 1, 0),
                new Object[] { "GIG", "IEI", "GIG", 'E', new ItemStack(ItemsCore.elementalFuel, 1, 2), 'G',
                    Items.gold_ingot, 'I', Items.iron_ingot }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.aFocus, 1, 0),
                new Object[] { "GIG", "IEI", "GIG", 'E', new ItemStack(ItemsCore.elementalFuel, 1, 3), 'G',
                    Items.gold_ingot, 'I', Items.iron_ingot }));
    }
    ...
    public void registerCharmsCraft() {
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "SGS", "FRF", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 1),
                new Object[] { "SGS", "WRW", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 2),
                new Object[] { "SGS", "ERE", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 3),
                new Object[] { "SGS", "ARA", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 4),
                new Object[] { "SGS", "FRA", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 4),
                new Object[] { "SGS", "ARF", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 5),
                new Object[] { "SGS", "FRE", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 5),
                new Object[] { "SGS", "ERF", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 6),
                new Object[] { "SGS", "FRW", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 6),
                new Object[] { "SGS", "WRF", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 7),
                new Object[] { "SGS", "ERW", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 7),
                new Object[] { "SGS", "WRE", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 8),
                new Object[] { "SGS", "WRA", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 8),
                new Object[] { "SGS", "ARW", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 9),
                new Object[] { "SGS", "ERA", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ItemsCore.charm, 1, 9),
                new Object[] { "SGS", "ARE", "@G@", 'F', ItemsCore.fFocus, 'W', ItemsCore.wFocus, 'E', ItemsCore.eFocus,
                    'A', ItemsCore.aFocus, 'S', Items.string, 'G', getItemByNameEC3("genericItem", 10), 'R',
                    new ItemStack(ItemsCore.storage, 1, 3), '@', "magicWater" }));
    }
