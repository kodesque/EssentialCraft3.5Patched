...
public class ResearchRegistry {
        ...
        basic.apendDiscovery(
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.wind")
                    .setReferal(
                        new ItemStack(ItemsCore.bottledWind, 0, 0),
                        new ItemStack(ItemsCore.imprisonedWind, 0, 0),
                        new ItemStack(ItemsCore.windKeeper, 0, 0),
                        new ItemStack(ItemsCore.magicArmorItems[12], 0, 0),
                        new ItemStack(ItemsCore.magicArmorItems[13], 0, 0),
                        new ItemStack(ItemsCore.magicArmorItems[14], 0, 0),
                        new ItemStack(ItemsCore.magicArmorItems[15], 0, 0),
                        new ItemStack(ItemsCore.air_potion, 0, 0))
                    ...
                    .apendPage(
                        new PageEntry("ec3.page.wind_3")
                            .setDisplayStacks(
                                new ItemStack(ItemsCore.bottledWind, 1, 0),
                                new ItemStack(ItemsCore.imprisonedWind, 1, 0),
                                new ItemStack(ItemsCore.windKeeper, 1, 0))
                            .setText(StatCollector.translateToLocal("ec3.page.wind_3.txt")))
                    .apendPage(
                        new PageEntry("ec3.page.wind_4")
                            .setDisplayStacks(
                                new ItemStack(ItemsCore.magicArmorItems[12], 1, 0),
                                new ItemStack(ItemsCore.magicArmorItems[13], 1, 0),
                                new ItemStack(ItemsCore.magicArmorItems[14], 1, 0),
                                new ItemStack(ItemsCore.magicArmorItems[15], 1, 0))
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.drops")
                    .setReferal(
                        ...
                        new ItemStack(ItemsCore.weak_elemental_axe),
                        new ItemStack(ItemsCore.weak_elemental_hoe),
                        new ItemStack(ItemsCore.weak_elemental_pick),
                        new ItemStack(ItemsCore.weak_elemental_shovel),
                        new ItemStack(ItemsCore.weak_elemental_sword))
                    ...
                    .apendPage(
                        new PageEntry("ec3.page.drops_11")
                            ...
                            .setDisplayStacks(
                                new ItemStack(BlocksCore.oreDrops, 1, 0),
                                new ItemStack(BlocksCore.oreDrops, 1, 1),
                                new ItemStack(BlocksCore.oreDrops, 1, 2),
                                new ItemStack(BlocksCore.oreDrops, 1, 3),
                                new ItemStack(BlocksCore.oreDrops, 1, 4)))
                    .apendPage(
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.miscCrafts")
                    .setReferal(
                        new ItemStack(ItemsCore.genericItem, 0, 1),
                        new ItemStack(ItemsCore.genericItem, 0, 21),
                        new ItemStack(ItemsCore.genericItem, 1, 22),
                        new ItemStack(ItemsCore.genericItem, 1, 23),
                        new ItemStack(ItemsCore.genericItem, 1, 25),
                        new ItemStack(ItemsCore.genericItem, 1, 26),
                        new ItemStack(ItemsCore.genericItem, 1, 28),
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mru").setReferal(new ItemStack(ItemsCore.mruMover1))
                    .setDisplayStack(
                    ...
                    .apendPage(
                        new PageEntry("ec3.page.mru_14").setText(StatCollector.translateToLocal("ec3.page.mru_14.txt"))
                            .setDisplayStacks(
                                new ItemStack(BlocksCore.lightCorruption[0], 1, 7),
                                new ItemStack(BlocksCore.lightCorruption[1], 1, 7),
                                new ItemStack(BlocksCore.lightCorruption[3], 1, 7)))
                    .apendPage(
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.soulStone").setReferal(new ItemStack(ItemsCore.soulStone))
                    ...
                    .apendPage(
                        new PageEntry("ec3.page.soulStone_1")
                            .setRecipe(
                                new StructureRecipe(
                                    new ItemStack(ItemsCore.soulStone, 1, 0),
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.decorations").setReferal(new ItemStack(ItemsCore.magicalChisel))
                    ...
                    .apendPage(
                        next("decorations").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicalChisel), 2))
                            .setDisplayStacks(
                                new ItemStack(ItemsCore.magicalSlag),
                                new ItemStack(BlocksCore.concrete),
                                new ItemStack(BlocksCore.fortifiedStone),
                                new ItemStack(BlocksCore.magicPlating),
                                new ItemStack(BlocksCore.platingPale),
                                new ItemStack(BlocksCore.voidStone),
                                new ItemStack(BlocksCore.coldStone)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 1), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 0), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 2), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 3), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 4), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 5), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 6), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 7), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 8), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 9), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 10), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 11), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 12), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 13), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 14), 2)))
                    .apendPage(
                        next("decorations")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.fancyBlocks.get(0), 1, 15), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.overworld")
                    .setReferal(
                        new ItemStack(ItemsCore.baublesCore, 1, 0),
                        new ItemStack(ItemsCore.baublesCore, 1, 1),
                        new ItemStack(ItemsCore.baublesCore, 1, 2),
                        new ItemStack(ItemsCore.baublesCore, 1, 3),
                        new ItemStack(ItemsCore.baublesCore, 1, 4),
                        new ItemStack(ItemsCore.baublesCore, 1, 5),
                        new ItemStack(ItemsCore.baublesCore, 1, 6),
                        new ItemStack(ItemsCore.baublesCore, 1, 7),
                        new ItemStack(ItemsCore.baublesCore, 1, 8),
                        new ItemStack(ItemsCore.baublesCore, 1, 9),
                        new ItemStack(ItemsCore.baublesCore, 1, 10),
                        new ItemStack(ItemsCore.baublesCore, 1, 11),
                        new ItemStack(ItemsCore.baublesCore, 1, 12),
                        new ItemStack(ItemsCore.baublesCore, 1, 13),
                        new ItemStack(ItemsCore.baublesCore, 1, 14),
                        new ItemStack(ItemsCore.baublesCore, 1, 15),
                        new ItemStack(ItemsCore.baublesCore, 1, 16),
                        new ItemStack(ItemsCore.baublesCore, 1, 17),
                        new ItemStack(ItemsCore.baublesCore, 1, 18),
                        new ItemStack(ItemsCore.baublesCore, 1, 19),
                        new ItemStack(ItemsCore.baublesCore, 1, 20),
                        new ItemStack(ItemsCore.baublesCore, 1, 21),
                        new ItemStack(ItemsCore.baublesCore, 1, 22),
                        new ItemStack(ItemsCore.baublesCore, 1, 23),
                        new ItemStack(ItemsCore.baublesCore, 1, 24),
                        new ItemStack(ItemsCore.baublesCore, 1, 25),
                        new ItemStack(ItemsCore.baublesCore, 1, 26),
                        new ItemStack(ItemsCore.baublesCore, 1, 27),
                        new ItemStack(ItemsCore.baublesCore, 1, 28),
                        new ItemStack(ItemsCore.baublesCore, 1, 29),
                        new ItemStack(ItemsCore.baublesCore, 1, 30),
                        new ItemStack(ItemsCore.baublesCore, 1, 31))
    ...
    public static void registerMruCategory() {
        ...
        mru.apendDiscovery(
            new DiscoveryEntry("ec3.disc.boundGem").setReferal(new ItemStack(ItemsCore.bound_gem, 0, 0))
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicianTable").setReferal(new ItemStack(BlocksCore.magicianTable, 0, 0))
                    ...
                    .apendPage(
                        new PageEntry("ec3.page.magicianTable_4")
                            .setDisplayStacks(
                                (ItemStack[]) ec3.api.MagicianTableUpgrades.upgradeStacks
                                    .toArray(new ItemStack[ec3.api.MagicianTableUpgrades.upgradeStacks.size()]))
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.paleItems")
                    .setReferal(
                        ...
                        generic(42),
                        new ItemStack(BlocksCore.platingPale),
                        new ItemStack(BlocksCore.blockPale))
                    ...
                    .apendPage(
                        next("paleItems").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.platingPale), 2)))
                    .apendPage(
                        next("paleItems").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.blockPale), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicMonocle").setReferal(new ItemStack(ItemsCore.magicMonocle, 0, 0))
                    ...
                    .apendPage(
                        next("magicMonocle")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicMonocle), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mrucumover2").setReferal(new ItemStack(ItemsCore.mruMover_t2, 0, 0))
                    ...
                    .apendPage(
                        next("mrucumover2").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.mruMover_t2), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mrucuec")
                    .setReferal(
                        new ItemStack(BlocksCore.magicPlating, 0, 0),
                        new ItemStack(BlocksCore.ecController, 0, 0))
                    ...
                    .apendPage(
                        next("mrucuec")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicPlating, 1, 0), 2)))
                    .apendPage(
                        next("mrucuec")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ecController, 1, 0), 2)))
                    .apendPage(next("mrucuec").setText(StatCollector.translateToLocal("ec3.page.mrucuec_3.txt")))
                    .apendPage(
                        next("mrucuec")
                            .setDisplayStacks(
                                new ItemStack(BlocksCore.fortifiedStone),
                                new ItemStack(BlocksCore.fortifiedGlass),
                                new ItemStack(BlocksCore.magicPlating),
                                new ItemStack(BlocksCore.platingPale),
                                new ItemStack(BlocksCore.voidStone),
                                new ItemStack(BlocksCore.voidGlass),
                                new ItemStack(BlocksCore.invertedBlock, 1, 0))
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mrucuec.state").setReferal(new ItemStack(BlocksCore.ecStateChecker))
                    ...
                    .apendPage(
                        next("mrucuec.state")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ecStateChecker), 2)))
                    .apendPage(
                        next("mrucuec.state").setText(StatCollector.translateToLocal("ec3.page.mrucuec.state_2.txt"))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mrucuec.in").setReferal(new ItemStack(BlocksCore.ecAcceptor))
                    ...
                    .apendPage(
                        next("mrucuec.in").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ecAcceptor), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mrucuec.out").setReferal(new ItemStack(BlocksCore.ecEjector))
                    ...
                    .apendPage(
                        next("mrucuec.out").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ecEjector), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mrucuec.storage").setReferal(new ItemStack(BlocksCore.ecHoldingChamber))
                    ...
                    .apendPage(
                        next("mrucuec.storage")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ecHoldingChamber), 2)))
                    .apendPage(
                        next("mrucuec.storage")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage, 1, 2), 6))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mrucuec.balancer").setReferal(new ItemStack(BlocksCore.ecBalancer))
                    ...
                    .apendPage(
                        next("mrucuec.balancer")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ecBalancer), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mrucuec.redstone")
                    ...
                    .apendPage(
                        next("mrucuec.redstone")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ecRedstoneController), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.naturalFurnace").setReferal(new ItemStack(BlocksCore.naturalFurnace))
                    ...
                    .apendPage(
                        next("naturalFurnace").setText(StatCollector.translateToLocal("ec3.page.naturalFurnace_1.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.naturalFurnace), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.heatGenerator").setReferal(new ItemStack(BlocksCore.heatGenerator))
                    ...
                    .apendPage(
                        next("heatGenerator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.heatGenerator), 2)))
                    .apendPage(
                        next("heatGenerator")
                            .setRecipe(
                                new StructureRecipe(
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalMirrors")
                    ...
                    .apendPage(
                        next("magicalMirrors")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalMirror), 2)))
                    .apendPage(
                        next("magicalMirrors")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.controlRod), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalAssembler").setReferal(new ItemStack(BlocksCore.assembler))
                    ...
                    .apendPage(
                        next("magicalAssembler")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.assembler), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.corruptionCleaner")
                    ...
                    .apendPage(
                        next("corruptionCleaner")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.corruptionCleaner), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.rayTower").setReferal(new ItemStack(BlocksCore.rayTower))
                    ...
                    .apendPage(
                        next("rayTower").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rayTower), 2))))
            .apendDiscovery(
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalActivator")
                    ...
                    .apendPage(
                        next("magicalActivator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rightClicker, 1, 0), 2)))
                    .apendPage(
                        next("magicalActivator")
                            .setText(StatCollector.translateToLocal("ec3.page.magicalActivator_2.txt")))
                    .apendPage(
                        next("magicalActivator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rightClicker, 1, 1), 3)))
                    .apendPage(
                        next("magicalActivator")
                            .setText(StatCollector.translateToLocal("ec3.page.magicalActivator_3.txt")))
                    .apendPage(
                        next("magicalActivator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rightClicker, 1, 2), 3)))
                    .apendPage(
                        next("magicalActivator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rightClicker, 1, 3), 3)))
                    .apendPage(
                        next("magicalActivator")
                            .setText(StatCollector.translateToLocal("ec3.page.magicalActivator_4.txt")))
                    .apendPage(
                        next("magicalActivator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rightClicker, 1, 4), 3)))
                    .apendPage(
                        next("magicalActivator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.rightClicker, 1, 5), 3))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.redstoneTransmitter")
                    ...
                    .apendPage(
                        next("redstoneTransmitter")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.redstoneTransmitter), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalHopper").setDisplayStack(new ItemStack(BlocksCore.magicalHopper))
                    ...
                    .apendPage(
                        next("magicalHopper")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalHopper), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.metadataManager")
                    ...
                    .apendPage(
                        next("metadataManager")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.metadataManager), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.blockBreaker").setDisplayStack(new ItemStack(BlocksCore.blockBreaker))
                    ...
                    .apendPage(
                        next("blockBreaker")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.blockBreaker), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.weaponMaker").setDisplayStack(new ItemStack(BlocksCore.weaponMaker))
                    ...
                    .apendPage(
                        next("weaponMaker").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.weaponMaker), 2)))
                    .apendPage(
                    ...
                    .apendPage(
                        next("weaponMaker").setText(StatCollector.translateToLocal("ec3.page.weaponMaker_7.txt"))
                            .setDisplayStacks(
                                ...
                                new ItemStack(ItemsCore.genericItem, 1, 39),
                                new ItemStack(ItemsCore.genericItem, 1, 50),
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magmaticFurnace").setDisplayStack(new ItemStack(BlocksCore.furnaceMagic))
                    ...
                    .apendPage(
                        next("magmaticFurnace")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.furnaceMagic, 1, 0), 2)))
                    .apendPage(
                        next("magmaticFurnace")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.furnaceMagic, 1, 4), 2)))
                    .apendPage(
                        next("magmaticFurnace")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.furnaceMagic, 1, 8), 2)))
                    .apendPage(
                        next("magmaticFurnace")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.furnaceMagic, 1, 12), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalChest").setDisplayStack(new ItemStack(BlocksCore.chest))
                    ...
                    .apendPage(
                        next("magicalChest")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.chest, 1, 0), 2)))
                    .apendPage(
                        next("magicalChest")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.chest, 1, 1), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.replanter").setDisplayStack(new ItemStack(BlocksCore.device, 1, 0))
                    ...
                    .apendPage(
                        next("replanter").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.device, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.itemShuffler").setDisplayStack(new ItemStack(BlocksCore.device, 1, 1))
                    ...
                    .apendPage(
                        next("itemShuffler")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.device, 1, 1), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.crafter").setDisplayStack(new ItemStack(BlocksCore.device, 1, 2))
                    ...
                    .apendPage(
                        next("crafter").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.device, 1, 2), 2)))
                    .apendPage(
                        next("crafter")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.craftingFrame, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.breeder").setDisplayStack(new ItemStack(BlocksCore.device, 1, 3))
                    ...
                    .apendPage(
                        next("breeder").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.device, 1, 3), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.shearingStation").setDisplayStack(new ItemStack(BlocksCore.device, 1, 5))
                    ...
                    .apendPage(
                        next("shearingStation")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.device, 1, 5), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.separator").setDisplayStack(new ItemStack(BlocksCore.device, 1, 6))
                    ...
                    .apendPage(
                        next("separator").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.device, 1, 6), 2)))
                    .apendPage(
                        next("separator").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.device, 1, 7), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.advBreaker").setDisplayStack(new ItemStack(BlocksCore.advBreaker, 1, 0))
                    ...
                    .apendPage(
                        next("advBreaker")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.advBreaker, 1, 0), 2)))
                    ...
                    .apendPage(
                        next("advBreaker").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.filter, 1, 0), 2)))
                    .apendPage(next("advBreaker").setText(StatCollector.translateToLocal("ec3.page.advBreaker_3.txt")))
                    .apendPage(
                        next("advBreaker").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.filter, 1, 2), 2)))
                    .apendPage(next("advBreaker").setText(StatCollector.translateToLocal("ec3.page.advBreaker_4.txt")))
                    .apendPage(
                        next("advBreaker").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.filter, 1, 1), 2)))
                    .apendPage(
                        next("advBreaker")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.filter, 1, 3), 2))));
    }
    ...
    public static void registerEngineersCategory() {
        ...
        eng.apendDiscovery(
            new DiscoveryEntry("ec3.disc.crystals")
                .setReferal(
                    crystal,
                    new ItemStack(BlocksCore.crystalFormer),
                    new ItemStack(BlocksCore.crystalController),
                    new ItemStack(BlocksCore.crystalExtractor),
                    new ItemStack(ItemsCore.elementalFuel, 0, 0),
                    new ItemStack(ItemsCore.elementalFuel, 0, 1),
                    new ItemStack(ItemsCore.elementalFuel, 0, 2),
                    new ItemStack(ItemsCore.elementalFuel, 0, 3),
                    new ItemStack(ItemsCore.fFocus),
                    new ItemStack(ItemsCore.wFocus),
                    new ItemStack(ItemsCore.eFocus),
                    new ItemStack(ItemsCore.aFocus))
                ...
                .apendPage(
                    next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.crystalFormer), 2)))
                ...
                .apendPage(
                    next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.crystalController), 2)))
                .apendPage(next("crystals").setText(StatCollector.translateToLocal("ec3.page.crystals_13.txt")))
                .apendPage(
                    next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.crystalExtractor), 2)))
                .apendPage(next("crystals").setText(StatCollector.translateToLocal("ec3.page.crystals_15.txt")))
                .apendPage(
                    next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.elementalFuel, 1, 0), 2)))
                .apendPage(
                    next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.elementalFuel, 1, 1), 2)))
                .apendPage(
                    next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.elementalFuel, 1, 2), 2)))
                .apendPage(
                    next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.elementalFuel, 1, 3), 2)))
                ...
                .apendPage(
                    next("crystals").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.aFocus, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.matrixSwitch")
                    .setReferal(
                        new ItemStack(ItemsCore.matrixProj, 1, 0),
                        new ItemStack(ItemsCore.matrixProj, 1, 1),
                        new ItemStack(ItemsCore.matrixProj, 1, 2),
                        new ItemStack(ItemsCore.matrixProj, 1, 3),
                        new ItemStack(ItemsCore.matrixProj, 1, 4))
                    ...
                    .apendPage(
                        next("matrixSwitch")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.matrixProj, 1, 0), 5)))
                    .apendPage(
                        next("matrixSwitch")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.matrixProj, 1, 1), 5)))
                    .apendPage(
                        next("matrixSwitch")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.matrixProj, 1, 2), 5)))
                    .apendPage(
                        next("matrixSwitch")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.matrixProj, 1, 3), 5))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.enderGen").setReferal(new ItemStack(BlocksCore.enderGenerator, 1, 0))
                    ...
                    .apendPage(
                        next("enderGen")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.enderGenerator, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.coldDistillator")

                    .setReferal(
                        new ItemStack(BlocksCore.coldStone, 1, 0),
                        new ItemStack(BlocksCore.coldDistillator, 1, 0))
                    ...
                    .apendPage(
                        next("coldDistillator")
                            ...
                            .setDisplayStacks(new ItemStack(BlocksCore.coldStone)))
                    .apendPage(
                        next("coldDistillator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.coldStone, 1, 0), 2)))
                    .apendPage(
                        next("coldDistillator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.coldDistillator, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.solarAbsorber")
                    .setReferal(
                        new ItemStack(BlocksCore.solarPrism, 1, 0),
                        new ItemStack(BlocksCore.sunRayAbsorber, 1, 0))
                    ...
                    .apendPage(
                        next("solarAbsorber")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.solarPrism, 1, 0), 2)))
                    .apendPage(
                    ...
                    .apendPage(
                        next("solarAbsorber")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.sunRayAbsorber, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.moonWell")
                    ...
                    .apendPage(
                        next("moonWell")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.moonWell, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.reactor")
                    ...
                    .apendPage(
                        next("reactor").setRecipe(
                            new StructureRecipe(
                                new ItemStack(BlocksCore.reactor, 1, 0),
                    ...
                    .apendPage(
                        next("reactor")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.reactorSupport, 1, 0), 2)))
                    .apendPage(
                        next("reactor").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.reactor, 1, 0), 2)))
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.soulStorage")
                    .setReferal(
                        new ItemStack(BlocksCore.chargingChamber, 1, 0),
                        new ItemStack(ItemsCore.storage, 1, 0),
                        new ItemStack(ItemsCore.storage, 1, 1),
                        new ItemStack(ItemsCore.storage, 1, 2),
                        new ItemStack(ItemsCore.storage, 1, 3),
                        new ItemStack(ItemsCore.storage, 1, 4))
                    ...
                    .apendPage(
                        next("soulStorage").setText(StatCollector.translateToLocal("ec3.page.soulStorage_1.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage, 1, 0), 6)))
                    .apendPage(
                        next("soulStorage").setText(StatCollector.translateToLocal("ec3.page.soulStorage_2.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage, 1, 1), 6)))
                    .apendPage(
                    ...
                    .apendPage(
                        next("soulStorage").setText(StatCollector.translateToLocal("ec3.page.soulStorage_4.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage, 1, 3), 6)))
                    .apendPage(
                        next("soulStorage").setText(StatCollector.translateToLocal("ec3.page.soulStorage_5.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.storage, 1, 4), 6)))
                    .apendPage(
                        next("soulStorage").setText(StatCollector.translateToLocal("ec3.page.soulStorage_6.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.chargingChamber, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalDigger")
                    ...
                    .apendPage(
                        next("magicalDigger")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicalDigger, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalLantern")
                    ...
                    .apendPage(
                        next("magicalLantern")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicalLantern, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magnetizingStaff")
                    ...
                    .apendPage(
                        next("magnetizingStaff")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magnetizingStaff, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.spawnerCollector")
                    ...
                    .apendPage(
                        next("spawnerCollector")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.spawnerCollector, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.lifeStaff")
                    ...
                    .apendPage(
                        next("lifeStaff")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.staffOfLife, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.holyMace")
                    ...
                    .apendPage(
                        next("holyMace").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.holyMace, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.emeraldHeart")
                    ...
                    .apendPage(
                        next("emeraldHeart")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.emeraldHeart, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalWings")
                    ...
                    .apendPage(
                        next("magicalWings")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicalWings, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalPorkchop")
                    ...
                    .apendPage(
                        next("magicalPorkchop")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicalPorkchop, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalWater")
                    ...
                    .apendPage(
                        next("magicalWater")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicWaterBottle, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalShield")

                    .setReferal(
                        new ItemStack(ItemsCore.magicalShield, 1, 0),
                        new ItemStack(ItemsCore.spikyShield, 1, 0))
                    ...
                    .apendPage(
                        next("magicalShield")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicalShield, 1, 0), 2)))
                    .apendPage(
                        next("magicalShield")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.spikyShield, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.biomeWand")
                    ...
                    .apendPage(
                        next("biomeWand")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.biomeWand, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.chaosFork")
                    ...
                    .apendPage(
                        next("chaosFork")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.chaosFork, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.frozenMace").setReferal(new ItemStack(ItemsCore.frozenMace, 1, 0))
                    ...
                    .apendPage(
                        next("frozenMace")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.frozenMace, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magmaticStaff").setReferal(new ItemStack(ItemsCore.magmaticStaff, 1, 0))
                    ...
                    .apendPage(
                        next("magmaticStaff")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magmaticStaff, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mhs")
                    .setReferal(
                        new ItemStack(ItemsCore.magicArmorItems[0], 1, 0),
                        new ItemStack(ItemsCore.magicArmorItems[1], 1, 0),
                        new ItemStack(ItemsCore.magicArmorItems[2], 1, 0),
                        new ItemStack(ItemsCore.magicArmorItems[3], 1, 0))
                    ...
                    .apendPage(
                        next("mhs")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicArmorItems[0], 1, 0), 2)))
                    .apendPage(
                        next("mhs")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicArmorItems[1], 1, 0), 2)))
                    .apendPage(
                        next("mhs")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicArmorItems[2], 1, 0), 2)))
                    .apendPage(
                        next("mhs")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicArmorItems[3], 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.elementalCharms")
                    .setReferal(
                        new ItemStack(ItemsCore.charm, 1, 0),
                        new ItemStack(ItemsCore.charm, 1, 1),
                        new ItemStack(ItemsCore.charm, 1, 2),
                        new ItemStack(ItemsCore.charm, 1, 3),
                        new ItemStack(ItemsCore.charm, 1, 4),
                        new ItemStack(ItemsCore.charm, 1, 5),
                        new ItemStack(ItemsCore.charm, 1, 6),
                        new ItemStack(ItemsCore.charm, 1, 7),
                        new ItemStack(ItemsCore.charm, 1, 8),
                        new ItemStack(ItemsCore.charm, 1, 9))
                    ...
                    .apendPage(
                        next("elementalCharms")
                            ...
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 0), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_2.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 1), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_3.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 2), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_4.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 3), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_5.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 4), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_6.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 5), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_7.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 6), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_8.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 7), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_9.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 8), 2)))
                    .apendPage(
                        next("elementalCharms")
                            .setText(StatCollector.translateToLocal("ec3.page.elementalCharms_10.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.charm, 1, 9), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.mruCoil")
                    .setReferal(
                        new ItemStack(ItemsCore.playerList, 1, 0),
                        new ItemStack(BlocksCore.mruCoil, 1, 0),
                        new ItemStack(BlocksCore.mruCoilHardener, 1, 0))
                    ...
                    .apendPage(
                        next("mruCoil").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mruCoil, 1, 0), 2)))
                    .apendPage(
                        next("mruCoil")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mruCoilHardener, 1, 0), 2)))
                    .apendPage(
                    ...
                    .apendPage(
                        next("mruCoil").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.playerList, 1, 0), 2)))
                    .apendPage(next("mruCoil").setText(StatCollector.translateToLocal("ec3.page.mruCoil_7.txt"))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.potionSpreader").setReferal(new ItemStack(BlocksCore.potionSpreader, 1, 0))
                    ...
                    .apendPage(
                        next("potionSpreader")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.potionSpreader, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalEnchanter")
                    ...
                    .apendPage(
                        next("magicalEnchanter")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalEnchanter, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.monsterHolder").setReferal(new ItemStack(BlocksCore.monsterClinger, 1, 0))
                    ...
                    .apendPage(
                        next("monsterHolder")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.monsterClinger, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalJukebox").setReferal(new ItemStack(BlocksCore.magicalJukebox, 1, 0))
                    ...
                    .apendPage(
                        next("magicalJukebox")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalJukebox, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalRepairer")
                    ...
                    .apendPage(
                        next("magicalRepairer")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalRepairer, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.monsterDuplicator")
                    ...
                    .apendPage(
                        next("monsterDuplicator")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.monsterHarvester, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magmaticSmeltery")
                    ...
                    .apendPage(
                        next("magmaticSmeltery")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magmaticSmeltery, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalQuarry")
                    .setReferal(
                        new ItemStack(BlocksCore.magicalQuarry, 1, 0),
                        generic(18),
                        generic(19),
                        generic(17),
                        generic(80),
                    ...
                    .apendPage(
                        next("magicalQuarry")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalQuarry, 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.hoanna").setReferal(new ItemStack(ItemsCore.windTablet, 1, 0))
                    ...
                    .apendPage(
                        next("hoanna").setText(StatCollector.translateToLocal("ec3.page.hoanna_4.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.windTablet, 1, 0), 2)))
    ...
    public static void registerHoannaCategory() {
        ...
        hoanna
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.loot").setDisplayStack(generic(37))
                    .setReferal(
                        ...
                        new ItemStack(ItemsCore.twinkling_titanite, 1, 0),
                        new ItemStack(ItemsCore.ember, 1, 0),
                        new ItemStack(ItemsCore.ember, 1, 1),
                        new ItemStack(ItemsCore.ember, 1, 2),
                        new ItemStack(ItemsCore.ember, 1, 3),
                        new ItemStack(ItemsCore.ember, 1, 4),
                        new ItemStack(ItemsCore.ember, 1, 5),
                        new ItemStack(ItemsCore.ember, 1, 6),
                        new ItemStack(ItemsCore.ember, 1, 7))
                    ...
                    .apendPage(
                        next("loot").setDisplayStacks(
                            ...
                            lootable)))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.voidStone").setDisplayStack(new ItemStack(BlocksCore.voidStone, 1, 0))
                    ...
                    .apendPage(
                        next("voidStone").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.voidStone), 2)))
                    .apendPage(
                        next("voidStone").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.voidGlass), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.voidArmor")
                    .setReferal(
                        new ItemStack(ItemsCore.magicArmorItems[4], 1, 0),
                        new ItemStack(ItemsCore.magicArmorItems[5], 1, 0),
                        new ItemStack(ItemsCore.magicArmorItems[6], 1, 0),
                        new ItemStack(ItemsCore.magicArmorItems[7], 1, 0))
                    ...
                    .apendPage(
                        next("voidArmor")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicArmorItems[4], 1, 0), 2)))
                    .apendPage(
                        next("voidArmor")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicArmorItems[5], 1, 0), 2)))
                    .apendPage(
                        next("voidArmor")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicArmorItems[6], 1, 0), 2)))
                    .apendPage(
                        next("voidArmor")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicArmorItems[7], 1, 0), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalTeleporter").setReferal(new ItemStack(BlocksCore.magicalTeleporter))
                    ...
                    .apendPage(
                        next("magicalTeleporter")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalTeleporter), 2)))
                    .apendPage(
                        next("magicalTeleporter")
                            .setText(StatCollector.translateToLocal("ec3.page.magicalTeleporter_2.txt"))
                            .setRecipe(
                                new StructureRecipe(
                                    new ItemStack(BlocksCore.magicalTeleporter),
                        ...
                        next("magicalTeleporter")
                            ...
                            .setRecipe(
                                new StructureRecipe(
                                    ...
                                    new StructureBlock(BlocksCore.voidStone, 0, -1, 0, -2)))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalFurnace").setReferal(new ItemStack(BlocksCore.magicalFurnace))
                    ...
                    .apendPage(
                        next("magicalFurnace")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.magicalFurnace), 2)))
                    .apendPage(
                        next("magicalFurnace").setText(StatCollector.translateToLocal("ec3.page.magicalFurnace_2.txt"))
                            .setRecipe(
                                new StructureRecipe(
                                    new ItemStack(BlocksCore.magicalFurnace),
                                    new StructureBlock(BlocksCore.voidStone, 0, -2, 0, 2),
                                    new StructureBlock(BlocksCore.voidStone, 0, -1, 0, 2),
                        ...
                        next("magicalFurnace").setText(StatCollector.translateToLocal("ec3.page.magicalFurnace_4.txt"))
                            .setRecipe(
                                new StructureRecipe(
                                    ...
                                    new StructureBlock(BlocksCore.heatGenerator, 0, 2, 0, 2)))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.emberForge").setReferal(new ItemStack(BlocksCore.emberForge))
                    ...
                    .apendPage(
                        next("emberForge").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.emberForge), 2)))
                    .apendPage(
                        next("emberForge").setText(StatCollector.translateToLocal("ec3.page.emberForge_2.txt"))
                            .setRecipe(
                                new StructureRecipe(
                                    new ItemStack(BlocksCore.emberForge),
                                    new StructureBlock(BlocksCore.voidStone, 0, -2, 0, 2),
                                    new StructureBlock(BlocksCore.voidStone, 0, -1, 0, 2),
                                    new StructureBlock(BlocksCore.voidStone, 0, 0, 0, 2),
                                    new StructureBlock(BlocksCore.voidStone, 0, 1, 0, 2),
             ...
             */
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.o8elisk").setDisplayStack(new ItemStack(BlocksCore.darknessObelisk, 1, 0))
                    ...
                    .apendPage(
                        next("o8elisk")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.darknessObelisk), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.ultraHeat").setDisplayStack(new ItemStack(BlocksCore.ultraHeatGen, 1, 0))
                    ...
                    .apendPage(
                        next("ultraHeat").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ultraHeatGen), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.ultraFlower")
                    ...
                    .apendPage(
                        next("ultraFlower")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.ultraFlowerBurner), 2))))
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.magicalBuilder")
                    ...
                    .apendPage(
                        next("magicalBuilder")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.magicalBuilder), 2))))
            .apendDiscovery(
                new DiscoveryEntry("hologram")

                    .setDisplayStack(new ItemStack(ItemsCore.genericItem, 1, 76))
                    .setReferal(
                        new ItemStack(ItemsCore.genericItem, 1, 70),
                        new ItemStack(ItemsCore.genericItem, 1, 71),
                        new ItemStack(ItemsCore.genericItem, 1, 72),
                        new ItemStack(ItemsCore.genericItem, 1, 73),
                        new ItemStack(BlocksCore.holopad, 1, 0))
                    ...
                    .apendPage(
                        next("hologram").setText(StatCollector.translateToLocal("ec3.page.hologram_3.txt"))
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.holopad), 2))))
            .apendDiscovery(
                new DiscoveryEntry("redSuit")

                    .setDisplayStack(new ItemStack(ItemsCore.computer_helmet, 1, 0))
                    .setReferal(
                        new ItemStack(ItemsCore.computer_helmet, 1, 0),
                        new ItemStack(ItemsCore.computer_chestplate, 1, 0),
                        new ItemStack(ItemsCore.computer_leggings, 1, 0),
                        new ItemStack(ItemsCore.computer_boots, 1, 0),
                        new ItemStack(ItemsCore.computerBoard, 1, 0),
                        gen(56),
                        gen(57),
                        gen(58),
                        gen(59),
                    ...
                    .apendPage(
                        next("redSuit").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.computer_helmet), 2)))
                    .apendPage(
                        next("redSuit")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.computer_chestplate), 2)))
                    .apendPage(
                        next("redSuit")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.computer_leggings), 2)))
                    .apendPage(
                        next("redSuit").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.computer_boots), 2)))
                    .apendPage(
                        next("redSuit").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.computerBoard), 2)))
            ...
            .apendDiscovery(
                new DiscoveryEntry("ec3.disc.newMim").setNew()
                    ...
                    .setReferal(
                        new ItemStack(BlocksCore.newMim, 1, 0),
                        new ItemStack(BlocksCore.mimEjector, 1, 0),
                        new ItemStack(BlocksCore.mimInjector, 1, 0),
                        new ItemStack(BlocksCore.mimEjectorP, 1, 0),
                        new ItemStack(BlocksCore.mimInjectorP, 1, 0))
                    ...
                    .apendPage(
                        next("newMim").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mimEjector), 2)))
                    .apendPage(
                        next("newMim").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mimInjector), 2)))
                    .apendPage(next("newMim").setText(StatCollector.translateToLocal("ec3.page.newMim_8.txt")))
                    .apendPage(
                        next("newMim").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mimEjectorP), 2)))
                    .apendPage(
                        next("newMim").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mimInjectorP), 2))))
            .apendDiscovery(
                new DiscoveryEntry("newMimInv").setNew()
                    ...
                    .apendPage(
                        next("newMimInv").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mimInvStorage), 2)))
                    .apendPage(
                        next("newMimInv").setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.inventoryGem), 2))))
            .apendDiscovery(
                new DiscoveryEntry("newMimCraft").setNew()
                    ...
                    .apendPage(
                        next("newMimCraft").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mimCrafter), 2))))
            .apendDiscovery(
                new DiscoveryEntry("newMimScreen").setNew()
                    ...
                    .apendPage(
                        next("newMimScreen")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mimScreen), 2))));
    }
        ...
        ender.apendDiscovery(
            ...
            .apendDiscovery(
                new DiscoveryEntry("mithriline")
                    ...
                    .setReferal(
                        ...
                        new ItemStack(ItemsCore.genericItem, 1, 50),
                        new ItemStack(ItemsCore.genericItem, 1, 49),
                        new ItemStack(ItemsCore.genericItem, 1, 48),
                        new ItemStack(BlocksCore.invertedBlock, 1, 0))
                    ...
                    .apendPage(
                        next("mithriline").setText(StatCollector.translateToLocal("ec3.page.mithriline_1.txt"))
                            .setDisplayStacks(new ItemStack(ItemsCore.genericItem, 1, 51)))
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.genericItem, 1, 50), 2)))
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.genericItem, 1, 49), 6)))
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.genericItem, 1, 48), 2)))
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.genericItem, 1, 50), 2)))
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.invertedBlock, 1, 0), 2))
                    ...
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mithrilineCrystal, 1, 0), 2)))
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mithrilineCrystal, 1, 3), 2)))
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mithrilineCrystal, 1, 6), 2)))
                    .apendPage(
                        next("mithriline")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mithrilineCrystal, 1, 9), 2))))
            .apendDiscovery(
                new DiscoveryEntry("mithrilineFurnace")
                    ...
                    .apendPage(
                        next("mithrilineFurnace")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.mithrilineFurnace, 1, 0), 2)))
                    .apendPage(
                        next("mithrilineFurnace").setText(StatCollector.translateToLocal("ec3.txt.layer_-1"))
                            .setRecipe(
                                new StructureRecipe(
                                    new ItemStack(BlocksCore.mithrilineFurnace),
            ...
            .apendDiscovery(
                new DiscoveryEntry("windRune")
                    ...
                    .apendPage(
                        next("windRune").setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.windRune, 1, 0), 2)))
                    .apendPage(
                        next("windRune").setText(StatCollector.translateToLocal("ec3.txt.layer_-1"))
                            .setRecipe(
                                new StructureRecipe(
                                    new ItemStack(BlocksCore.windRune),
                                    new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, 0),
                                    new StructureBlock(BlocksCore.invertedBlock, 0, 1, 0, 0),
                                    new StructureBlock(BlocksCore.invertedBlock, 0, -1, 0, 0),
                                    new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, 1),
                    ...
                    .apendPage(
                        next("windRune")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.wind_elemental_axe), 2)))
                    .apendPage(
                        next("windRune")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.wind_elemental_pick), 2)))
                    .apendPage(
                        next("windRune")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.wind_elemental_hoe), 2)))
                    .apendPage(
                        next("windRune")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.wind_elemental_shovel), 2)))
                    .apendPage(
                        next("windRune")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.wind_elemental_sword), 2))))
            .apendDiscovery(
                new DiscoveryEntry("playerPentacle")
                    ...
                    .apendPage(
                        next("playerPentacle")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.playerPentacle), 2)))
                    .apendPage(
                        next("playerPentacle").setText(StatCollector.translateToLocal("ec3.txt.layer_-1"))
                            .setRecipe(
                                new StructureRecipe(
                                    new ItemStack(BlocksCore.playerPentacle),
                                    new StructureBlock(BlocksCore.invertedBlock, 0, 1, 0, 0),
                                    new StructureBlock(BlocksCore.invertedBlock, 0, -1, 0, 0),
                                    new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, 1),
                                    new StructureBlock(BlocksCore.invertedBlock, 0, 0, 0, -1),
            ...
            .apendDiscovery(
                new DiscoveryEntry("demonicPentacle")
                    ...
                    .apendPage(
                        next("demonicPentacle")
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(BlocksCore.demonicPentacle), 2)))
                    .apendPage(
                        next("demonicPentacle").setText(StatCollector.translateToLocal("ec3.txt.layer_-1"))
                            .setRecipe(
                                new StructureRecipe(
                                    new ItemStack(BlocksCore.demonicPentacle),
                                    new StructureBlock(BlocksCore.voidStone, 0, 0, 0, 0),
                    ...
                    .apendPage(
                        next("demonicPentacle")
                            ...
                            .setRecipe(ECUtils.findRecipeByIS(new ItemStack(ItemsCore.soulScriber), 2)))
