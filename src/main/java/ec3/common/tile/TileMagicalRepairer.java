...
public class TileMagicalRepairer extends TileMRUGeneric {
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isBlockIndirectlyGettingPowered(xCoord, yCoord, zCoord)) repare();
        spawnParticles();
    }
    ...
    public boolean canRepare(ItemStack s) {
        return s != null && s.getItemDamage() != 0
            && s.getItem()
                .isRepairable()
    ...
    public static void setupConfig(Configuration cfg) {
        try {
            ...
            String[] cfgArrayString = cfg.getStringList(
                "MagicalRepairerSettings",
                "tileentities",
                new String[] { "Max MRU:" + ApiCore.DEVICE_MAX_MRU_GENERIC, "MRU Usage:70",
