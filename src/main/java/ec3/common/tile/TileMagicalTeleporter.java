...
public class TileMagicalTeleporter extends TileMRUGeneric {
    ...
    public boolean isStructureCorrect() {
        ...
        flag = this.worldObj.getBlock(xCoord + 1, yCoord + 1, zCoord + 2) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord + 1, yCoord + 2, zCoord + 2) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord + 2, yCoord + 1, zCoord + 1) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord + 2, yCoord + 2, zCoord + 1) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord - 2, yCoord + 1, zCoord + 1) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord - 2, yCoord + 2, zCoord + 1) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord - 1, yCoord + 1, zCoord + 2) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord - 1, yCoord + 2, zCoord + 2) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord + 2, yCoord + 1, zCoord - 1) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord + 2, yCoord + 2, zCoord - 1) == BlocksCore.voidStone
            && this.worldObj.getBlock(xCoord + 1, yCoord + 1, zCoord - 2) == BlocksCore.voidStone
