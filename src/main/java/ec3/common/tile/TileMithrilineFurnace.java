...
public class TileMithrilineFurnace extends TileEntity implements IInventory {
    ...
    public boolean isStructureCorrect() {
        ...
        int y = this.yCoord;
        int z = this.zCoord;
        boolean hasPlatformBelow = worldObj.getBlock(x, y - 1, z) == BlocksCore.invertedBlock
        ...
        boolean hasGenericOutline = worldObj.getBlock(x - 2, y, z) == BlocksCore.invertedBlock
