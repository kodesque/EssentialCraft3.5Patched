            ...
            if (this.getStackInSlot(1) != null) {
                if (this.getMRU() >= mruForIns) {
                    if (this.setMRU(this.getMRU() - mruForIns)) {
                        if (parent.addItemStackToSystem(this.getStackInSlot(1))) this.setInventorySlotContents(1, null);
    ...
    public static void setupConfig(Configuration cfg) {
        try {
            ...
            String[] cfgArrayString = cfg.getStringList(
                "NewMagicalInventoryManagerScreenSettings",
                "tileentities",
                new String[] { "Max MRU:" + ApiCore.DEVICE_MAX_MRU_GENERIC, "MRU Per Inserted Item:500",
