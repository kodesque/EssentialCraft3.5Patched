        ...
        if (result != null) {
            if (this.getStackInSlot(3) == null) {
                ...
                if (this.getStackInSlot(3)
                    .isItemEqual(result)) {
                    if (this.getStackInSlot(3).stackSize + result.stackSize <= this.getInventoryStackLimit()
                        && this.getStackInSlot(3).stackSize + result.stackSize <= this.getStackInSlot(3)
                            .getMaxStackSize()) {
                        return true;
                    }
                }
        ...
        if (this.canFunction(this.currentRecipe)) {
            ...
            if (this.getStackInSlot(3) == null) {
                ...
                this.setInventorySlotContents(
                    ...
                    new ItemStack(
                        stk.getItem(),
                        stk.stackSize + this.getStackInSlot(3).stackSize,
                        stk.getItemDamage()));
            }
            for (int i = 1; i < 3; ++i) {
