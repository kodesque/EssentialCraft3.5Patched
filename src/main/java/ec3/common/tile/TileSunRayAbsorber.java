...
public class TileSunRayAbsorber extends TileMRUGeneric {
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isBlockIndirectlyGettingPowered(xCoord, yCoord, zCoord)) {
            ...
            List<EntitySolarBeam> l = this.worldObj.getEntitiesWithinAABB(
                EntitySolarBeam.class,
                AxisAlignedBB.getBoundingBox(xCoord - 1, yCoord - 1, zCoord - 1, xCoord + 1, yCoord + 1, zCoord + 1));
            if (!l.isEmpty()) {
    ...
    public static void setupConfig(Configuration cfg) {
        try {
            ...
            String[] cfgArrayString = cfg.getStringList(
                "SunRayAbsorberSettings",
                "tileentities",
                new String[] { "Max MRU:" + ApiCore.GENERATOR_MAX_MRU_GENERIC * 10, "Default balance:2",
