...
public class TileWeaponMaker extends TileMRUGeneric {
    ...
    public void readFromNBT(NBTTagCompound i) {
        if (i.hasKey("preview")) previewStack = ItemStack.loadItemStackFromNBT(i.getCompoundTag("preview"));
        else previewStack = null;
                ...
                if (this.getStackInSlot(i) != null) {
                    for (int j = 0; j < GunRegistry.gunMaterials.size(); ++j) {
                        ...
                        if (this.getStackInSlot(i)
                            .isItemEqual(material.recipe)) {
                            if (baseName.isEmpty()) {
                                baseName = material.id;
                            } else {
                                if (!baseName.equalsIgnoreCase(material.id)) return "";
                            }
                        }
                    }
                } else return "";
        ...
        if (this.index == 0) {
            if (this.getStackInSlot(9) != null) {
                for (int i = 0; i < GunRegistry.gunMaterials.size(); ++i) {
                    ...
                    if (this.getStackInSlot(9)
                        .isItemEqual(material.recipe)) return material.id;
                }
            }
        }
        if (this.index == 1) {
                    ...
                    for (int j = 0; j < GunRegistry.gunMaterials.size(); ++j) {
                        ...
                        if (this.getStackInSlot(i)
                            ...
                            if (handleName.isEmpty()) {
                                ...
                                if (!handleName.equalsIgnoreCase(material.id)) return "";
                            }
                        }
                    }
                } else return "";
                    ...
                    for (int j = 0; j < GunRegistry.gunMaterials.size(); ++j) {
                        ...
                        if (this.getStackInSlot(i)
                            ...
                            if (deviceName.isEmpty()) {
                                ...
                                if (!deviceName.equalsIgnoreCase(material.id)) return "";
                            }
                        }
                    }
                } else return "";
    ...
    public String getLense() {
        ...
        if (this.index == 3) {
            if (this.getStackInSlot(3) != null) {
                if (this.getStackInSlot(3)
                    .getItem() instanceof ItemGenericEC3
                            ...
                            for (int j = 0; j < GunRegistry.lenseMaterials.size(); ++j) {
                                ...
                                if (this.getStackInSlot(i)
                                    ...
                                    if (lenseName.isEmpty()) {
                                        ...
                                        if (!lenseName.equalsIgnoreCase(material.id)) return "";
                                    }
                                }
                            }
                        } else return "";
                        ...
                        for (int j = 5; j < 7; ++j) {
                            if (this.getStackInSlot(j) != null) {
                                for (int k = 0; k < GunRegistry.scopeMaterialsSniper.size(); ++k) {
                                    ...
                                    if (this.getStackInSlot(j)
                                        .isItemEqual(material1.recipe)) {
                                        if (scopeName.isEmpty()) {
                                            scopeName = material1.id;
                                        } else {
                                            if (!scopeName.equalsIgnoreCase(material1.id)) return "";
                                        }
                                    }
                                }
                            } else return "";
        ...
        if (this.getStackInSlot(0) == null) {
            if (this.getStackInSlot(1) != null && isOreDict(this.getStackInSlot(1), "elementalCore")) {
                if (this.getStackInSlot(2) != null && this.getStackInSlot(2)
                    .getItem() instanceof ItemMRUStorageNBTTag
                    ...
                    if (index == 0) {
                        if (!base.isEmpty() && !handle.isEmpty() && !device.isEmpty()) return true;
                    }
                    if (index == 1) {
                        if (!base.isEmpty() && !handle.isEmpty() && !device.isEmpty()) return true;
                    }
                    if (index == 2) {
                        if (!base.isEmpty() && !handle.isEmpty() && !device.isEmpty() && !scope.isEmpty()) return true;
                    }
                    if (index == 3) {
                        if (!base.isEmpty() && !handle.isEmpty() && !device.isEmpty() && !lense.isEmpty()) return true;
                    }
                }
            }
        }
        ...
        if (this.getStackInSlot(0) == null) {
            if (this.getStackInSlot(1) != null && isOreDict(this.getStackInSlot(1), "elementalCore")) {
                if (this.getStackInSlot(2) != null && this.getStackInSlot(2)
                    ...
                    && this.getStackInSlot(2)
                        .getItemDamage() >= 1) {
                    if (this.index == 0) this.previewStack = new ItemStack(ItemsCore.pistol);
                    if (this.index == 1) this.previewStack = new ItemStack(ItemsCore.rifle);
                    if (this.index == 2) this.previewStack = new ItemStack(ItemsCore.sniper);
                    if (this.index == 3) this.previewStack = new ItemStack(ItemsCore.gatling);
    ...
    public void makeWeapon() {
        if (this.areIngridientsCorrect()) {
            ...
            for (int i = 1; i < this.getSizeInventory(); ++i) this.decrStackSize(i, 1);
        }
    }
