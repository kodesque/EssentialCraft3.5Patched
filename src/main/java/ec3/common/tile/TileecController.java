...
public class TileecController extends TileEntity implements ITEHasMRU {
    ...
    public IMRUPressence getMRUCU() {
        if (isCorrect) {
            List<IMRUPressence> pList = this.worldObj.getEntitiesWithinAABB(
                IMRUPressence.class,
                        ...
                        if (z == minZ || z == maxZ || x == minX || x == maxX || y == minY || y == maxY) {
                            if (allowedBlocks.contains(this.worldObj.getBlock(xCoord + x, yCoord + y, zCoord + z))) {
                                this.blocksInStructure
                                    .add(new BlockPosition(worldObj, xCoord + x, yCoord + y, zCoord + z));
                                ...
                                if (this.worldObj.getTileEntity(xCoord + x, yCoord + y, zCoord + z) != null
                                    ...
                                    if (this.worldObj.getTileEntity(
                                        xCoord + x,
                                        yCoord + y,
                                        zCoord + z) instanceof TileecHoldingChamber) {
