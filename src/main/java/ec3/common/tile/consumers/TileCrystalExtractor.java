...
public class TileCrystalExtractor extends TileMRUGeneric {
    ...
    public void createItems() {
        ...
        if (!this.worldObj.isRemote) {
            for (int i = 1; i < 13; ++i) {
                ItemStack st = new ItemStack(ECItems.essence, 1, this.worldObj.rand.nextInt(16));
    ...
    public boolean canWork() {
        ...
        if (this.getCrystal() == null) return false;
        return true;
    }
    ...
    public void spawnParticles() {
        if (this.canWork() && this.getMRU() > 0) {
            TileElementalCrystal t = this.getCrystal();
            if (t != null) for (int o = 0; o < 10; ++o) {
                this.worldObj.spawnParticle(
                    "portal",
                    xCoord + this.worldObj.rand.nextDouble(),
                    t.yCoord + this.worldObj.rand.nextDouble(),
