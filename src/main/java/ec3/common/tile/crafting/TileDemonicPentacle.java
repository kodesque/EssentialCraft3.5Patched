...
public class TileDemonicPentacle extends TileEntity {
    ...
    public boolean consumeEnderstarEnergy(int consumed) {
        int[][] coords = new int[][] { { 2, 1, 2 }, { 2, 1, -2 }, { -2, 1, 2 }, { -2, 1, -2 }, { 3, 0, 2 },
            { 3, 0, -2 }, { -3, 0, 2 }, { -3, 0, -2 }, { 2, 0, 3 }, { 2, 0, -3 }, { -2, 0, 3 }, { -2, 0, -3 },
    ...
    public void updateEntity() {
        List<EntityDemon> demons = this.worldObj.getEntitiesWithinAABB(
            EntityDemon.class,
    ...
    public void checkStructureAndTier() {
        ...
        if (w.getBlock(x, y, z) == ECBlocks.voidStone && w.getBlock(x + 2, y, z) == ECBlocks.voidStone
            && w.getBlock(x - 2, y, z) == ECBlocks.voidStone
            && w.getBlock(x, y, z - 2) == ECBlocks.voidStone
            && w.getBlock(x, y, z + 2) == ECBlocks.voidStone
            && w.getBlock(x + 3, y, z + 1) == ECBlocks.voidStone
            && w.getBlock(x + 3, y, z - 1) == ECBlocks.voidStone
            && w.getBlock(x - 3, y, z + 1) == ECBlocks.voidStone
            && w.getBlock(x - 3, y, z - 1) == ECBlocks.voidStone
            && w.getBlock(x + 1, y, z + 3) == ECBlocks.voidStone
            && w.getBlock(x - 1, y, z + 3) == ECBlocks.voidStone
            && w.getBlock(x + 1, y, z - 3) == ECBlocks.voidStone
            && w.getBlock(x - 1, y, z - 3) == ECBlocks.voidStone
            ...
            && w.getBlock(x, y + 1, z - 3) == Blocks.glowstone
            && w.getBlock(x + 2, y + 1, z + 2) == ECBlocks.invertedBlock
            && w.getBlock(x - 2, y + 1, z + 2) == ECBlocks.invertedBlock
            && w.getBlock(x + 2, y + 1, z - 2) == ECBlocks.invertedBlock
            && w.getBlock(x - 2, y + 1, z - 2) == ECBlocks.invertedBlock
            && w.getBlock(x + 1, y, z) == ECBlocks.platingPale
            && w.getBlock(x - 1, y, z) == ECBlocks.platingPale
            && w.getBlock(x, y, z + 1) == ECBlocks.platingPale
            && w.getBlock(x, y, z - 1) == ECBlocks.platingPale
            ...
            && w.getBlock(x - 1, y, z + 2) == ECBlocks.platingPale
            && w.getBlock(x - 1, y, z - 2) == ECBlocks.platingPale
            && w.getBlock(x + 3, y, z + 2) == ECBlocks.platingPale
            && w.getBlock(x + 3, y, z - 2) == ECBlocks.platingPale
            && w.getBlock(x - 3, y, z + 2) == ECBlocks.platingPale
            && w.getBlock(x - 3, y, z - 2) == ECBlocks.platingPale
            && w.getBlock(x + 2, y, z + 3) == ECBlocks.platingPale
            && w.getBlock(x + 2, y, z - 3) == ECBlocks.platingPale
            && w.getBlock(x - 2, y, z + 3) == ECBlocks.platingPale
            && w.getBlock(x - 2, y, z - 3) == ECBlocks.platingPale
            &&

            w.getBlock(x + 3, y + 1, z + 2) == ECBlocks.mithrilineCrystal
            && w.getBlock(x + 3, y + 1, z - 2) == ECBlocks.mithrilineCrystal
            && w.getBlock(x - 3, y + 1, z + 2) == ECBlocks.mithrilineCrystal
            && w.getBlock(x - 3, y + 1, z - 2) == ECBlocks.mithrilineCrystal
            && w.getBlock(x + 2, y + 1, z + 3) == ECBlocks.mithrilineCrystal
            && w.getBlock(x + 2, y + 1, z - 3) == ECBlocks.mithrilineCrystal
            && w.getBlock(x - 2, y + 1, z + 3) == ECBlocks.mithrilineCrystal
            && w.getBlock(x - 2, y + 1, z - 3) == ECBlocks.mithrilineCrystal
            &&
            ...
            w.getBlock(x + 2, y + 2, z + 2) == ECBlocks.mithrilineCrystal
            && w.getBlock(x - 2, y + 2, z + 2) == ECBlocks.mithrilineCrystal
            && w.getBlock(x + 2, y + 2, z - 2) == ECBlocks.mithrilineCrystal
            && w.getBlock(x - 2, y + 2, z - 2) == ECBlocks.mithrilineCrystal
            ...
            w.getBlock(x + 3, y + 2, z) == ECBlocks.mithrilineCrystal
            && w.getBlock(x - 3, y + 2, z) == ECBlocks.mithrilineCrystal
            && w.getBlock(x, y + 2, z + 3) == ECBlocks.mithrilineCrystal
            && w.getBlock(x, y + 2, z - 3) == ECBlocks.mithrilineCrystal
