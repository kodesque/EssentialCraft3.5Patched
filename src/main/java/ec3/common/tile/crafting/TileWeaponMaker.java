...
public class TileWeaponMaker extends TileMRUGeneric {
    ...
    public String getLense() {
        ...
        if (this.index == 3) {
            if (this.getStackInSlot(3) != null) {
                if (this.getStackInSlot(3)
                    .getItem() instanceof ItemGenericEC
        ...
        if (this.getStackInSlot(0) == null) {
            if (this.getStackInSlot(1) != null && isOreDict(this.getStackInSlot(1), "elementalCore")) {
                if (this.getStackInSlot(2) != null && this.getStackInSlot(2)
                    ...
                    && this.getStackInSlot(2)
                        .getItemDamage() >= 1) {
                    if (this.index == 0) this.previewStack = new ItemStack(ECItems.pistol);
                    if (this.index == 1) this.previewStack = new ItemStack(ECItems.rifle);
                    if (this.index == 2) this.previewStack = new ItemStack(ECItems.sniper);
                    if (this.index == 3) this.previewStack = new ItemStack(ECItems.gatling);
