...
public class TileNewMIM extends TileMRUGeneric {
        ...
        if (tickTime == 0) {
            ...
            if (tickTime == 9) {
                for (int i = 35; i < 53; ++i) {
                    ...
                    if (gem != null && gem.getItem() instanceof ItemBoundGem
                        && gem.getTagCompound() != null
                        && gem.getTagCompound()
                            .hasKey("pos")
                        && gem.getTagCompound()
                            .getInteger("dim") == this.worldObj.provider.dimensionId) {
                        ...
                        if (this.worldObj.blockExists(c[0], c[1], c[2])) {
                            ...
                            if (t != null && t instanceof TileNewMIMExportNode) {
                                TileNewMIMExportNode.class.cast(t)
                                    .exportAllPossibleItems(this);
                            }
                        }
                    }
                }
                    ...
                    if (gem != null && gem.getItem() instanceof ItemBoundGem
                        ...
                        if (this.worldObj.blockExists(c[0], c[1], c[2])) {
                            ...
                            if (t != null && t instanceof TileNewMIMImportNode) {
                                TileNewMIMImportNode.class.cast(t)
                                    .importAllPossibleItems(this);
                            }
                        }
                    }
                }
     ...
     * @return true if the operation was sucessfull, and the Inserter MUST set the ItemStack to null. False otherwise.
     *         Note, that the ItemStack may have been changed(the stacksize)
     */
            ...
            if (gem != null && gem.getItem() instanceof ItemBoundGem
                ...
                if (this.worldObj.blockExists(c[0], c[1], c[2])) {
                    ...
                    if (t != null && t instanceof TileNewMIMInventoryStorage) {
                        if (TileNewMIMInventoryStorage.class.cast(t)
                            .insertItemStack(is)) return true;
                        else continue;
                    }
                }
            }
    ...
    public ArrayList<CraftingPattern> getCraftsByName(String namePart) {
        ...
        for (int i = 0; i < crafts.size(); ++i) {
            ...
            if (stk.getDisplayName()
                .toLowerCase()
                .contains(namePart.toLowerCase())) retLst.add(crafts.get(i));
        }
        ...
        for (int i = 1; i < 7; ++i) {
            ...
            if (gem != null && gem.getItem() instanceof ItemBoundGem
                ...
                if (this.worldObj.blockExists(c[0], c[1], c[2])) {
                    TileEntity t = this.worldObj.getTileEntity(c[0], c[1], c[2]);
                    if (t != null && t instanceof TileNewMIMInventoryStorage) {
                        int newLeft = TileNewMIMInventoryStorage.class.cast(t)
                            .retrieveStack(is, oreDict, doRetrieve);
                        if (newLeft == 0) {
                            if (!doRetrieve) is.stackSize = oldSize;
                            return 0;
                        } else {
                            left = newLeft;
        ...
        for (int i = 1; i < 7; ++i) {
            ...
            if (gem != null && gem.getItem() instanceof ItemBoundGem
                ...
                if (this.worldObj.blockExists(c[0], c[1], c[2])) {
                    TileEntity t = this.worldObj.getTileEntity(c[0], c[1], c[2]);
                    if (t != null && t instanceof TileNewMIMInventoryStorage) {
                        TileNewMIMInventoryStorage.class.cast(t)
                            .openInventory(p);
                    }
                }
            }
        ...
        for (int i = 1; i < 7; ++i) {
            ...
            if (gem != null && gem.getItem() instanceof ItemBoundGem
                ...
                if (this.worldObj.blockExists(c[0], c[1], c[2])) {
                    TileEntity t = this.worldObj.getTileEntity(c[0], c[1], c[2]);
                    if (t != null && t instanceof TileNewMIMInventoryStorage) {
                        ArrayList<ItemStack> items = TileNewMIMInventoryStorage.class.cast(t)
                            .getAllItems();
                        for (int j = 0; j < items.size(); ++j) {
                            ItemStack itm = items.get(j);
                            if (itm != null) {
                                String id = GameRegistry.findUniqueIdentifierFor(itm.getItem())
                                    .toString() + "@"
                                    + itm.getItemDamage();
                                if (itm.getTagCompound() == null || itm.getTagCompound()
                                    .hasNoTags()) {
        ...
        for (int i = 11; i < 17; ++i) {
            ...
            if (gem != null && gem.getItem() instanceof ItemBoundGem
                ...
                if (this.worldObj.blockExists(c[0], c[1], c[2])) {
                    ...
                    if (t != null && t instanceof TileNewMIMCraftingManager) {
                        this.crafts.addAll(
                            TileNewMIMCraftingManager.class.cast(t)
                                .getAllRecipes());
                    }
                }
            }
