...
public class TileChamberRedstoneController extends TileEntity implements IStructurePiece {
    ...
    public boolean outputRedstone() {
        if (this.controller != null && this.controller.getMRUCU() != null
            && ((float) this.controller.getMRU() / (float) this.controller.getMaxMRU()) * 10 >= this.setting)
            return true;
