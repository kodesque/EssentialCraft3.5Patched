...
public class WorldGenElementalDrops extends WorldGenerator {
    ...
    public boolean generate(World w, Random rnd, int x, int y, int z) {
        ...
        new WorldGenMinable(BlocksCore.oreDrops, meta + 1, 8, minableReplacable).generate(
            w,
            rnd,
            x + rnd.nextInt(6) - rnd.nextInt(6),
            y + rnd.nextInt(6) - rnd.nextInt(6),
            z + rnd.nextInt(6) - rnd.nextInt(6));
        new WorldGenMinable(BlocksCore.oreDrops, meta + 2, 8, minableReplacable).generate(
            w,
            rnd,
            x + rnd.nextInt(6) - rnd.nextInt(6),
            y + rnd.nextInt(6) - rnd.nextInt(6),
            z + rnd.nextInt(6) - rnd.nextInt(6));
        new WorldGenMinable(BlocksCore.oreDrops, meta + 3, 8, minableReplacable).generate(
            w,
            rnd,
            x + rnd.nextInt(6) - rnd.nextInt(6),
            y + rnd.nextInt(6) - rnd.nextInt(6),
            z + rnd.nextInt(6) - rnd.nextInt(6));
        new WorldGenMinable(BlocksCore.oreDrops, meta + 4, 8, minableReplacable).generate(
            w,
            rnd,
            x + rnd.nextInt(6) - rnd.nextInt(6),
            y + rnd.nextInt(6) - rnd.nextInt(6),
