...
public class MapGenTown extends MapGenStructure {
    ...
    public static List villageSpawnBiomes = Arrays.asList(
        new BiomeGenBase[] { BiomeGenBase.plains, BiomeRegistry.chaosCorruption, BiomeRegistry.frozenCorruption });
    ...
    public MapGenTown(Map p_i2093_1_) {
        this();
        Iterator iterator = p_i2093_1_.entrySet()
            .iterator();
    ...
    public static class Start extends StructureStart {
        ...
        public Start(World p_i2092_1_, Random p_i2092_2_, int p_i2092_3_, int p_i2092_4_, int p_i2092_5_) {
            ...
            StructureTownPieces.Start start = new StructureTownPieces.Start(
