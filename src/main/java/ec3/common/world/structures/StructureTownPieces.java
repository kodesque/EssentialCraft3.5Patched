...
public class StructureTownPieces {
    ...
    public static void registerVillagePieces() {
        MapGenStructureIO.func_143031_a(House1.class, "TViBH");
        MapGenStructureIO.func_143031_a(Field1.class, "TViDF");
        MapGenStructureIO.func_143031_a(Torch.class, "TViL");
        MapGenStructureIO.func_143031_a(Hall.class, "TViPH");
        MapGenStructureIO.func_143031_a(House4Garden.class, "TViSH");
        MapGenStructureIO.func_143031_a(WoodHut.class, "TViSmH");
        MapGenStructureIO.func_143031_a(Church.class, "TViST");
        MapGenStructureIO.func_143031_a(House2.class, "TViS");
        MapGenStructureIO.func_143031_a(Start.class, "TViStart");
        MapGenStructureIO.func_143031_a(Path.class, "TViSR");
        MapGenStructureIO.func_143031_a(House3.class, "TViTRH");
        MapGenStructureIO.func_143031_a(Well.class, "TViW");
    }
    ...
    private static Village func_75083_a(Start p_75083_0_, PieceWeight p_75083_1_, List p_75083_2_, Random p_75083_3_,
        int p_75083_4_, int p_75083_5_, int p_75083_6_, int p_75083_7_, int p_75083_8_) {
        Class oclass = p_75083_1_.villagePieceClass;
        Object object = null;

        if (oclass == House4Garden.class) {
            object = House4Garden.func_74912_a(
                p_75083_0_,
                p_75083_2_,
                p_75083_3_,
                p_75083_4_,
     ...
     */
    private static Village getNextVillageComponent(Start p_75081_0_, List p_75081_1_, Random p_75081_2_, int p_75081_3_,
        int p_75081_4_, int p_75081_5_, int p_75081_6_, int p_75081_7_) {
        ...
        if (j1 <= 0) {
            ...
            StructureBoundingBox structureboundingbox = Torch
                .func_74904_a(p_75081_0_, p_75081_1_, p_75081_2_, p_75081_3_, p_75081_4_, p_75081_5_, p_75081_6_);
     ...
     */
    private static StructureComponent getNextVillageStructureComponent(Start p_75077_0_, List p_75077_1_,
        Random p_75077_2_, int p_75077_3_, int p_75077_4_, int p_75077_5_, int p_75077_6_, int p_75077_7_) {
        if (p_75077_7_ > 500) {
            return null;
        } else if (Math.abs(p_75077_3_ - p_75077_0_.getBoundingBox().minX) <= 600
            && Math.abs(p_75077_5_ - p_75077_0_.getBoundingBox().minZ) <= 600) {
                Village village = getNextVillageComponent(
                    p_75077_0_,
                    p_75077_1_,
                    p_75077_2_,
                    p_75077_3_,
    ...
    private static StructureComponent getNextComponentVillagePath(Start p_75080_0_, List p_75080_1_, Random p_75080_2_,
        int p_75080_3_, int p_75080_4_, int p_75080_5_, int p_75080_6_, int p_75080_7_) {
        if (p_75080_7_ > 50 + p_75080_0_.terrainType) {
            return null;
        } else if (Math.abs(p_75080_3_ - p_75080_0_.getBoundingBox().minX) <= 600
            && Math.abs(p_75080_5_ - p_75080_0_.getBoundingBox().minZ) <= 600) {
                StructureBoundingBox structureboundingbox = Path
                    .func_74933_a(p_75080_0_, p_75080_1_, p_75080_2_, p_75080_3_, p_75080_4_, p_75080_5_, p_75080_6_);
    ...
    public static class Church extends Village {
        ...
        public Church(Start p_i2102_1_, int p_i2102_2_, Random p_i2102_3_, StructureBoundingBox p_i2102_4_,
            int p_i2102_5_) {
        ...
        public static Church func_74919_a(Start p_74919_0_, List p_74919_1_, Random p_74919_2_, int p_74919_3_,
            int p_74919_4_, int p_74919_5_, int p_74919_6_, int p_74919_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74919_3_, p_74919_4_, p_74919_5_, 0, 0, 0, 5, 12, 9, p_74919_6_);
            return canVillageGoDeeper(structureboundingbox)
                && StructureComponent.findIntersecting(p_74919_1_, structureboundingbox) == null
                    ? new Church(p_74919_0_, p_74919_7_, p_74919_2_, structureboundingbox, p_74919_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            if (p_74875_1_.provider.dimensionId == Config.dimensionID) new WorldGenMRUTower().generate(
                p_74875_1_,
                p_74875_2_,
                p_74875_3_.minX,
                this.getAverageGroundLevel(p_74875_1_, p_74875_3_),
                p_74875_3_.minZ);
            return true;
        }
    ...
    public static class Field1 extends Village {
        ...
        public Field1(Start p_i2095_1_, int p_i2095_2_, Random p_i2095_3_, StructureBoundingBox p_i2095_4_,
            int p_i2095_5_) {
        ...
        public static Field1 func_74900_a(Start p_74900_0_, List p_74900_1_, Random p_74900_2_, int p_74900_3_,
            int p_74900_4_, int p_74900_5_, int p_74900_6_, int p_74900_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74900_3_, p_74900_4_, p_74900_5_, 0, 0, 0, 13, 4, 9, p_74900_6_);
            return canVillageGoDeeper(structureboundingbox)
                && StructureComponent.findIntersecting(p_74900_1_, structureboundingbox) == null
                    ? new Field1(p_74900_0_, p_74900_7_, p_74900_2_, structureboundingbox, p_74900_6_)
                    : null;
        }
    ...
    public static class Field2 extends Village {
        ...
        public Field2(Start p_i2096_1_, int p_i2096_2_, Random p_i2096_3_, StructureBoundingBox p_i2096_4_,
            int p_i2096_5_) {
        ...
        public static Field2 func_74902_a(Start p_74902_0_, List p_74902_1_, Random p_74902_2_, int p_74902_3_,
            int p_74902_4_, int p_74902_5_, int p_74902_6_, int p_74902_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74902_3_, p_74902_4_, p_74902_5_, 0, 0, 0, 7, 4, 9, p_74902_6_);
            return canVillageGoDeeper(structureboundingbox)
                && StructureComponent.findIntersecting(p_74902_1_, structureboundingbox) == null
                    ? new Field2(p_74902_0_, p_74902_7_, p_74902_2_, structureboundingbox, p_74902_6_)
                    : null;
        }
    ...
    public static class Hall extends Village {
        ...
        public Hall(Start p_i2099_1_, int p_i2099_2_, Random p_i2099_3_, StructureBoundingBox p_i2099_4_,
            int p_i2099_5_) {
        ...
        public static Hall func_74906_a(Start p_74906_0_, List p_74906_1_, Random p_74906_2_, int p_74906_3_,
            int p_74906_4_, int p_74906_5_, int p_74906_6_, int p_74906_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74906_3_, p_74906_4_, p_74906_5_, 0, 0, 0, 9, 7, 11, p_74906_6_);
            return canVillageGoDeeper(structureboundingbox)
                && StructureComponent.findIntersecting(p_74906_1_, structureboundingbox) == null
                    ? new Hall(p_74906_0_, p_74906_7_, p_74906_2_, structureboundingbox, p_74906_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            if (p_74875_1_.provider.dimensionId == Config.dimensionID) new WorldGenMRUSpreader().generate(
                p_74875_1_,
                p_74875_2_,
                p_74875_3_.minX,
                this.getAverageGroundLevel(p_74875_1_, p_74875_3_),
    ...
    public static class House1 extends Village {
        ...
        public House1(Start p_i2094_1_, int p_i2094_2_, Random p_i2094_3_, StructureBoundingBox p_i2094_4_,
            int p_i2094_5_) {
        ...
        public static House1 func_74898_a(Start p_74898_0_, List p_74898_1_, Random p_74898_2_, int p_74898_3_,
            int p_74898_4_, int p_74898_5_, int p_74898_6_, int p_74898_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74898_3_, p_74898_4_, p_74898_5_, 0, 0, 0, 9, 9, 6, p_74898_6_);
            return canVillageGoDeeper(structureboundingbox)
                && StructureComponent.findIntersecting(p_74898_1_, structureboundingbox) == null
                    ? new House1(p_74898_0_, p_74898_7_, p_74898_2_, structureboundingbox, p_74898_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            if (p_74875_1_.provider.dimensionId == Config.dimensionID)
                new WorldGenDestroyedHouse(p_74875_2_.nextInt(2) + 1, 5).generate(
                    p_74875_1_,
                    p_74875_2_,
                    p_74875_3_.minX,
                    this.getAverageGroundLevel(p_74875_1_, p_74875_3_),
    ...
    public static class House2 extends Village {
        ...
        public House2(Start p_i2103_1_, int p_i2103_2_, Random p_i2103_3_, StructureBoundingBox p_i2103_4_,
            int p_i2103_5_) {
        ...
        public static House2 func_74915_a(Start p_74915_0_, List p_74915_1_, Random p_74915_2_, int p_74915_3_,
            int p_74915_4_, int p_74915_5_, int p_74915_6_, int p_74915_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74915_3_, p_74915_4_, p_74915_5_, 0, 0, 0, 10, 6, 7, p_74915_6_);
            return canVillageGoDeeper(structureboundingbox)
                && StructureComponent.findIntersecting(p_74915_1_, structureboundingbox) == null
                    ? new House2(p_74915_0_, p_74915_7_, p_74915_2_, structureboundingbox, p_74915_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            if (p_74875_1_.provider.dimensionId == Config.dimensionID)
                new WorldGenDestroyedHouse(p_74875_2_.nextInt(5) + 1, 4).generate(
                    p_74875_1_,
                    p_74875_2_,
                    p_74875_3_.minX,
                    this.getAverageGroundLevel(p_74875_1_, p_74875_3_),
    ...
    public static class House3 extends Village {
        ...
        public House3(Start p_i2106_1_, int p_i2106_2_, Random p_i2106_3_, StructureBoundingBox p_i2106_4_,
            int p_i2106_5_) {
        ...
        public static House3 func_74921_a(Start p_74921_0_, List p_74921_1_, Random p_74921_2_, int p_74921_3_,
            int p_74921_4_, int p_74921_5_, int p_74921_6_, int p_74921_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74921_3_, p_74921_4_, p_74921_5_, 0, 0, 0, 9, 7, 12, p_74921_6_);
            return canVillageGoDeeper(structureboundingbox)
                && StructureComponent.findIntersecting(p_74921_1_, structureboundingbox) == null
                    ? new House3(p_74921_0_, p_74921_7_, p_74921_2_, structureboundingbox, p_74921_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            if (p_74875_1_.provider.dimensionId == Config.dimensionID)
                new WorldGenDestroyedHouse(p_74875_2_.nextInt(9) + 1, 3).generate(
                    p_74875_1_,
                    p_74875_2_,
                    p_74875_3_.minX,
                    this.getAverageGroundLevel(p_74875_1_, p_74875_3_),
    ...
    public static class House4Garden extends Village {
        ...
        public House4Garden(Start p_i2100_1_, int p_i2100_2_, Random p_i2100_3_, StructureBoundingBox p_i2100_4_,
            int p_i2100_5_) {
        ...
        public static House4Garden func_74912_a(Start p_74912_0_, List p_74912_1_, Random p_74912_2_, int p_74912_3_,
            int p_74912_4_, int p_74912_5_, int p_74912_6_, int p_74912_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74912_3_, p_74912_4_, p_74912_5_, 0, 0, 0, 5, 6, 5, p_74912_6_);
            return StructureComponent.findIntersecting(p_74912_1_, structureboundingbox) != null ? null
                : new House4Garden(p_74912_0_, p_74912_7_, p_74912_2_, structureboundingbox, p_74912_6_);
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            if (p_74875_1_.provider.dimensionId == Config.dimensionID)
                new WorldGenDestroyedHouse(p_74875_2_.nextInt(3) + 1, 7).generate(
                    p_74875_1_,
                    p_74875_2_,
                    p_74875_3_.minX,
                    this.getAverageGroundLevel(p_74875_1_, p_74875_3_),
    ...
    public static class Path extends Road {
        ...
        public Path(Start p_i2105_1_, int p_i2105_2_, Random p_i2105_3_, StructureBoundingBox p_i2105_4_,
            int p_i2105_5_) {
        ...
        public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_) {
            ...
            for (i = p_74861_3_.nextInt(18); i < this.averageGroundLevel - 8; i += 2 + p_74861_3_.nextInt(18)) {
                ...
                if (structurecomponent1 != null) {
                    i += Math.max(
                        structurecomponent1.getBoundingBox()
                            .getXSize(),
                        structurecomponent1.getBoundingBox()
                            .getZSize());
                    flag = true;
            ...
            if (flag && p_74861_3_.nextInt(18) > 0) {
                switch (this.coordBaseMode) {
                    case 0:
                        StructureTownPieces.getNextComponentVillagePath(
                            (Start) p_74861_1_,
                            p_74861_2_,
                            p_74861_3_,
        ...
        public static StructureBoundingBox func_74933_a(Start p_74933_0_, List p_74933_1_, Random p_74933_2_,
            int p_74933_3_, int p_74933_4_, int p_74933_5_, int p_74933_6_) {
            for (int i1 = 7 * MathHelper.getRandomIntegerInRange(p_74933_2_, 3, 5); i1 >= 7; i1 -= 7) {
                StructureBoundingBox structureboundingbox = StructureBoundingBox
                    .getComponentToAddBoundingBox(p_74933_3_, p_74933_4_, p_74933_5_, 0, 0, 0, 5, 5, i1, p_74933_6_);
         ...
         */
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            Block block = this.func_151558_b(ECBlocks.concrete, 0);
    ...
    public static class Torch extends Village {
        ...
        public Torch(Start p_i2097_1_, int p_i2097_2_, Random p_i2097_3_, StructureBoundingBox p_i2097_4_,
            int p_i2097_5_) {
        ...
        public static StructureBoundingBox func_74904_a(Start p_74904_0_, List p_74904_1_, Random p_74904_2_,
            int p_74904_3_, int p_74904_4_, int p_74904_5_, int p_74904_6_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74904_3_, p_74904_4_, p_74904_5_, 0, 0, 0, 3, 4, 2, p_74904_6_);
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            if (p_74875_1_.provider.dimensionId == Config.dimensionID) {
                ...
                this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.fence[0], 0, 1, 0, 0, p_74875_3_);
                this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.fence[0], 0, 1, 1, 0, p_74875_3_);
                this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.fence[0], 0, 1, 2, 0, p_74875_3_);
                this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.voidStone, 15, 1, 3, 0, p_74875_3_);
                this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.torch, 0, 0, 3, 0, p_74875_3_);
                this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.torch, 0, 1, 3, 1, p_74875_3_);
                this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.torch, 0, 2, 3, 0, p_74875_3_);
                this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.torch, 0, 1, 3, -1, p_74875_3_);
            }
            return true;
        }
    ...
    public abstract static class Village extends StructureComponent {
         ...
         */
        protected StructureComponent getNextComponentNN(Start p_74891_1_, List p_74891_2_, Random p_74891_3_,
            int p_74891_4_, int p_74891_5_) {
            switch (this.coordBaseMode) {
                case 0:
                    return StructureTownPieces.getNextVillageStructureComponent(
                        p_74891_1_,
                        p_74891_2_,
                        p_74891_3_,
                        this.boundingBox.minX - 1,
         ...
         * Gets the next village component, with the bounding box shifted +1 in the X and Z direction.
         */
        protected StructureComponent getNextComponentPP(Start p_74894_1_, List p_74894_2_, Random p_74894_3_,
        ...
        protected int getAverageGroundLevel(World p_74889_1_, StructureBoundingBox p_74889_2_) {
            int i = 0;
            int j = 0;
            if (this.boundingBox == null) this.boundingBox = p_74889_2_;
            for (int k = this.boundingBox.minZ; k <= this.boundingBox.maxZ; ++k) {
                for (int l = this.boundingBox.minX; l <= this.boundingBox.maxX; ++l) {
                    if (p_74889_2_.isVecInside(l, 64, k)) {
                        i += Math.max(
                            p_74889_1_.getTopSolidOrLiquidBlock(l, k),
    ...
    public static class WoodHut extends Village {
        ...
        public WoodHut(Start p_i2101_1_, int p_i2101_2_, Random p_i2101_3_, StructureBoundingBox p_i2101_4_,
            int p_i2101_5_) {
        ...
        public static WoodHut func_74908_a(Start p_74908_0_, List p_74908_1_, Random p_74908_2_, int p_74908_3_,
            int p_74908_4_, int p_74908_5_, int p_74908_6_, int p_74908_7_) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74908_3_, p_74908_4_, p_74908_5_, 0, 0, 0, 4, 6, 5, p_74908_6_);
            return canVillageGoDeeper(structureboundingbox)
                && StructureComponent.findIntersecting(p_74908_1_, structureboundingbox) == null
                    ? new WoodHut(p_74908_0_, p_74908_7_, p_74908_2_, structureboundingbox, p_74908_6_)
                    : null;
        }
        ...
        public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            // TODO do
            if (p_74875_1_.provider.dimensionId == Config.dimensionID) {
                ECExplosion explosion = new ECExplosion(
                    p_74875_1_,
                    null,
                    p_74875_3_.minX,
                    this.getAverageGroundLevel(p_74875_1_, p_74875_3_) - 3,
                    p_74875_3_.minZ,
                    15F);
