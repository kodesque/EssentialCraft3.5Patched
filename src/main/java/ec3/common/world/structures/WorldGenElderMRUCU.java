...
public class WorldGenElderMRUCU extends WorldGenerator {
    ...
    public static void handleGeneration(Random random, int chunkX, int chunkZ, World world,
        ...
        for (int i = 0; i < Config.eMRUCUGenAttempts; ++i) {
            ...
            new WorldGenElderMRUCU(random.nextInt(4)).generate(world, random, rndX, rndY, rndZ);
        }
    }

    public WorldGenElderMRUCU(int i) {
        type = i;
    }
                ...
                for (int z = -2; z <= 2; ++z) {
                    ...
                    if ((x == -2 || x == 2) || (z == -2 || z == 2)) {
                        var1.setBlock(
                            ...
                            var4 + 1,
                            var5 + z,
                            Block.getBlockFromName("minecraft:cobblestone_wall"),
                            0,
                            3);
                    }
                    if (x == 0 && z == 0) {
                        var1.setBlock(
                            ...
                            var4 + 1,
                            var5 + z,
                            Block.getBlockFromName("minecraft:stonebrick"),
                            3,
                            3);
                        ECUtils.createMRUCUAt(
                            var1,
                            new Coord3D(var3 + x + 0.5F, var4 + 1.5F, var5 + z + 0.5F),
                            5000 + var2.nextInt(5000),
                            MathUtils.randomFloat(var2) + 1.0F,
                            false,
                            false);
                    }
                }
                ...
                for (int z = -4; z <= 4; ++z) {
                    ...
                    if ((x == -3 && z == -3) || (x == 3 && z == -3) || (x == 3 && z == 3) || (x == -3 && z == 3)) {
                        var1.setBlock(
                            ...
                            var4 + 1,
                            var5 + z,
                            Block.getBlockFromName("minecraft:chest"),
                            var2.nextInt(4),
                            3);
                        TileEntityChest tileentitychest = (TileEntityChest) var1
                            .getTileEntity(var3 + x, var4 + 1, var5 + z);

                        if (tileentitychest != null) {
                            WeightedRandomChestContent.generateChestContents(
                                var2,
                                ChestGenHooks.getItems(DUNGEON_CHEST, var2),
                                tileentitychest,
                                ChestGenHooks.getCount(DUNGEON_CHEST, var2));
                        }
                    }
                }
            }
                ...
                for (int z = -4; z <= 4; ++z) {
                    ...
                    if ((x == -4 || x == 4) || (z == -4 || z == 4)) {
                        var1.setBlock(
                            ...
                            var4 + 1,
                            var5 + z,
                            Block.getBlockFromName("minecraft:iron_bars"),
                            0,
                            3);
                        var1.setBlock(
                            var3 + x,
                    ...
                    if ((x == -1 && z == 0) || (x == 1 && z == 0) || (x == 0 && z == 1) || (x == 0 && z == -1)) {
                        var1.setBlock(
                            ...
                            var4 + 1,
                            var5 + z,
                            Block.getBlockFromName("minecraft:mob_spawner"),
                            0,
                            3);
                        TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner) var1
                            .getTileEntity(var3 + x, var4 + 1, var5 + z);

                        if (tileentitymobspawner != null) {
                            tileentitymobspawner.func_145881_a()
                                .setEntityName(DungeonHooks.getRandomDungeonMob(var2));
                        }
                    }
                }
            }
            ...
            for (int dz = minZ; dz <= maxZ; ++dz) {
                ...
                if (!b.isAir(w, dx, y, dz) && b.isNormalCube(w, dx, y, dz)) {
                    if (requiresSolidBlocks) {
                        if (!w.getBlock(dx, y + 1, dz)
                            .isNormalCube(w, dx, y, dz) || w.getBlock(dx, y + 1, dz)
                                .isAir(w, dx, y + 1, dz)) {} else
                            return false;
                    } else {
                        if (w.getBlock(dx, y, dz)
                            .isReplaceableOreGen(w, dx, y, dz, Blocks.stone)) {} else return false;
                    }
