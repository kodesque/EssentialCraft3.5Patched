...
import ec3.dummycore.utils.CustomTXTConfig;
                ...
                if (name.endsWith(NetHandlerPlayClientName) || name.endsWith(NotchNetHandlerPlayClientName)
                                                                                                             ...
                                                                                                             // class.
                    {
                                                                                        ...
                                                                                        // class
                        {
                            ...
                            if (node.desc.equalsIgnoreCase("LDummyCore/Utils/DCASMCheck;")) // If the given annotation
                                                                                            // is a DummyCore
                                                                                            // annotation, that sygnals,
                                                                                            // that the class needs to
                                                                                            // be checked.
                            {
                                checkClass = true;
                                break; // We have to send our class outside the loop to make sure there is no
