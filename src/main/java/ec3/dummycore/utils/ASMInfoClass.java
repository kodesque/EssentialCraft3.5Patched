...
final class ASMInfoClass {
    ...
    private class Signatures {
        ...
        // Everything in () are PARAMS. [ indicates an ARRAY. java/lang/String = link to PARAM. If PARAM is not an
        // object, it will be I = int, F = float, D = double, etc.
    ...
    private class ASMUsageRules {
        ...
        /*
         * ...
         * Notifier.notifyCustomMod("DummyCoreASM",
