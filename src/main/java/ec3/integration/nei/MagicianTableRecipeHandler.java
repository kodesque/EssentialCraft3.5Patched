...
public class MagicianTableRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        super.transferRects
            .add(new RecipeTransferRect(new Rectangle(70, 20, 32, 18), this.getOverlayIdentifier(), new Object[0]));
    }
    ...
    public void drawExtras(int recipe) {
        if (this.cycleticks % 30 == 0) {
            ...
            for (int i = 0; i < cp.getIngredients()
                .size(); ++i) {
                PositionedStack stack = cp.getIngredients()
                    .get(i);
        ...
        Minecraft.getMinecraft().fontRenderer
            .drawStringWithShadow(rec.mruRequired + " MRU", posX + 2, posY + 5, 0xffffff);
