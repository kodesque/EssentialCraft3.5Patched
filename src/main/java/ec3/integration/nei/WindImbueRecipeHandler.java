...
public class WindImbueRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        super.transferRects
            .add(new RecipeTransferRect(new Rectangle(72, 0, 18, 18), this.getOverlayIdentifier(), new Object[0]));
    }
    ...
    public void drawExtras(int recipe) {
        ...
        Minecraft.getMinecraft().fontRenderer
            .drawString(MathHelper.floor_double(pair.energy) + " ESPE", 53, 36, 0x000000, false);
