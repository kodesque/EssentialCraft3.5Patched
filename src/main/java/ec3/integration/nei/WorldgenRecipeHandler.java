...
public class WorldgenRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        super.transferRects
            .add(new RecipeTransferRect(new Rectangle(78, 38, 18, 28), this.getOverlayIdentifier(), new Object[0]));
    }
    ...
    public void drawExtras(int recipe) {
        ...
        Minecraft.getMinecraft().fontRenderer
            .drawStringWithShadow(pair.fortune ? "Yes" : "No", 76, 120, pair.fortune ? 0x007700 : 0xff0000);
