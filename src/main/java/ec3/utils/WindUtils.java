...
public class WindUtils {
    ...
    public static float getPlayerWindRevModifier(EntityPlayer player) {
        ...
        for (int i = 0; i < player.inventory.armorInventory.length; ++i) {
            ...
            if (armor != null) {
                if (armor.getItem() == ECItems.magicArmorItems[12] || armor.getItem() == ECItems.magicArmorItems[13]
                    || armor.getItem() == ECItems.magicArmorItems[14]
                    || armor.getItem() == ECItems.magicArmorItems[15]) {
                    retFlt += 0.23F;
                }
        ...
        if (BaublesApi.getBaubles(player) != null) for (int i = 0; i < BaublesApi.getBaubles(player)
            .getSizeInventory(); ++i) {
                ItemStack armor = BaublesApi.getBaubles(player)
                    .getStackInSlot(i);
                if (armor != null) {
                    if (armor.getItem() instanceof IWindModifier) {
                        retFlt += ((IWindModifier) armor.getItem()).getModifier(armor, player);
    ...
    public static void increasePlayerWindRelations(EntityPlayer e, int amount) {
        ...
        e.addPotionEffect(new PotionEffect(ECPotions.windTouch.id, 1000, 0, true));
    }
    ...
    public static void playerTick(EntityPlayer player) {
        ...
        int mod = 1;
        if (player.getActivePotionEffect(ECPotions.paranormalLightness) != null)
            mod = player.getActivePotionEffect(ECPotions.paranormalLightness)
                .getAmplifier() + 1;
            ...
            if (b != null) {
                for (int i = 0; i < b.getSizeInventory(); ++i) {
                    ...
                    if (is != null && is.getItem() != null
                        ...
                        && is.getItemDamage() == 9) elemental = true;
                }
            }
            if (!elemental) player.addChatMessage(
                new ChatComponentText(
                    EnumChatFormatting.DARK_AQUA + ""
                        + EnumChatFormatting.ITALIC
                        + "The wind timidly touches your hair..."));
            else {
                ...
                if (rndID == 0) {
                    player.addChatMessage(
                        new ChatComponentText(
                            EnumChatFormatting.DARK_AQUA + ""
                                + EnumChatFormatting.ITALIC
                                + "You feel a warm touch of the wind..."));
                ...
                if (rndID == 1) {
                    player.addChatMessage(
                        new ChatComponentText(
                            EnumChatFormatting.DARK_AQUA + ""
                                + EnumChatFormatting.ITALIC
                                + "You feel a chilling touch of the wind..."));
                ...
                if (rndID == 2) {
                    player.addChatMessage(
                        new ChatComponentText(
                            EnumChatFormatting.DARK_AQUA + ""
                                + EnumChatFormatting.ITALIC
                                + "You feel a strong push of the wind..."));
                ...
                if (rndID == 2) {
                    player.addChatMessage(
                        new ChatComponentText(
                            EnumChatFormatting.DARK_AQUA + ""
                                + EnumChatFormatting.ITALIC
                                + "You feel a strong blow of the wind..."));
            ...
            if (player.isSprinting()) {
                player.addChatMessage(
                    new ChatComponentText(
                        EnumChatFormatting.DARK_AQUA + ""
                            + EnumChatFormatting.ITALIC
                            + "The wind pushes you in the back..."));
                increasePlayerWindRelations(player, 1000);
                ...
                if (addBuff) player.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 20, 31));
            }
        }
    }
}
