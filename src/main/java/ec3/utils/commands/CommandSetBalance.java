...
public class CommandSetBalance extends CommandEC {

    public static void handle(ICommandSender par1ICommandSender, String[] par2ArrayOfStr) {
        int var3 = parseIntBounded(par1ICommandSender, par2ArrayOfStr[1], 1, 20000);
        ...
        func_152373_a(par1ICommandSender, CommandEC.instance, "commands.balance.success", new Object[0]);
    }
