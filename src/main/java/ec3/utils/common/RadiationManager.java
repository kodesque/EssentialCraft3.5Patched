...
public class RadiationManager {
    ...
    public static void playerTick(EntityPlayer player) {
        ...
        if (dimID == Config.dimensionID) {
            ...
            if (biome == BiomeRegistry.firstWorldBiomeArray[8]) rndRad += 2;
            if (biome == BiomeRegistry.firstWorldBiomeArray[4]) rndRad += 6;
        ...
        if (amount > 0) {
            ...
            if (hasEffect) {
                ...
                player
                    .addPotionEffect(new PotionEffect(PotionRegistry.radiation.id, currentDuration, newModifier, true));
            } else {
