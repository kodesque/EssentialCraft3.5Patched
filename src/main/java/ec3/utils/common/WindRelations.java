...
public class WindRelations {
    ...
    public static float getPlayerWindRevModifier(EntityPlayer player) {
        ...
        for (int i = 0; i < player.inventory.armorInventory.length; ++i) {
            ...
            if (armor != null) {
                if (armor.getItem() == ItemsCore.magicArmorItems[12] || armor.getItem() == ItemsCore.magicArmorItems[13]
                    || armor.getItem() == ItemsCore.magicArmorItems[14]
                    || armor.getItem() == ItemsCore.magicArmorItems[15]) {
                    retFlt += 0.23F;
                }
    ...
    public static void playerTick(EntityPlayer player) {
        ...
        if (player.getActivePotionEffect(PotionRegistry.paranormalLightness) != null)
            mod = player.getActivePotionEffect(PotionRegistry.paranormalLightness)
                .getAmplifier() + 1;
