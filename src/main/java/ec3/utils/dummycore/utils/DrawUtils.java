...
public class DrawUtils {
    ...
    public static void bindTexture(String mod, String texture) {
        if (locTable.contains(mod + ":" + texture)) Minecraft.getMinecraft()
            .getTextureManager()
            .bindTexture(locTable.get(mod + ":" + texture));
        else {
    ...
    public static boolean drawScaledTexturedRect_Items(int x, int y, IIcon icon, int width, int height, float zLevel) {
        if (icon == null) return false;
            ...
            tessellator.addVertexWithUV(
                ...
                y + height,
                zLevel,
                minU + ((maxU - minU) * (double) width) / 16D,
                minV + ((maxV - minV) * (double) height) / 16D);
     ...
     */
    @SideOnly(Side.CLIENT)
    public static void drawTexturedModalRect(int x, int y, int textureX, int textureY, int sizeX, int sizeY,
        int zLevel) {
        ...
        tessellator.addVertexWithUV(
            ...
            (double) ((float) (textureY + sizeY) * f1));
        tessellator.addVertexWithUV(
            (double) (x + sizeX),
            (double) (y + sizeY),
            (double) zLevel,
            (double) ((float) (textureX + sizeX) * f),
            (double) ((float) (textureY + sizeY) * f1));
        tessellator.addVertexWithUV(
            (double) (x + sizeX),
            (double) (y + 0),
    ...
    public static void renderItemStack_Full(ItemStack stk, double posX, double posY, double posZ, double screenPosX,
        ...
        float colorBlue, float offsetX, float offsetY, float offsetZ, boolean force3DRender) {
        if (stk != null) {
            ...
            if (itemstack != null && itemstack.getItem() != null) {
                Minecraft.getMinecraft().renderEngine
                    .bindTexture(Minecraft.getMinecraft().renderEngine.getResourceLocation(stk.getItemSpriteNumber()));
    ...
    public static void renderItemStack(ItemStack stk, double posX, double posY, double posZ, double screenPosX,
        ...
        int renderPass, int itemsAmount, boolean force3DRender) {
        final ResourceLocation RES_ITEM_GLINT = new ResourceLocation("textures/misc/enchanted_item_glint.png");
        Random random = new Random();
        IIcon iicon = stk.getItem()
            .getIcon(stk, renderPass);
        ...
        if (Minecraft.getMinecraft().gameSettings.fancyGraphics || force3DRender) {
            ...
            for (int k = 0; k < b0; ++k) {
                ...
                ItemRenderer.renderItemIn2D(
                    ...
                    minU,
                    maxV,
                    ((IIcon) iicon).getIconWidth(),
                    ((IIcon) iicon).getIconHeight(),
                    f9);
            ...
            for (int l = 0; l < itemsAmount; ++l) {
                ...
                tessellator
                    .addVertexWithUV((double) (0.0F - f7), (double) (0.0F - f8), 0.0D, (double) minU, (double) maxV);
                tessellator
                    .addVertexWithUV((double) (f6 - f7), (double) (0.0F - f8), 0.0D, (double) maxU, (double) maxV);
                tessellator
                    .addVertexWithUV((double) (f6 - f7), (double) (1.0F - f8), 0.0D, (double) maxU, (double) minV);
                tessellator
                    .addVertexWithUV((double) (0.0F - f7), (double) (1.0F - f8), 0.0D, (double) minU, (double) minV);
                tessellator.draw();
                GL11.glPopMatrix();
            }
        }
