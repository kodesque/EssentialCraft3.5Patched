package ec3.utils.dummycore.utils.world;
...
public class StructureApi {
    ...
    public static NBTTagCompound createStructureTagIgnoreMetadata(World w, AxisAlignedBB aabb, boolean whitelist,
        Block... blocks) {
            ...
            for (int dy = (int) aabb.minY; dy <= aabb.maxY; ++dy) {
                for (int dz = (int) aabb.minZ; dz <= aabb.maxZ; ++dz) {
                    ...
                    if (b != null) {
                        ...
                        if (include) {
                            String coords = String.valueOf(dx - aabb.minX - (aabb.maxX - aabb.minX) / 2) + "|"
                                + String.valueOf(dy - aabb.minY)
                                + "|"
                                + String.valueOf(dz - aabb.minZ - (aabb.maxZ - aabb.minZ) / 2);
                            if (!tag.hasKey(coords)) tag.setString(
                                coords,
                                GameRegistry.findUniqueIdentifierFor(b)
                                    .toString());
                        }
                    }
                }
    ...
    public static void nbtStructureIntoWorld(World w, int x, int y, int z, NBTTagCompound structureTag) {
        ...
        for (String s : keys) {
            ...
            String bid;
            if (st.indexOf('|') != -1) bid = st.substring(0, st.indexOf('|'));
            else bid = st;

            Block b = GameRegistry.findBlock(bid.substring(0, bid.indexOf(':')), bid.substring(bid.indexOf(':') + 1));
            int meta;
            if (st.indexOf('|') != -1) meta = Integer.parseInt(st.substring(st.indexOf('|') + 1));
            else meta = 0;
    ...
    public static boolean areNBTTagsEqual(NBTTagCompound tag1, NBTTagCompound tag2) {
        if (tag1.hasNoTags() || tag2.hasNoTags()) return false;
        ...
        while ($i.hasNext()) {
            ...
            if (!tag2.hasKey(key)) return false;
            NBTBase base2 = tag2.getTag(key);
            if (!compareTagsPrimitive(base1, base2)) return false;
        }
    ...
    public static boolean compareTagsPrimitive(NBTBase base1, NBTBase base2) {
        ...
        switch (id1) {
            ...
            case 1: {
                ...
                if (byte1.func_150290_f() != byte2.func_150290_f()) return false;
            ...
            case 2: {
                ...
                if (short1.func_150289_e() != short2.func_150289_e()) return false;
            ...
            case 3: {
                ...
                if (int1.func_150287_d() != int2.func_150287_d()) return false;
            ...
            case 4: {
                ...
                if (long1.func_150291_c() != long2.func_150291_c()) return false;
            ...
            case 5: {
                ...
                if (float1.func_150288_h() != float2.func_150288_h()) return false;
            ...
            case 6: {
                ...
                if (double1.func_150286_g() != double2.func_150286_g()) return false;
            ...
            case 7: {
                ...
                if (!byteArray1.equals(byteArray2)) return false;
            ...
            case 11: {
                ...
                if (!intArray1.equals(intArray2)) return false;
